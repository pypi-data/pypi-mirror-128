...
class Client(AminoHttpClient):
    ...
    async def get_community_client(self, comId: str = None, aminoId: str = None) -> CommunityClient:
        if comId:
    ...
    async def change_chat_bubble(self, bubbleId: str, chatId: str = None) -> int:
        ...
        response = await self.post(f"{self.apip}/g/s/chat/thread/apply-bubble", data)
        return response.status
