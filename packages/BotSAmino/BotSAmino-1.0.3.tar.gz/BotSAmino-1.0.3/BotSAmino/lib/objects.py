...
class UserInfo:
    def __init__(self, data):
        ...
        except Exception: self.createdTime = None
        try: self.userId = data['uid']
        except Exception: self.userId = None
        try: self.icon = data['icon']
        except Exception: self.icon = None
        try: self.content = data['content']
        except: self.content = None
        try: self.nickname = data['nickname']
        except Exception: self.nickname = None


class Message:
    def __init__(self, data):
        try: self.json = data
        except KeyError : self.json = None
        try: self.userId = data["uid"]
        except KeyError as e: self.userId = None
...
class CommandMessage:
    def __init__(self, data):
        ...
        try: self.message = data['content']
        except KeyError: self.content = None
        try:  self.clientRefId = data['clientRefId']
        except KeyError: self.clientRefId = None
        try: self.chatId = data["threadId"]
        except KeyError: self.chatId = None
        try: self.authorInfo: UserInfo = UserInfo(data["author"])
        except KeyError: self.author: UserInfo = UserInfo([])
        try: self.replyMessage: ReplyMessage = ReplyMessage(data["extensions"]["replyMessage"])
        except KeyError: self.replyMessage: ReplyMessage = ReplyMessage({})
        self.authorId = self.userId
        self.author = self.authorInfo.nickname
...
class ReplyMessage:
    def __init__(self, data):
        try: self.messageId = data['messageId']
        except Exception: self.messageId = None
        try: self.content = data['content']
        except Exception: self.content = None
        try:  self.clientRefId = data['clientRefId']
        except Exception: self.clientRefId = None
        try: self.author: UserInfo = UserInfo(data["author"])
        except Exception: self.author = None
        try: self.replyMessage: ReplyMessage = ReplyMessage(data["extensions"]["replyMessage"])
        except Exception: self.replyMessage = None
