...
from CGPCLI.Parser import parse_to_CGP_object
...
class Server(CGPConnector):
  ...
  def list_domain_objects(self, domain_name, limit,
                          accounts=False, aliases=False, forwarders=False,
  ...
  def get_account_ACL(self, account_name, auth_account_name=None):
  ...
  def set_account_ACL(self, account_name, new_ACL, auth_account_name=None):
    '''The following command manage the Account Access Rights.
       These command can be used by the Account owner and by Domain Administrators who have the CanImpersonate access right.
  ...
  def create_XIMSS_session(self, account_name, ip_address, orig_address=None):
    ...
    return self._operate('CREATEXIMSSSESSION ' + account_name + ' ADDRESS ' + ip_address + params + '\n')
  ...
  def kill_account_session(self, sessionID, domain_name=None):
    ...
    return self._operate('KILLSESSION ' + sessionID  + params + '\n')
  ...
  def bless_account_session(self, sessionID, secret=None, domain_name=None):
    ...
    return self._operate('BLESSSESSION ' + sessionID  + params + '\n')
  ...
  def set_server_mail_rules(self, new_rules): 
    ...
    return self._operate('SETSERVERMAILRULES ' + parse_to_CGP_object(new_rules) + '\n')
  ...
  def set_cluster_mail_rules(self, new_rules): 
    ...
    return self._operate('SETCLUSTERMAILRULES ' + parse_to_CGP_object(new_rules) + '\n')
  ...
  def set_server_signal_rules(self, new_rules): 
    ...
    return self._operate('SETSERVERSIGNALRULES ' + parse_to_CGP_object(new_rules) + '\n')
  ...
  def set_cluster_signal_rules(self, new_rules): 
    ...
    return self._operate('SETCLUSTERSIGNALRULES ' + parse_to_CGP_object(new_rules) + '\n')
  ...
  def get_IP_state(self, ip_address, temp=False): 
    ...
    return self._operate('GETIPSTATE ' + ip_address + params + '\n')
  ...
  def set_server_intercept(self, new_settings): 
    ...
    return self._operate('SETSERVERINTERCEPT ' + parse_to_CGP_object(new_settings) + '\n')
  ...
  def set_cluster_intercept(self, new_settings): 
    ...
    return self._operate('SETCLUSTERINTERCEPT ' + parse_to_CGP_object(new_settings) + '\n')
  ...
  def report_failed_login_adress(self, address): 
