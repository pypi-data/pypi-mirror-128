...
setuptools.setup(
    ...
    url="https://github.com/FayasNoushad/Check-Hashtag",
    download_url="https://github.com/FayasNoushad/Check-Hashtag/releases/latest",
    license="MIT",
    ...
    project_urls={
        ...
        "Documentation": "https://check-hashtag.projects.fayas.me",
    },
    python_requires=">=3.6",
