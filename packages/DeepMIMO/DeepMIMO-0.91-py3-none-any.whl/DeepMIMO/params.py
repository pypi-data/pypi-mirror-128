...
def default_params():
    params = {c.PARAMSET_DATASET_FOLDER: './Raytracing_scenarios', # To be implemented
              ...
              c.PARAMSET_ANT_BS: {
                  c.PARAMSET_ANT_SHAPE: np.array([1, 32, 1]), # Antenna dimensions in X - Y - Z
                  c.PARAMSET_ANT_SPACING: 0.5
                  },
              
              # UE Antenna Parameters
              c.PARAMSET_ANT_UE: {
                  c.PARAMSET_ANT_SHAPE: np.array([1, 1, 1]), # Antenna dimensions in X - Y - Z
                  c.PARAMSET_ANT_SPACING: 0.5
                  }
              }
    return params