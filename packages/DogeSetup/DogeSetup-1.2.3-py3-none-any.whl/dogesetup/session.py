...
def sessiongenerator():
    ...
    while True:
        ...
        if phonenumber.startswith("+"):
            break
    p_info(f"⏳ %10 ~ {LAN['SESSION_GENERATING']}...")
    AI, AH = random_choice()
    client = InteractiveTelegramClient(StringSession(), AI, AH, phonenumber)
    return client.session.save(), AI, AH
