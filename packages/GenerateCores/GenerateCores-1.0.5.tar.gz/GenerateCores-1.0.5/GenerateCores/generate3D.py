...
def is_separable_2(outcat1, outcat2):
    ...
    :param outcat1: The generated cores.
    :param outcat2: The newly formed core.
...
def make_3DClumps(n, path1, header_path=None, size_v=100, size_y=100, size_x=100, number=10000):
    '''
    Generate simulation data.
    :param n: The number of cores in the cube.
    :param path1: Data storage location.
    :param header_path: Header file location.
    :param size_v: The size of the V in the cube.
    :param size_y: The size of the Y in the cube.
    :param size_x: The size of the X in the cube.
    :param number: The total number of cores.
    :return: Date set.
    '''
    ...
    if header_path is not None:
        fits_header = fits.open(header_path)[0].header  # 读取头文件
    total_data = []
    while 1:
