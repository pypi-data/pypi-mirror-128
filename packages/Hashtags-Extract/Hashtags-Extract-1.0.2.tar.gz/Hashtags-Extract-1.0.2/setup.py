...
setuptools.setup(
    ...
    url="https://github.com/FayasNoushad/Hashtags-Extract",
    download_url="https://github.com/FayasNoushad/Hashtags-Extract/releases/latest",
    license="MIT",
    ...
    project_urls={
        ...
        "Documentation": "https://hashtags-extract.projects.fayas.me",
    },
    python_requires=">=3.6",
