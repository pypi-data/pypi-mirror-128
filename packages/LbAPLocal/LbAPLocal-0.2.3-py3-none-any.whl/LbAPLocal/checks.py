...
def perform_checks(production_name, job_name, test_ntuple_path_list, checks_output_dir):
    ...
    if "checks" in job_data.keys():
        ...
        output_check_results(checks_data, check_results, checks_output_dir)
...
def output_check_results(checks_data, check_results, checks_out_dir):
    """
