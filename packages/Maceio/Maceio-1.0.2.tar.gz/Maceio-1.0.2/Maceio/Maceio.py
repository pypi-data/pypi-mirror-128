...
class Maceio():
    ...
    def save(self, table, data, conflicts=[], verify=True, primaries=[]):
        ...
        if isinstance(data, list):
            ...
            for item in data:
                columns, element = self.__generateColumnsAndData(
                    item, primaries=primaries)
    ...
    def __insert(self, table, data, name_index_unique=None, primaries=[]):
        """
    ...
    def __addTable(self, table, columns, conflicts, verify=True, primaries=[]):
        ...
        :primary: List with primary keys
        :return: object
        """
