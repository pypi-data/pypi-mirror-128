...
def get_16s_copy_num(args):
    ...
    # Final report
    report_and_log(('Get_cn: estimating 16S copy number done!'), pwd_log_file, keep_quiet)
...
if __name__ == '__main__':
    ...
    get_16s_copy_num_parser.add_argument('-cp_mags',                required=False, metavar='',                             help='combined_prefixed_mags')
    get_16s_copy_num_parser.add_argument('-cp_mag_gff',             required=False, metavar='',                             help='combined_prefixed_mags_gff')
