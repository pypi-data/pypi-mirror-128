...
from NEMO_billing.invoices.exceptions import InvoiceItemsNotInFacilityException, NoRateSetException
...
def get_rate(r_type: str, project: Project, tool: Tool = None, area: Area = None, consumable: Consumable = None):
    ...
    try:
        ...
        raise NoRateSetException(
            rate_type.id, project.projectbillingdetails.category, tool=tool, area=area, consumable=consumable
        )
