...
class options:
    ...
    guess_function: :code:`False` or function
    ...
    inner_solver: str
        ...
        :code:`'fsolve'`. :code:`'fsolve'` is currently in alpha stages and is unstable; however, :code:`'least_squares'` performs well.
    ...
    Notes
    -------
    1. The HJB update loop, or dynamic loop, is the iteration involving the PDE system. The HJB or dynamic loop iterates backward in time using the equation found :ref:`on this page <documentation-main>` and a monotone finite difference scheme.
