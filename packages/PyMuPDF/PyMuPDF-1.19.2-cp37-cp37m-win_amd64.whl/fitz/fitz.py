...
VersionFitz = "1.19.0"
VersionBind = "1.19.2"
VersionDate = "2021-11-20 00:00:01"
version = (VersionBind, VersionFitz, "20211120000001")
...
class Pixmap(object):
    ...
    def color_count(self, colors: int = 0) -> AnyType:
        """Count or return unique colors of pixmap."""

        return _fitz.Pixmap_color_count(self, colors)
