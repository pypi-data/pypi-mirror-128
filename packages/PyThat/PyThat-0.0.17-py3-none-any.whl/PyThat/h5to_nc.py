...
class MeasurementTree:
    ...
    def save_netcdf(self):
        ...
        print('The save path has been set to {}'.format(str(self.save_path)))
    ...
    def construct_tree(self, data_index: tuple or None = None):
        ...
        while parent is not None:
            ...
            try:
                ...
                if self.definition[parent_row]['function'] == 'internal - repetitions':
                    ...
                    print('Scalar control without data. Generating data')
        ...
        print(dims)
        # get coordinates and dimensions for innermost data
        for i in range(len(data_shape)):
            coords[self.get_metadata(self.target[row][0])['name'][i]] = self.get_scales(self.target[row][0], i)
            dims.append(self.get_metadata(self.target[row][0])['name'][i])
