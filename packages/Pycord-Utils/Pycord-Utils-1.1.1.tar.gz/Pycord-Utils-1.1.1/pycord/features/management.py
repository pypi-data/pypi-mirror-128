...
"""
pycord.features.management
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The pycord extension and bot control commands.
...
from pycord.flags import Flags
from pycord.modules import ExtensionConverter
from pycord.paginators import WrappedPaginator
...
class ManagementFeature(Feature):
    ...
    @Feature.Command(parent="pyc", name="load", aliases=["reload"])
    async def pyc_load(self, ctx: commands.Context, *extensions: ExtensionConverter):
        """
        ...
        # 'pyc reload' on its own just reloads pycord
    ...
    @Feature.Command(parent="pyc", name="unload")
    async def pyc_unload(self, ctx: commands.Context, *extensions: ExtensionConverter):
        """
    ...
    @Feature.Command(parent="pyc", name="shutdown", aliases=["logout"])
    async def pyc_shutdown(self, ctx: commands.Context):
        """
        Logs this bot out.
        """
    ...
    @Feature.Command(parent="pyc", name="invite")
    async def pyc_invite(self, ctx: commands.Context, *perms: str):
        """
    ...
    @Feature.Command(parent="pyc", name="rtt", aliases=["ping"])
    async def pyc_rtt(self, ctx: commands.Context):
        """
