...
"""
pycord.features.voice
~~~~~~~~~~~~~~~~~~~~~~~

The pycord core voice-related commands.
...
class VoiceFeature(Feature):
    ...
    @Feature.Command(parent="pyc_voice", name="disconnect", aliases=["dc"])
    async def pyc_vc_disconnect(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="pyc_voice", name="stop")
    async def pyc_vc_stop(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="pyc_voice", name="pause")
    async def pyc_vc_pause(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="pyc_voice", name="resume")
    async def pyc_vc_resume(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="pyc_voice", name="volume")
    async def pyc_vc_volume(self, ctx: commands.Context, *, percentage: float):
        """
    ...
    @Feature.Command(parent="pyc_voice", name="play", aliases=["play_local"])
    async def pyc_vc_play(self, ctx: commands.Context, *, uri: str):
        """
