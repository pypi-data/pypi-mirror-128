...
"""
pycord.paginators (shim for discord.py 1.7.x)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Paginator-related tools and interfaces for pycord.
...
from pycord.shim.paginator_base import EMOJI_DEFAULT
...
class PaginatorInterface:  # pylint: disable=too-many-instance-attributes
    ...
    .. code:: python3
        ...
        from pycord.paginators import PaginatorInterface
