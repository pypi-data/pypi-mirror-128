...
package body Librflxlang.Implementation.C is
   ...
   function rflx_message_type_def_f_checksums
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Message_Type_Def_Range then
         ...
         declare
            ...
            Result : Bare_Checksum_Aspect;
         begin
            Result := Message_Type_Def_F_Checksums (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_message_type_def_f_checksums;
