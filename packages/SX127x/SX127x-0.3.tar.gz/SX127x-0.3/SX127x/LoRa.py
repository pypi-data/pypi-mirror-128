...
class LoRa(object):
    ...
    def __init__(self, verbose=True, do_calibration=True, calibration_freq=902.7):
        """ Init the object
        ...
        :param calibration_freq: call rx_chain_calibration with this parameter. Default is 902.7
    ...
    def rx_chain_calibration(self, freq=902.7):
