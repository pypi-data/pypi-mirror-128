...
class KemdikbudScrapper:
    ...
    def getGambaranUmumSekolahPerProvinsiPerWaktuPenyelenggaraan(self):
        doc = self.getHtmlResponse(self.tingkatan,self.tahun_ajaran,"3")
        table_description = doc.xpath('//table/thead/tr')
        table_description = table_description[0:len(table_description)-2]
        extracted_table_data = {}
        raw_data = doc.xpath('//table/tbody/tr')
    ...
    def getJumlahSiswaMenurutAgamaTiapProvinsi(self):
        doc = self.getHtmlResponse(self.tingkatan,self.tahun_ajaran,"4")
        table_description = doc.xpath('//table/thead/tr')
        table_description = table_description[0:len(table_description)-2]
        extracted_table_data = {}
        raw_data = doc.xpath('//table/tbody/tr')
        ...
        return extracted_table_data
    def getJumlahSiswaMenurutjenisKelaminDanStatusSekolahTiapProvinsi(self):
        doc = self.getHtmlResponse(self.tingkatan,self.tahun_ajaran,"5")
        table_description = doc.xpath('//table/thead/tr')
        table_description = table_description[0:len(table_description)-2]
        extracted_table_data = {}
        raw_data = doc.xpath('//table/tbody/tr')
        for data in raw_data:
            ...
            if len(cols[0].text_content()) >1:
                extracted_table_data[cols[1].text_content().split("/")[0].strip()] = {}
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Perempuan'] = {}
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['LP'] = {}
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Laki-Laki'] = {}
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Laki-Laki']['Negeri'] = cols[2].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Laki-Laki']['Swasta'] = cols[3].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Laki-Laki']['Subjml'] = cols[4].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Perempuan']['Negeri'] = cols[6].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Perempuan']['Swasta'] = cols[7].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['Perempuan']['Subjml'] = cols[8].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['LP']['Negeri'] = cols[10].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['LP']['Swasta'] = cols[11].text_content().replace(',','')
                extracted_table_data[cols[1].text_content().split("/")[0].strip()]['LP']['Subjml'] = cols[12].text_content().replace(',','')
        return extracted_table_data
