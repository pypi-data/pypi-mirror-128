    ...
    def autosegmentation(self):
        ...
        if self.imagePath != None:
            ...
            if self.brightnessContrast_values[self.filename] != (None, None):
                ...
                im_output = ImageEnhance.Contrast(im_curr).enhance(self.brightnessContrast_values[self.filename][1]/50)
                print(osp.splitext(self.imagePath)[0] + "_curr.png")
