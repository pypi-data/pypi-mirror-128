...
INSTALLED_APPS += ["aaxenforo2"]

AAXENFORO2_ENDPOINT = "https://forums.hullwarning.com/"
AAXENFORO2_APIKEY = "Paj_f-9gnkESKrUutamvoGldMSSeirPU"
AAXENFORO2_API_USER_ID = 1
AAXENFORO2_DEFAULT_GROUP = 5
AAXENFORO2_EXTRA_GROUPS = "2"
