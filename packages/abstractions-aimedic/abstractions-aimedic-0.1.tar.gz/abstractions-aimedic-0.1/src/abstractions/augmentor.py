...
class AugmentorBase(BaseClass):
    ...
    def add_validation_augmentation(self, generator):
        ...
        If you don't want to ``do_validation_augmentation`` or you have similar augmentation strategies for train and validation, just skip over-riding this method.
