...
def save_attachment(exchange_folder_name: str, save_to_folder: str, exchangelib_account, suffix=0,
                    prename='', last_items=1) -> str:
    folder = exchangelib_account.account.inbox / exchange_folder_name
