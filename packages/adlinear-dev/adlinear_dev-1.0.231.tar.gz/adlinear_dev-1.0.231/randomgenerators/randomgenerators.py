...
if __name__ == "__main__":
    ...
    dfc = utl.generate_clusters_centroids(ndim=10, max_corr=0.1)
    v = dfc.iloc[:, 0]
    dfb = utl.generate_vectors_bouquet(v, 20, 0.9)
    cl_vects = utl.generate_clusterized_vectors(veclen=10,
                                                nclusters=10, nbvect=100, clusterminsize=5,
                                                max_inter_corr=0.1,min_intra_corr=0.9)
    pass
