...
if __name__ == "__main__":
    ...
    cl_vects_H = utl.generate_clusterized_vectors(veclen=nb_clusters,
                                                  ...
                                                  nbvect=nb_clusters * h_avg_clust_size,
                                                  clusterminsize=h_avg_clust_size/2,
                                                  max_inter_corr=max_inter_corr,
                                                  min_intra_corr=min_intra_corr)
    cl_vects_W = utl.generate_clusterized_vectors(veclen=nb_clusters,
                                                  nclusters=nb_clusters,
                                                  nbvect=nb_clusters * w_avg_clust_size,
                                                  clusterminsize=w_avg_clust_size/2,
                                                  max_inter_corr=max_inter_corr,
                                                  min_intra_corr=min_intra_corr)
    ...
    df_scree_plot = nmf.scree_plot(cl_vects_M, ncmin=10, ncmax=30)
    pass
