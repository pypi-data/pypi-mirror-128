/*! For license information please see 5fa63fa2.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[73318,40227,95810,29485],{14166:(t,i,e)=>{e.d(i,{W:()=>a});var n=function(){return n=Object.assign||function(t){for(var i,e=1,n=arguments.length;e<n;e++)for(var a in i=arguments[e])Object.prototype.hasOwnProperty.call(i,a)&&(t[a]=i[a]);return t},n.apply(this,arguments)};function a(t,i,e){void 0===i&&(i=Date.now()),void 0===e&&(e={});var a=n(n({},o),e||{}),s=(+t-+i)/1e3;if(Math.abs(s)<a.second)return{value:Math.round(s),unit:"second"};var r=s/60;if(Math.abs(r)<a.minute)return{value:Math.round(r),unit:"minute"};var l=s/3600;if(Math.abs(l)<a.hour)return{value:Math.round(l),unit:"hour"};var p=s/86400;if(Math.abs(p)<a.day)return{value:Math.round(p),unit:"day"};var h=new Date(t),c=new Date(i),d=h.getFullYear()-c.getFullYear();if(Math.round(Math.abs(d))>0)return{value:Math.round(d),unit:"year"};var m=12*d+h.getMonth()-c.getMonth();if(Math.round(Math.abs(m))>0)return{value:Math.round(m),unit:"month"};var u=s/604800;return{value:Math.round(u),unit:"week"}}var o={second:45,minute:45,hour:22,day:5}},14114:(t,i,e)=>{e.d(i,{P:()=>n});const n=t=>(i,e)=>{if(i.constructor._observers){if(!i.constructor.hasOwnProperty("_observers")){const t=i.constructor._observers;i.constructor._observers=new Map,t.forEach(((t,e)=>i.constructor._observers.set(e,t)))}}else{i.constructor._observers=new Map;const t=i.updated;i.updated=function(i){t.call(this,i),i.forEach(((t,i)=>{const e=this.constructor._observers.get(i);void 0!==e&&e.call(this,this[i],t)}))}}i.constructor._observers.set(e,t)}},63207:(t,i,e)=>{e(65660),e(15112);var n=e(9672),a=e(87156),o=e(50856),s=e(65233);(0,n.k)({_template:o.d`
    <style>
      :host {
        @apply --layout-inline;
...
`,is:"iron-icon",properties:{icon:{type:String},theme:{type:String},src:{type:String},_meta:{value:s.XY.create("iron-meta",{type:"iconset"})}},observers:["_updateIcon(_meta, isAttached)","_updateIcon(theme, isAttached)","_srcChanged(src, isAttached)","_iconChanged(icon, isAttached)"],_DEFAULT_ICONSET:"icons",_iconChanged:function(t){var i=(t||"").split(":");this._iconName=i.pop(),this._iconsetName=i.pop()||this._DEFAULT_ICONSET,this._updateIcon()},_srcChanged:function(t){this._updateIcon()},_usesIconset:function(){return this.icon||!this.src},_updateIcon:function(){this._usesIconset()?(this._img&&this._img.parentNode&&(0,a.vz)(this.root).removeChild(this._img),""===this._iconName?this._iconset&&this._iconset.removeIcon(this):this._iconsetName&&this._meta&&(this._iconset=this._meta.byKey(this._iconsetName),this._iconset?(this._iconset.applyIcon(this,this._iconName,this.theme),this.unlisten(window,"iron-iconset-added","_updateIcon")):this.listen(window,"iron-iconset-added","_updateIcon"))):(this._iconset&&this._iconset.removeIcon(this),this._img||(this._img=document.createElement("img"),this._img.style.width="100%",this._img.style.height="100%",this._img.draggable=!1),this._img.src=this.src,(0,a.vz)(this.root).appendChild(this._img))}})},49075:(t,i,e)=>{e.d(i,{S:()=>s,B:()=>r});e(65233);var n=e(51644),a=e(26110),o=e(84938);const s={observers:["_focusedChanged(receivedFocusFromKeyboard)"],_focusedChanged:function(t){t&&this.ensureRipple(),this.hasRipple()&&(this._ripple.holdDown=t)},_createRipple:function(){var t=o.o._createRipple();return t.id="ink",t.setAttribute("center",""),t.classList.add("circle"),t}},r=[n.P,a.a,o.o,s]},25782:(t,i,e)=>{e(65233),e(65660),e(70019),e(97968);var n=e(9672),a=e(50856),o=e(33760);(0,n.k)({_template:a.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[o.U]})},54444:(t,i,e)=>{e(65233);var n=e(9672),a=e(87156),o=e(50856);(0,n.k)({_template:o.d`
    <style>
      :host {
        display: block;
        position: absolute;
