/*! For license information please see 61c69661.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[83935],{54930:(e,r,t)=>{t.d(r,{D:()=>f});var i=t(87480),n=t(26767),o=t(38103),s=t(37500),a=t(5701),c=t(228),l=t(48399),d=t(47501);class p extends s.oi{constructor(){super(...arguments),this.indeterminate=!1,this.progress=0,this.density=0,this.closed=!1}open(){this.closed=!1}close(){this.closed=!0}render(){const e={"mdc-circular-progress--closed":this.closed,"mdc-circular-progress--indeterminate":this.indeterminate},r=48+4*this.density,t={width:`${r}px`,height:`${r}px`};return s.dy`
      <div
      ...
      </div>`}renderDeterminateContainer(){const e=48+4*this.density,r=e/2,t=this.density>=-3?18+11*this.density/6:12.5+5*(this.density+3)/4,i=6.2831852*t,n=(1-this.progress)*i,o=this.density>=-3?4+this.density*(1/3):3+(this.density+3)*(1/6);return s.dy`
      ...
      </div>`}renderIndeterminateSpinnerLayer(){const e=48+4*this.density,r=e/2,t=this.density>=-3?18+11*this.density/6:12.5+5*(this.density+3)/4,i=6.2831852*t,n=.5*i,o=this.density>=-3?4+this.density*(1/3):3+(this.density+3)*(1/6);return s.dy`
    ...
    `:i.dy``}},{kind:"method",key:"renderEntity",value:function(e,r){const t=this.hass.states[e.entity];return e={tap_action:{action:r?"more-info":"toggle"},hold_action:{action:"more-info"},...e},t?i.dy`
      <div class="wrapper">
        <ha-icon-button
          @action=${this._handleAction}
          .actionHandler=${(0,h.K)({hasHold:(0,y._)(e.hold_action),hasDoubleClick:(0,y._)(e.double_tap_action)})}
    ...
    `:i.dy`
        ...
        ></hui-warning-element>
      `}},{kind:"method",key:"_handleAction",value:function(e){const r=e.currentTarget.config;(0,g.G)(this,this.hass,r,e.detail.action)}},{kind:"get",static:!0,key:"styles",value:function(){return i.iv`
      ha-card {
        position: relative;
        min-height: 48px;
        overflow: hidden;
    ...
    `}}]}}),i.oi)}))}}]);
//# sourceMappingURL=61c69661.js.map