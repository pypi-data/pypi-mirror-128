      ...
      <div class="card-config">
        ...
        <div class="side-by-side">
          ...
          <ha-icon-picker
            ...
            .fallbackPath=${this._icon||null!=t&&t.attributes.icon||!t?void 0:(0,v.K)((0,f.M)(t.entity_id),t)}
            .configValue=${"icon"}
            @value-changed=${this._valueChanged}
          ></ha-icon-picker>
        </div>
