...
w = np.array([500,  1000,  100,  0,   100,  0,   0])  # Weights: [discriminatory, monotonicity, minNb, minNr, No_NaN-s
args = {'nc1': 4,
        'nc2': 4,
       ...
       'maxx': np.max(np.max(data[['Score_GB', 'Score_GBR']])),
        ...
        'BRR': 100,     # min Bad rate for most risky population
