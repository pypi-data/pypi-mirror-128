...
def flag_flatline(df_well, y_pred=None, **kwargs):
    ...
    def run_get_flatlines(df_well, cols, ncols, **kwargs):
        ...
        var_window_size = kwargs.get('var_window', 10)
        ...
        return ac_grad_anomalies, acs_grad_anomalies, den_grad_anomalies

    #run the function for all points
    ac_grad_anomalies, acs_grad_anomalies, den_grad_anomalies = run_get_flatlines(df_well, cols, ncols, **kwargs)
    ...
    ac_grad_anomalies  = ac_grad_anomalies.append(ac_grad_anomalies_ends)
    acs_grad_anomalies = acs_grad_anomalies.append(acs_grad_anomalies_ends)
    den_grad_anomalies = den_grad_anomalies.append(den_grad_anomalies_ends)
    ...
    ac_grad_anomalies.append(ac_flat_grad)
    acs_grad_anomalies.append(acs_flat_grad)
    den_grad_anomalies.append(den_flat_grad)
    ...
    ac_grad_anomalies  = ac_grad_anomalies.append(ac_flat_window)
    acs_grad_anomalies = acs_grad_anomalies.append(acs_flat_window)
    den_grad_anomalies = den_grad_anomalies.append(den_flat_window)
    ...
    y_pred['score_flat_deriv_ac']  = ac_derivatives.fillna(0)
    y_pred['score_flat_deriv_acs'] = acs_derivatives.fillna(0)
    y_pred['score_flat_deriv_den'] = den_derivatives.fillna(0)

    y_pred['score_flat_window_ac']  = ac_window_grad.fillna(0)
    y_pred['score_flat_window_acs'] = acs_window_grad.fillna(0)
    y_pred['score_flat_window_den'] = den_window_grad.fillna(0)
