...
SQLITE_GIFTS_TABLE = 'alive_bot_gifts'
...
def get_invoker_level(invoker_name):
    ...
    invoker_delegationsIn = float(0.0 if wallet_token_info['delegationsIn'] is None else wallet_token_info['delegationsIn'])
    invoker_stake = float(0.0 if wallet_token_info['stake'] is None else wallet_token_info['stake'])
    ...
    min_staked = float(config['AccessLevel3']['MIN_TOKEN_STAKED'])
