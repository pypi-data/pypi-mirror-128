...
class Client(Callbacks, SocketHandler):
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/login", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        self.run_socket()
    ...
    def register(self, nickname: str, email: str, password: str, verificationCode: str, deviceId: str = device.device_id):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/register", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def restore(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/account/delete-request/cancel", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def logout(self):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/logout", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else:
            self.authenticated = False
            self.json = None
    ...
    def configure(self, age: int, gender: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/persona/profile/basic", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def verify(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/check-security-validation", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def request_verify_code(self, email: str, resetPassword: bool = False):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.api}/g/s/auth/request-security-validation", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def activate_account(self, email: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/activate-email", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def delete_account(self, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/account/delete-request", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def change_password(self, email: str, password: str, code: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/reset-password", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def check_device(self, deviceId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/device", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
    ...
    def start_chat(self, userId: [str, list], message: str, title: str = None, content: str = None, isGlobal: bool = False, publishToGlobal: bool = False):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/chat/thread", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def invite_to_chat(self, userId: [str, list], chatId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/member/invite", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def send_message(self, chatId: str, message: str = None, messageType: int = 0, file: BinaryIO = None, fileType: str = None, replyTo: str = None, mentionUserIds: list = None, stickerId: str = None, embedId: str = None, embedType: int = None, embedLink: str = None, embedTitle: str = None, embedContent: str = None, embedImage: BinaryIO = None):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/message", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def delete_message(self, chatId: str, messageId: str, asStaff: bool = False, reason: str = None):
        ...
        **Returns**
        ...
        else: response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/message/{messageId}/admin", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.userId}/alert", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        ...
        if backgroundImage is not None:
            ...
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.userId}/background", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)
        ...
        if coHosts is not None:
            ...
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/co-host", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)
        ...
        if viewOnly is not None:
            if viewOnly:
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/view-only/enable", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not viewOnly:
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/view-only/disable", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)
        ...
        if canInvite is not None:
            if canInvite:
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/members-can-invite/enable", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not canInvite:
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/members-can-invite/disable", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)
        ...
        if canTip is not None:
            if canTip:
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/tipping-perm-status/enable", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

            if not canTip:
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/tipping-perm-status/disable", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
                if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
                else: res.append(response.status_code)

        data = json.dumps(data)
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
        else: res.append(response.status_code)
    ...
    def send_coins(self, coins: int, blogId: str = None, chatId: str = None, objectId: str = None, transactionId: str = None):
        ...
        data = json.dumps(data)
        sig = signature(data)
        response = requests.post(url, headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def follow(self, userId: [str, list]):
        ...
        **Returns**
        ...
        if isinstance(userId, str):
            ...
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/user-profile/{self.userId}/joined", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def join_community(self, comId: str, invitationId: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        sig = signature(data)
        response = requests.post(f"{self.api}/x{comId}/s/community/join", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def request_join_community(self, comId: str, message: str = None):
        ...
        **Returns**
        ...
        sig = signature(data)
        response = requests.post(f"{self.api}/x{comId}/s/community/membership-request", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def flag_community(self, comId: str, reason: str, flagType: int, isGuest: bool = False):
        ...
        **Returns**
        ...
        sig = signature(data)
        response = requests.post(f"{self.api}/x{comId}/s/{flg}", data=data, headers=self.parse_headers(data=data, sig=sig), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def edit_profile(self, nickname: str = None, content: str = None, icon: BinaryIO = None, backgroundColor: str = None, backgroundImage: str = None, defaultBubbleId: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/user-profile/{self.userId}", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def set_privacy_status(self, isAnonymous: bool = False, getNotifications: bool = False):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/account/visit-settings", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def set_amino_id(self, aminoId: str):
        ...
        **Returns**
        ...
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/account/change-amino-id", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def reorder_linked_communities(self, comIds: list):
        ...
        **Returns**
        ...
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/user-profile/{self.userId}/linked-community/reorder", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def comment(self, message: str, userId: str = None, blogId: str = None, wikiId: str = None, replyTo: str = None):
        ...
        **Returns**
        ...
        if userId:
            ...
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/user-profile/{userId}/g-comment", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/blog/{blogId}/g-comment", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/item/{wikiId}/g-comment", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        ...
        **Returns**
        ...
        if blogId:
            if isinstance(blogId, str):
                ...
                data = json.dumps(data)
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/blog/{blogId}/g-vote?cv=1.2", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)

            elif isinstance(blogId, list):
                data["targetIdList"] = blogId
                data = json.dumps(data)
                sig = signature(data)
                response = requests.post(f"{self.api}/g/s/feed/g-vote", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
            ...
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/item/{wikiId}/g-vote?cv=1.2", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def like_comment(self, commentId: str, userId: str = None, blogId: str = None, wikiId: str = None):
        ...
        **Returns**
        ...
        if userId:
            ...
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/user-profile/{userId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif blogId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/blog/{blogId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)

        elif wikiId:
            data["eventSource"] = "PostDetailView"
            data = json.dumps(data)
            sig = signature(data)
            response = requests.post(f"{self.api}/g/s/item/{wikiId}/comment/{commentId}/g-vote?cv=1.2&value=1", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def get_from_id(self, objectId: str, objectType: int, comId: str = None):
        ...
        **Returns**
        ...
        sig = signature(data)
        if comId: response = requests.post(f"{self.api}/g/s-x{comId}/link-resolution", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        else: response = requests.post(f"{self.api}/g/s/link-resolution", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return objects.FromCode(json.loads(response.text)["linkInfoV2"]).FromCode
    ...
    def invite_to_vc(self, chatId: str, userId: str):
        ...
        **Returns**
        ...
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/vvchat-presenter/invite", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def wallet_config(self, level: int):
        ...
        **Returns**
        ...
        sig = signature(data)
        response = requests.post(f"{self.api}/g/s/wallet/ads/config", headers=self.parse_headers(data=data, sig=sig), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
