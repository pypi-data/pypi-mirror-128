...
# TODO(ilr) Remove aioredis from here once it is pinned in latest ray
# NOTE: These are package versions that are *pinned* in the vendored version of Ray
PATCHES = ["aioredis<2.0.0"]
