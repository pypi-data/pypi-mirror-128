...
def install_vbox_sdk():
    ...
    if platform.system() == 'Windows':
        ...
        command = 'VBOX_INSTALL_PATH=$(which virtualbox) python3 vboxapisetup.py install --user'
    elif platform.system() == 'Darwin':
        command = 'VBOX_INSTALL_PATH=/Applications/VirtualBox.app/Contents/MacOS python3 vboxapisetup.py install --user'
    else:
        command = 'VBOX_INSTALL_PATH=$(which virtualbox) python3 vboxapisetup.py install --user'
