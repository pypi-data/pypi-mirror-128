...
import virtualbox
from aos_prov.command_download import download_vox_sdk, DOWNLOADS_PATH
...
def install_vbox_sdk():
    ...
    if platform.system() == 'Windows':
        command = 'python vboxapisetup.py install'
    elif platform.system() == 'Linux':
        command = 'python3 vboxapisetup.py install'
    else:
        command = 'python3 vboxapisetup.py install'
...
def new_vm(vm_name: str, disk_location: str):
    ...
    __check_disk_exist(disk_location)
