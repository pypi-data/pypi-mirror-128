...
class DefaultUnleashConf(Configuration):
    ...
    conf = dict(
        ...
        custom_headers={'Authorization': os.getenv('AEXP_UNLEASH_AUTH_HEADER')},
        refresh_interval=int(os.getenv("AEXP_UNLEASH_REFRESH_INTERVAL")),
        metrics_interval=int(os.getenv("AEXP_UNLEASH_METRICS_INTERVAL")),
