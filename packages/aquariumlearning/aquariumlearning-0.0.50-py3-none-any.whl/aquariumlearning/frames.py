...
class BaseFrame:
    ...
    def add_coordinate_frame_2d(
        ...
        *,
        coord_frame_id: str,
        camera_matrix: List[List[Union[int, float]]],
        fx: Union[int, float],
        fy: Union[int, float],
        ...
        Args:
            coord_frame_id (str): String identifier for this coordinate frame.
            camera_matrix (List[List[Union[int, float]]]): 4x4 row major order camera matrix mapping 3d world space to camera space (x right, y down, z forward).
            fx (Union[int, float]): focal length x in pixels.
            fy (Union[int, float]): focal length y in pixels.
            k1 (Optional[Union[int, float]], optional): k1 radial distortion coefficient. Defaults to None.
            k2 (Optional[Union[int, float]], optional): k2 radial distortion coefficient. Defaults to None.
            k3 (Optional[Union[int, float]], optional): k3 radial distortion coefficient. Defaults to None.
            k4 (Optional[Union[int, float]], optional): k4 radial distortion coefficient. Defaults to None.
            k5 (Optional[Union[int, float]], optional): k5 radial distortion coefficient. Defaults to None.
            k6 (Optional[Union[int, float]], optional): k6 radial distortion coefficient. Defaults to None.
            p1 (Optional[Union[int, float]], optional): p1 tangential distortion coefficient. Defaults to None.
            p2 (Optional[Union[int, float]], optional): p2 tangential distortion coefficient. Defaults to None.
            cx (Optional[Union[int, float]], optional): optical center pixel x coordinate. Defaults to None.
            cy (Optional[Union[int, float]], optional): optical center pixel y coordinate. Defaults to None.
        """
        ...
        for coord in [k1, k2, k3, k4, k5, k6, p1, p2, cx, cy]:
