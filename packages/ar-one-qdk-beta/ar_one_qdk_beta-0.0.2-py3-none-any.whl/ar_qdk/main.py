...
class ARQDK(QDK):
    ...
    def add_record_note(self):
        """Добавление комментария к записи"""
        return self.execute_method('add_record_note')

    def open_internal_gate(self):
        """Метод для открытия шлагбаума при въезде на весы, в ручном режиме"""
        return self.execute_method('open_internal_gate')

    def close_internal_gate(self):
        """Метод для закрытия шлагбаума при въезде на весы, в ручном режиме"""
        return self.execute_method('close_internal_gate')

    def open_external_gate(self):
        """Метод для открытия шлагбаума при выезде с весов, в ручном режиме"""
        return self.execute_method('open_external_gate')

    def close_external_gate(self):
        """Метод для закрытия шлагбаума при выезде с весов, в ручном режиме"""
        return self.execute_method('close_external_gate')
