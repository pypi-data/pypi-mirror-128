...
class Agent(Insight, Channel, Catalog, Dataset):
    ...
    def query(self, dataset_slug="", fields:list=[], filters=None, sorted_by=None,  dataset_id="", limit=50, offset=0):
...
class Askdata(SignUp):
    ...
    def save_dataset(self, df:pd.DataFrame, workspace: str, dataset_slug="", replace=True, dataset_name="", locale="en"):
    ...
    def query(self, workspace='', dataset='', fields:list=[], filters=None, sorted_by=None, limit=50, offset=0):
        ...
        return agent.query(dataset_slug, fields, filters, sorted_by, limit=limit, offset=offset)
