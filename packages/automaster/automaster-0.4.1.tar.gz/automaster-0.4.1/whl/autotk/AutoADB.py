...
class adbClass():
    def __init__(self, port, versionlimit=2021111101):
        self.verlimit = versionlimit
        self.boxid = None
        self.ver = 0
        self.palystate = False
        self.iperfver = None
        self.errormsg = ["NoError", "Command Error", "APK Version_limit:%s Unsupported"%versionlimit, "Not Found Return", "ConnectError",
                         "Device Not Found"]
        self.error = 0
    ...
    def get_tag_keys(self, _json, isnew, conf_keys):
        ...
        unifykeys = {'did': ["DID", "IOT_CERT", "IOT_PRIV"], 'netflix': ["netflix_mgkid"],
                     ...
                     'hdcp22_key': ["hdcp22_fw_private"], 'attestationkey': ["attestationkeybox"],'attestation_v2':["attestationkeybox"],
