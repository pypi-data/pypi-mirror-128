"""
.. module:: akit.integration.upnp.extensions.sonos.zps15
    :platform: Darwin, Linux, Unix, Windows
    :synopsis: Module containing the a Upnp device for a Sonos Zps15.
...
class SonosDeviceZpS15(SonosPlayer, LoadableExtension):
    """
    """
