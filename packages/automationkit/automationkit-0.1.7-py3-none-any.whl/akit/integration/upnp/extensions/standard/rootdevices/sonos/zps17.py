"""
.. module:: akit.integration.upnp.extensions.sonos.zps17
    :platform: Darwin, Linux, Unix, Windows
    :synopsis: Module containing the a Upnp device for a Sonos Zps17.
...
class SonosDeviceZpS17(SonosPlayer, LoadableExtension):
    """
    """
