...
DIR_UPNP_EXTENSIONS_INTEGRATION = os.path.join(AKIT_VARIABLES.AKIT_DIRECTORY, "upnp", "extensions")
...
DIR_UPNP_SCAN_INTEGRATION = os.path.join(AKIT_VARIABLES.AKIT_DIRECTORY, "upnp", "scan")
