"""
.. module:: akit.integration.upnp.extensions.sonos.zps9
    :platform: Darwin, Linux, Unix, Windows
    :synopsis: Module containing the a Upnp device for a Sonos Zps9.
...
class SonosDeviceZpS9(SonosPlayer, LoadableExtension):
    """
    """
