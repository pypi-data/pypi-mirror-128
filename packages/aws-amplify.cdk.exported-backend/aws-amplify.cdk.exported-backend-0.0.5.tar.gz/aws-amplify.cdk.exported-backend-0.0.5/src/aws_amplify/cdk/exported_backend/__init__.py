...
class APIGraphQLIncludedNestedStack(
    ...
    def stack(self) -> aws_cdk.core.NestedStack:
        return typing.cast(aws_cdk.core.NestedStack, jsii.get(self, "stack"))

    @stack.setter
    def stack(self, value: aws_cdk.core.NestedStack) -> None:
...
class AmplifyExportedBackend(
    ...
    def _transform_template_file(
        self,
        cfn_include_props: aws_cdk.cloudformation_include.CfnIncludeProps,
    ...
    def root_stack(self) -> aws_cdk.core.Stack:
        '''The root stack created.'''
        return typing.cast(aws_cdk.core.Stack, jsii.get(self, "rootStack"))

    @root_stack.setter
    def root_stack(self, value: aws_cdk.core.Stack) -> None:
...
class AmplifyExportedBackendProps(aws_cdk.core.StackProps):
    def __init__(
        self,
        *,
        analytics_reporting: typing.Optional[builtins.bool] = None,
...
class AuthIncludedNestedStack(
    ...
    def hosted_ui_provider_credentials(
        self,
        credentials: typing.Sequence["ProviderCredential"],
    ) -> None:
        '''
        :param credentials: -
        '''
...
class ExportManifest:
    def __init__(
        self,
        *,
        props: aws_cdk.cloudformation_include.CfnIncludeProps,
