...
from .. import (
    ...
    CustomResource as _CustomResource_99737ca3,
...
class NestedStack(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        notifications: typing.Optional[typing.Sequence[_ITopic_9eca4852]] = None,
...
class NestedStackProps:
    ...
    @builtins.property
    def notifications(self) -> typing.Optional[typing.List[_ITopic_9eca4852]]:
...
class CustomResourceProvider(
    ...
    def from_lambda(cls, handler: _IFunction_6adb0ab8) -> "CustomResourceProvider":
    ...
    @builtins.classmethod
    def from_topic(cls, topic: _ITopic_9eca4852) -> "CustomResourceProvider":
    ...
    @builtins.classmethod
    def lambda_(cls, handler: _IFunction_6adb0ab8) -> "CustomResourceProvider":
    ...
    @builtins.classmethod
    def topic(cls, topic: _ITopic_9eca4852) -> "CustomResourceProvider":
