...
from ..aws_cloudformation import (
    CloudFormationCapabilities as _CloudFormationCapabilities_4ef0bba7
)
...
class CloudFormationCreateReplaceChangeSetAction(
    ...
    def __init__(
        ...
        *,
        ...
        capabilities: typing.Optional[typing.Sequence[_CloudFormationCapabilities_4ef0bba7]] = None,
...
class CloudFormationCreateReplaceChangeSetActionProps(_CommonAwsActionProps_8b809bb6):
    ...
    def capabilities(
        self,
    ) -> typing.Optional[typing.List[_CloudFormationCapabilities_4ef0bba7]]:
        ...
        return typing.cast(typing.Optional[typing.List[_CloudFormationCapabilities_4ef0bba7]], result)
