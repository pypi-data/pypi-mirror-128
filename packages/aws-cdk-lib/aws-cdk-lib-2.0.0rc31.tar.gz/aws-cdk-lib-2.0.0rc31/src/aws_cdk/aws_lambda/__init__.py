...
from .. import (
    ...
    BundlingDockerImage as _BundlingDockerImage_89739db2,
...
from ..aws_logs import (
    ...
    LogRetention as _LogRetention_40e2be6d,
    LogRetentionProps as _LogRetentionProps_1e1bad93,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_LogRetentionProps_1e1bad93],
    name_mapping={
        "log_group_name": "logGroupName",
        "log_group_region": "logGroupRegion",
        "log_retention_retry_options": "logRetentionRetryOptions",
...
class LogRetentionProps(_LogRetentionProps_1e1bad93):
    def __init__(
        self,
        *,
        log_group_name: builtins.str,
    ...
    @builtins.property
    def retention(self) -> _RetentionDays_070f99f0:
        '''(experimental) The number of days log events are kept in CloudWatch Logs.
        ...
        return typing.cast(_RetentionDays_070f99f0, result)
...
class Runtime(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_lambda.Runtime"):
    ...
    def bundling_docker_image(self) -> _BundlingDockerImage_89739db2:
        '''(deprecated) DEPRECATED.
        ...
        :stability: deprecated
        '''
        return typing.cast(_BundlingDockerImage_89739db2, jsii.get(self, "bundlingDockerImage"))
...
class Function(
    ...
    def architecture(self) -> typing.Optional[Architecture]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[Architecture], jsii.get(self, "architecture"))
