...
class NodejsFunction(
    ...
    def __init__(
        ...
        *,
        ...
        architectures: typing.Optional[typing.Sequence[_Architecture_12d5a53f]] = None,
...
class NodejsFunctionProps(_FunctionOptions_328f4d39):
    ...
    @builtins.property
    def architectures(self) -> typing.Optional[typing.List[_Architecture_12d5a53f]]:
        ...
        return typing.cast(typing.Optional[typing.List[_Architecture_12d5a53f]], result)
