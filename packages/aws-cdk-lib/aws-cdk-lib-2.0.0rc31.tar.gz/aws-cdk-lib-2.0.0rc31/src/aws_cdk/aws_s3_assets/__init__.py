...
from ..assets import (
    CopyOptions as _CopyOptions_d6089be2, FollowMode as _FollowMode_e83279b3
)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[
        _CopyOptions_d6089be2, _FileCopyOptions_e03e2a30, _AssetOptions_9cd3031e
    ],
    name_mapping={
        "exclude": "exclude",
        "follow": "follow",
...
class AssetOptions(
    _CopyOptions_d6089be2,
    _FileCopyOptions_e03e2a30,
    _AssetOptions_9cd3031e,
):
    def __init__(
        self,
        *,
