...
from ..aws_cloudformation import (
    CustomResourceProviderConfig as _CustomResourceProviderConfig_9144adcd,
    ICustomResourceProvider as _ICustomResourceProvider_e93cd466,
)
from ..aws_ec2 import (
...
@jsii.implements(_ICustomResourceProvider_e93cd466)
class Provider(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    ...
    def bind(
    ...
    ) -> _CustomResourceProviderConfig_9144adcd:
        ...
        :stability: deprecated
        '''
        return typing.cast(_CustomResourceProviderConfig_9144adcd, jsii.invoke(self, "bind", [_scope]))
