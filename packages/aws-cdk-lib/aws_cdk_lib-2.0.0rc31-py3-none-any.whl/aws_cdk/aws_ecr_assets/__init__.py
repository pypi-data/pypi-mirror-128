...
from ..assets import (
    FingerprintOptions as _FingerprintOptions_890bcb6b,
    FollowMode as _FollowMode_e83279b3,
    IAsset as _IAsset_d32f2e49,
)
from ..aws_ecr import IRepository as _IRepository_e6004aa6


@jsii.implements(_IAsset_d32f2e49)
class DockerImageAsset(
    ...
    def __init__(
        ...
        *,
        ...
        follow: typing.Optional[_FollowMode_e83279b3] = None,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_FingerprintOptions_890bcb6b, _FileFingerprintOptions_115b8b51],
    name_mapping={
        "exclude": "exclude",
        "follow": "follow",
...
class DockerImageAssetOptions(
    _FingerprintOptions_890bcb6b,
    _FileFingerprintOptions_115b8b51,
):
    def __init__(
        self,
        *,
    ...
    @builtins.property
    def follow(self) -> typing.Optional[_FollowMode_e83279b3]:
        ...
        return typing.cast(typing.Optional[_FollowMode_e83279b3], result)
