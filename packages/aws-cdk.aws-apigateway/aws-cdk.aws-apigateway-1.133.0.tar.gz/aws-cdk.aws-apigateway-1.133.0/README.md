...
```python
# imported_key is of type ApiKey
...
```python
# usageplan is of type UsagePlan
...
```python
# books_backend is of type LambdaIntegration
...
```python
# my_resource is of type Resource
...
```python
# some_endpoint is of type IVpcEndpoint
...
```python
# integration is of type Integration
...
```python
# api_definition is of type ApiDefinition
