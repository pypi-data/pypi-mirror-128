...
class HttpUserPoolAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        user_pool_clients: typing.Sequence[aws_cdk.aws_cognito.IUserPoolClient],
        authorizer_name: typing.Optional[builtins.str] = None,
        identity_source: typing.Optional[typing.Sequence[builtins.str]] = None,
...
class UserPoolAuthorizerProps:
    ...
    @builtins.property
    def user_pool_clients(self) -> typing.List[aws_cdk.aws_cognito.IUserPoolClient]:
        ...
        return typing.cast(typing.List[aws_cdk.aws_cognito.IUserPoolClient], result)
