...
from aws_cdk.aws_apigatewayv2_integrations import HttpProxyIntegration, LambdaProxyIntegration
...
web_socket_api = apigwv2.WebSocketApi(self, "mywsapi",
    connect_route_options=apigwv2.WebSocketRouteOptions(integration=LambdaWebSocketIntegration(handler=connect_handler)),
    disconnect_route_options=apigwv2.WebSocketRouteOptions(integration=LambdaWebSocketIntegration(handler=disconnect_handler)),
    default_route_options=apigwv2.WebSocketRouteOptions(integration=LambdaWebSocketIntegration(handler=default_handler))
)
...
class WebSocketRoute(
    ...
    Example::
        ...
        # web_socket_api is of type WebSocketApi
        # web_socket_route_integration is of type IWebSocketRouteIntegration
    ...
    def __init__(
        ...
        *,
        ...
        props = DomainNameProps(
            certificate=certificate, domain_name=domain_name, mtls=mtls
        )
