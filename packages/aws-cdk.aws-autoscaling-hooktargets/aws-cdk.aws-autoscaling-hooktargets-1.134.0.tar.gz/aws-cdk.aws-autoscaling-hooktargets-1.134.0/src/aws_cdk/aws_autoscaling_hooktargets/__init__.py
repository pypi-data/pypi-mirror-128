...
class FunctionHook(
    ...
    def bind(
        ...
        '''
        return typing.cast(aws_cdk.aws_autoscaling.LifecycleHookTargetConfig, jsii.invoke(self, "bind", [scope, lifecycle_hook]))
...
class QueueHook(
    ...
    def bind(
        ...
        :param lifecycle_hook: -
        '''
        return typing.cast(aws_cdk.aws_autoscaling.LifecycleHookTargetConfig, jsii.invoke(self, "bind", [_scope, lifecycle_hook]))
