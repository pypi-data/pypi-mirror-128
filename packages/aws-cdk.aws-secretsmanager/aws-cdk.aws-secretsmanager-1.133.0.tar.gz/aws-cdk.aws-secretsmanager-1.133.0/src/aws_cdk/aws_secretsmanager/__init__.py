...
class HostedRotation(
    ...
    Example::
        ...
        hosted_rotation = secretsmanager.HostedRotation.maria_db_multi_user(
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            rotation_schedule_options = secretsmanager.RotationScheduleOptions(
                automatically_after=cdk.Duration.minutes(30),
                hosted_rotation=hosted_rotation,
                rotation_lambda=function_
            )
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            secret_attributes = secretsmanager.SecretAttributes(
                encryption_key=key,
                secret_arn="secretArn",
                secret_complete_arn="secretCompleteArn",
                secret_partial_arn="secretPartialArn"
...
class SecretRotation(
    ...
    Example::
        ...
        # connectable is of type IConnectable
        # interface_vpc_endpoint is of type InterfaceVpcEndpoint
        # secret is of type Secret
        # secret_rotation_application is of type SecretRotationApplication
        # security_group is of type SecurityGroup
        # subnet is of type Subnet
        # subnet_filter is of type SubnetFilter
        # vpc is of type Vpc
        
        secret_rotation = secretsmanager.SecretRotation(self, "MySecretRotation",
            application=secret_rotation_application,
            secret=secret,
            target=connectable,
            vpc=vpc,
...
class SecretRotationApplication(
    ...
    Example::
        ...
        secret_rotation_application = secretsmanager.SecretRotationApplication("applicationId", "semanticVersion",
            is_multi_user=False
        )
    '''
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            secret_rotation_props = secretsmanager.SecretRotationProps(
                application=secret_rotation_application,
                secret=secret,
                target=connectable,
                vpc=vpc,
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            single_user_hosted_rotation_options = secretsmanager.SingleUserHostedRotationOptions(
                function_name="functionName",
                security_groups=[security_group],
                vpc=vpc,
                vpc_subnets=ec2.SubnetSelection(
