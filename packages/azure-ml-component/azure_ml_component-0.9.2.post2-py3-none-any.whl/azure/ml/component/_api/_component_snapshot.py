...
class ComponentSnapshot:
    ...
    @classmethod
    def from_spec(cls, spec_file_path, additional_amlignore_file=None, logger=None, **kwargs):
        """
        ...
        if result.trial_file:
            ...
            result = cls(spec_file_path=sweep_snapshot.trial_file, logger=logger, **kwargs)
