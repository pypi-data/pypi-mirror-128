...
class SamplesV2Operations(object):
    ...
    def open_sample_and_get_draft(
            self, subscription_id, resource_group_name, workspace_name, name, include_run_setting_params=True, has_namespace_concept=True, version=None, feed_name=None, custom_headers=None, raw=False, **operation_config):
        """
