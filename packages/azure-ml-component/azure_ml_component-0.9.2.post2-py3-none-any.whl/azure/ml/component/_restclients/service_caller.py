...
class DesignerServiceCaller(WorkspaceTelemetryMixin, RequestTelemetryMixin):
    ...
    def get_component_run_setting_parameters_mapping(self):
        return self._caller.components_workspace_independent.get_component_run_setting_parameters_mapping(
            custom_headers=self._get_custom_headers(),
            run_setting_type="Full"
        )
    ...
    @track(_get_logger)
    def get_component(self, component_name, version=None, feed_name=None, include_run_setting_params=False,
                      get_yaml=True):
        """Get component dto
