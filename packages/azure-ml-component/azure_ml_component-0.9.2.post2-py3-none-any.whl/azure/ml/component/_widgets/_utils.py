...
def _get_graph_from_query_dict(query_dict):
...
def _get_run_status_from_query_dict(query_dict):
    designer_service_caller = _get_designer_service_caller_from_dict(query_dict)
...
def _get_graph_no_staus_from_query_dict(query_dict):
    designer_service_caller = _get_designer_service_caller_from_dict(query_dict)
...
def _get_step_run_details_from_run(run, query_dict):
...
def _get_child_runs_from_query_dict(query_dict):
    designer_service_caller = _get_designer_service_caller_from_dict(query_dict)
...
def _get_pipeline_run_from_query_dict(query_dict):
    designer_service_caller = _get_designer_service_caller_from_dict(query_dict)
    run_id = query_dict['runId']
