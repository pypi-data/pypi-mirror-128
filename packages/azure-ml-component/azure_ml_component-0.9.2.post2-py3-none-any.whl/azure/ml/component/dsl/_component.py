...
from azure.ml.component.dsl.types import Input, Output, _Param, String, _InputFileList, _OutputFile, \
    _get_param_with_standard_annotation
from azure.ml.component._aml_core_dependencies import _get_tagged_image
from azure.ml.component._util._exceptions import DSLComponentDefiningError, TooManyDSLComponentsError, \
