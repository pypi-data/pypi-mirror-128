...
class Environment:
    ...
    .. note::
        ...
        .. code-block:: python
            ...
            env = Environment(workspace=ws, name="AzureML-Minimal")
            # Or use a curated environment with a specific version
            env = Environment(workspace=ws, name="AzureML-Minimal", version="19")
    ...
    def __init__(self, *, workspace: Workspace=None, name: str=None, version: str=None, file: str=None, **kwargs):
...
class Docker:
    ...
    def __init__(self, *, image: str=None, file: str=None, **kwargs):
        """
...
class Conda:
    ...
    def __init__(self, *, pip_requirements_file: str=None, conda_file: str=None, **kwargs):
        """
