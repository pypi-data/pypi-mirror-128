...
from ...mocks import (
    aml_dataset_mock, get_multiclass_labeling_df, MockRun, open_classification_file
)
...
class TestTextClassificationInferenceTests:
    ...
    def test_inference_labeling_service(
            ...
            auto_config_mock, np_load_mock, pytorch_data_wrapper_mock, get_by_id_mock
    ):
        label_column_name = "labels_col"
        mock_run = MockRun(
        ...
        mock_aml_dataset = aml_dataset_mock(get_multiclass_labeling_df())
        ...
        np_load_mock.return_value = np.array(['label_1', 'label_2', 'label_3'])
    ...
    def test_inference_with_datapoint_id(
        ...
        load_training_artifacts_mock.return_value = MagicMock(), MagicMock(), MagicMock()
