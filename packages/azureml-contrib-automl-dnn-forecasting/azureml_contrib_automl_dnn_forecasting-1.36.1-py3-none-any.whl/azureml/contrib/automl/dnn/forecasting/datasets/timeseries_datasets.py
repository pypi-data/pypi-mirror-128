...
class TimeSeriesDataset(AbstractDNNTimeSeriesDataset):
    ...
    def __init__(self,
        ...
        :param min_grain_for_embedding: minimum number of samples per grain to enable embedding.
        :param grain_feature_col_prefix: column prefix of the transferred grain.
    ...
    def get_train_test_split(self, validation_percent: float = 0.1):
        ...
        if len(test_data_grains) == 0:
            ...
            test_item = _DataGrainItem(grainitem_to_split.X_df, grainitem_to_split.y, 0, 1, offset=0)
