                ...
                if 'key_mapping' in config_data.keys() and 'key_value' in config_data.keys():
                    if 'key' in config_data['key_mapping'].keys() and 'iv' in config_data['key_mapping'].keys():
                        ...
                        if key_name in config_data['key_value'].keys() and iv_name in config_data['key_value'].keys():
                            ...
                            print('Decryption failed! Incorrect config (unknown vey value Pair)', flush=True)
                    else:
                        print('Decryption failed! Incorrect config (missing key and iv)', flush=True)
                else:
                    print('Decryption failed! Incorrect config', flush=True)
            except Exception as e:
                print(traceback.format_exc(), flush=True)
                pass
        else:
            print('Decryption failed! Missing config file', flush=True)
