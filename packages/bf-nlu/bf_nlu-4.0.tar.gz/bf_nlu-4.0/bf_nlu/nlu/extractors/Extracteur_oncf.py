...
class Extracteur_oncf(Component):
	...
	def convert_to_bf_nlu_day(self, value):
	...
	def convert_to_bf_nlu_month(self, value):
		"""Convert model output into the bf_nlu NLU compatible output format."""
		...
		return entity
	def convert_to_bf_nlu_horaire(self, value):
		"""Convert model output into the bf_nlu NLU compatible output format."""
	...
	def convert_to_bf_nlu_numbers(self, value):
		"""Convert model output into the bf_nlu NLU compatible output format."""
...
#Detection des cartes d'abonnement
			...
			entity_tranche_horaire = self.convert_to_bf_nlu_horaire(tranche_horaire)

			month = []
			month = self.convert_to_bf_nlu_month(entit_mois)
			
			date_conv = self.convert_to_bf_nlu_day(entit_jour)
			numbers = self.convert_to_bf_nlu_numbers(entity_numb)
