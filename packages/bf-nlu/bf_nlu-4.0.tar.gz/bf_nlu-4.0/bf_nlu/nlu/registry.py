...
from bf_nlu.constants import DOCS_URL_COMPONENTS
...
from bf_nlu.nlu.classifiers.embedding_intent_classifier import EmbeddingIntentClassifier
from bf_nlu.nlu.extractors.crf_entity_extractor import CRFEntityExtractor
from bf_nlu.nlu.extractors.duckling_http_extractor import DucklingHTTPExtractor
...
from bf_nlu.nlu.extractors.extract_dupont import Extract_dupont
from bf_nlu.nlu.featurizers.sparse_featurizer.lexical_syntactic_featurizer import (
    LexicalSyntacticFeaturizer,
)
from bf_nlu.nlu.tokenizers.Whitespace_tokenizer_ar import WhitespaceTokenizer_ar
from bf_nlu.nlu.tokenizers.Whitespace_tokenizer_fr import WhitespaceTokenizer_fr
...
from bf_nlu.nlu.model import Metadata
from bf_nlu.nlu.selectors.response_selector import ResponseSelector
from bf_nlu.nlu.tokenizers.convert_tokenizer import ConveRTTokenizer
...
from bf_nlu.nlu.tokenizers.whitespacetokenizer_oncf_ar import WhitespaceTokenizer_oncf_ar
from bf_nlu.nlu.tokenizers.WhitespaceTokenizer_oncf_ar_v2 import WhitespaceTokenizer_oncf_ar_v2
...
from bf_nlu.utils.common import class_from_module_path, raise_warning

from bf_nlu.nlu.tokenizers.whitespacetokenizer_oncf_fr import WhitespaceTokenizer_oncf_fr
from bf_nlu.nlu.tokenizers.whitespacetokenizer_oncf_fr_v2 import WhitespaceTokenizer_oncf_fr_v2
from bf_nlu.nlu.tokenizers.whitespacetokenizer_omran_fr import WhitespaceTokenizer_omran_fr
from bf_nlu.nlu.tokenizers.whitespacetokenizer_omran_ar import WhitespaceTokenizer_omran_ar

from bf_nlu.nlu.extractors.omran_produit_extractor import Extracteur_omran
from bf_nlu.nlu.extractors.Extracteur_oncf import Extracteur_oncf
from bf_nlu.utils.tensorflow.constants import (
...
if typing.TYPE_CHECKING:
    ...
    from bf_nlu.nlu.config import bf_nluNLUModelConfig, bf_nluNLUModelConfig
...
def create_component_by_config(
    component_config: Dict[Text, Any], config: "bf_nluNLUModelConfig"
) -> Optional["Component"]:
