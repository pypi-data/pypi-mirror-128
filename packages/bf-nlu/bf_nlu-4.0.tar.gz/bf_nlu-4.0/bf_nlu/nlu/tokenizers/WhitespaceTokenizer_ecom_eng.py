...
from custom_func.generateur_ecom_ang import generateur_ecom_ang
from custom_func.clean_data_ang import clean_data_ang
from custom_func.clean_data_ang_training import clean_data_ang_training
import langid
...
class WhitespaceTokenizer_ecom_ang(Tokenizer,Component):
    ...
    def tokenize(self, message: Message, attribute: Text) -> List[Token]:
        ...
        print("words")
        print(words)
        words2 = clean_data_ang_training(words)
        print("words2")
        print(words2)
    ...
    def tokenize_pr(self, message: Message, attribute: Text ) -> List[Token]:
        ...
        with open("dictionaries_ecom/dict_ecom_ang.txt", 'r',encoding="utf8") as f:
            list = set(chain(*(line.split() for line in f if line)))
        words2 = clean_data_ang(list,words)
        dicto = {}
