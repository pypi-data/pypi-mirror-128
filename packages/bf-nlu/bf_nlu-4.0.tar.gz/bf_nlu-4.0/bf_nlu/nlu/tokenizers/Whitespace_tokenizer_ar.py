...
class WhitespaceTokenizer_ar(Tokenizer, Component):
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(WhitespaceTokenizer_ar, self).__init__(component_config)
    ...
    def tokenize(self, message: Message, attribute: Text) -> List[Token]:
        ...
        with open("dictionaries/dict_ar.txt", 'r',encoding="utf8") as f:
            list2 = set(chain(*(line.split() for line in f if line)))
        wordss = []
        #Data Cleaning during training :
...
#replace indou arabic numbers:
    ...
    def tokenize_arab(self, message: Message, attribute: Text) -> List[Token]:
        ...
        for word in words2:
            ...
            print("word_corrected_arab"+word_corr)
            word_offset = texte.index(word, running_offset)
            word_len = len(word)
            running_offset = word_offset + word_len
