...
from bf_nlu.nlu.training_data import TrainingData, Message
from itertools import *
from custom_func.generateur_dup import generateur_dup
from bf_nlu.nlu.constants import TOKENS_NAMES, MESSAGE_ATTRIBUTES, TEXT,INTENT
import jellyfish
...
class WhitespaceTokenizer_dup(Tokenizer):
    ...
    def tokenize_tr(self, message: Message, attribute: Text) -> List[Token]:
        ...
        stop_words = ['en','homme','femme','avez','qu','et','ceci','cela','si','pouvez','tout','avant','vous','sur','dans','peut','peux','votre','c','quoi','t','pouvez','pour','me','veuillez','s','d','ca','cette','ce','est','il','a','plus','est-il','avoir','etre','que','qui','si','veux','en','j','ai','des','les','quelles','sont','quels','du','que','ce','est','je','un','une','le','la','de','avec','sur','moi','avec','des','stp','plait','les','tu','puis','svp','par','aux','et','voudrais','souhaite','souhaiterai','me','d','puis','m','avant','mes']
        text = text.lower()
