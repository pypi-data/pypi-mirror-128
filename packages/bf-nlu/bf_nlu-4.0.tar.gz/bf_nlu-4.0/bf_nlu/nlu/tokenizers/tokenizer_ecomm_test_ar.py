...
class WhitespaceTokenizer_ecomm_info_ar(Tokenizer, Component):
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(WhitespaceTokenizer_ecomm_info_ar, self).__init__(component_config)
...
#replace indou arabic numbers
        ...
        print(words)
        print("words")
        cleaned_text = clean_data_ar(words)
        cleaned_text
        print("cleaned_text")
        print(cleaned_text)
