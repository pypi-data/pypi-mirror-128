...
class WhitespaceTokenizer_arab(Tokenizer, Component):
    ...
    def __init__(self, component_config: Dict[Text, Any] = None) -> None:
        ...
        super(WhitespaceTokenizer_arab, self).__init__(component_config)
    ...
    #tokenizer of the training process
