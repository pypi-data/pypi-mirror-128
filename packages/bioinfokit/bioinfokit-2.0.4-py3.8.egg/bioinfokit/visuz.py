...
class GeneExpression:
    ...
    @staticmethod
    def volcano(df="dataframe", lfc=None, pv=None, lfc_thr=(1, 1), pv_thr=(0.05, 0.05),
                ...
                legendlabels=['significant up', 'not significant', 'significant down'], theme=None, title=None):
    ...
    @staticmethod
    def ma(df="dataframe", lfc=None, ct_count=None, st_count=None, lfc_thr=(1, 1), valpha=1, dotsize=8,
           markerdot="o", dim=(6, 5), r=300, show=False, color=("green", "grey", "red"), ar=0, figtype='png',
