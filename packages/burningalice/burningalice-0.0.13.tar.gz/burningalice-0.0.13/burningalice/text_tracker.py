    ...
    def process_frame(self, frame_key, frame, label_and_boxes):
        ...
        for label_to_track in labels_to_track:
            ...
            if self.messages_frame_count[label_to_track] == 0 or required_skip_frames == 0:
                pass
            elif self.messages_frame_count[label_to_track] - self.current_frame_number < required_skip_frames:
                    continue
...
#        filename = '%s.png' % ((str(uuid.uuid4())))
    ...
    def compare_all_configs_againsts_other_images(self, config_mapper, restricted_labels = None):
        ...
        for label_to_track in labels_to_track:
            ...
            overriden_images = check_images_against_config_override(tracking_configuration, threshold, other_images)
    ...
    def check_images_against_config_override(self, tracking_configuration, threshold, image_names):
        overriden_images = []
