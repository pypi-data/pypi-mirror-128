...
from canvas_workflow_kit.value_set.v2018 import (
    BilateralAmputationOfLegBelowOrAboveKnee, LeftUnilateralAmputationAboveOrBelowKnee,
    PulseExamOfFoot, RightUnilateralAmputationAboveOrBelowKnee, SensoryExamOfFoot,
    UnilateralAmputationBelowOrAboveKneeUnspecifiedLaterality, VisualExamOfFoot)
...
class ClinicalQualityMeasure123v6(DiabetesQualityMeasure):
    ...
    description = (
        'Patients 18-75 years of age with diabetes who have not received a foot exam in the last year.'
    )
        ...
        if self.in_denominator():
            ...
            if self.in_numerator():
                ...
                result.add_narrative(
                    f'{first_name} has diabetes and his comprehensive foot exam was done {self.period}.'
                )
            else:
                result.due_in = -1
