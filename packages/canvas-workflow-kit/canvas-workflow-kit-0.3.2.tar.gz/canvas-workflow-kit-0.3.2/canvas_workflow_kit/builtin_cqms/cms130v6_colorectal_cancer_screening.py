...
from canvas_workflow_kit.recommendation import ImagingRecommendation, LabRecommendation, ReferRecommendation
...
class ClinicalQualityMeasure130v6(ExternallyAwareClinicalQualityMeasure, ClinicalQualityMeasure):
    ...
    More information: https://ecqi.healthit.gov/ecqm/measures/cms130v6
    """
    ...
    information = 'https://ecqi.healthit.gov/ecqm/measures/cms130v6'
