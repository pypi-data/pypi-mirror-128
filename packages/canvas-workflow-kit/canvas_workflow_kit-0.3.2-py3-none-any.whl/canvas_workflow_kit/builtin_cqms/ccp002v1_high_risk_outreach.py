...
from canvas_workflow_kit.value_set.specials import Covid19QuestionnaireHighRiskOutreach, Covid19QuestionnaireSymptomaticSurveillance
            ...
            if self.in_numerator():
                ...
                if self.high_risk_conditions:
                    ...
                    if has_display:
                        ...
                        result.add_narrative(
                            f'{self.patient.first_name} has {len(self.high_risk_conditions)} high risk conditions'
                        )
