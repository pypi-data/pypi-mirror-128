...
class CustomerScanPhysicalActivityIntervention(ExternallyAwareClinicalQualityMeasure,
    ...
    def enabled(cls) -> bool:
        return settings.IS_HEALTHCHEC

    @property
    def references(self) -> List[str]:
        return ['Written by SCAN']
    ...
    def in_numerator(self) -> bool:
        ...
        referred_for_physical_activity_intervention = self.referred_for_physical_activity_intervention_on_or_after(
    ...
    def craft_satisfied_result(self):
        ...
        if referred_for_physical_activity_intervention:
            result.add_narrative(
                ...
                f'{self.display_date(self.last_referral_for_physical_activity_intervention_date())}.'
            )
        else:
