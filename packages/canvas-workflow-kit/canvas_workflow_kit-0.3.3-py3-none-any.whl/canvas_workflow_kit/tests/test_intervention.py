...
class BannerAlertInterventionTest(SDKBaseTest):
    def test___init__error_no_narrative(self):
        with pytest.raises(TypeError) as init_error:
            BannerAlertIntervention(intent='warning', placement=['scheduling'])
        self.assertIn(
    ...
    def test___init__error_no_intent_no_narrative(self):
        with pytest.raises(TypeError) as init_error:
            BannerAlertIntervention(placement=['scheduling'])
        self.assertIn(
    ...
    def test___init__error_no_intent(self):
        with pytest.raises(TypeError) as init_error:
            BannerAlertIntervention(placement=['scheduling'], narrative='Call your mom!')
        self.assertIn(
    ...
    def test___init__(self):
        alert = BannerAlertIntervention(
            narrative='Call your mom!', intent='warning', placement=['scheduling'])
        ...
        self.assertEqual(alert.placement, ['scheduling'])
    ...
    def test_narrative(self):
        alert1 = BannerAlertIntervention(
            narrative='H', intent='warning', placement=['scheduling'])
    ...
    def test_placement_type(self):
        alert1 = BannerAlertIntervention(
            ...
            placement=['scheduling', 'chart', 'profile', 'appointment_card'])
        self.assertEqual(alert1.placement, ['scheduling', 'chart', 'profile', 'appointment_card'])
