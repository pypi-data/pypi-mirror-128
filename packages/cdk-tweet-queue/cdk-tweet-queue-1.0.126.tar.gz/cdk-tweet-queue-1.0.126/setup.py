    ...
    """
{
    ...
    "package_data": {
        "cdk_tweet_queue._jsii": [
            "cdk-tweet-queue@1.0.126.jsii.tgz"
        ],
        "cdk_tweet_queue": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-dynamodb>=1.132.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.132.0, <2.0.0",
        "aws-cdk.aws-events>=1.132.0, <2.0.0",
        "aws-cdk.aws-iam>=1.132.0, <2.0.0",
        "aws-cdk.aws-lambda-nodejs>=1.132.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.132.0, <2.0.0",
        "aws-cdk.aws-sqs>=1.132.0, <2.0.0",
