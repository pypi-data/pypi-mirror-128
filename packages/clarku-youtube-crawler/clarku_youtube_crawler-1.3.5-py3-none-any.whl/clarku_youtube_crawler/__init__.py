...
def generate_config():
    ...
    subtitlefilepath={
        "VIDEO_SUBTITLE_DIR": f"/video_subtitles/"
    }
    ...
    config.add_section('subtitlefilepath')
    config.set('subtitlefilepath', '; all sub directories in this section will be under SUBTITLE_PARENT_PATH')
    for k, v in subtitlefilepath.items():
        config.set("subtitlefilepath", k, v)
