...
StatePropagatorOutputs = function_params.DefaultOutputEnum
...
class StatePropagator(function_params.FunctionParams):
    ...
    _input_enum: Type[Enum] = pydantic.PrivateAttr(default=StatePropagatorInputs)
    _output_enum: Type[Enum] = pydantic.PrivateAttr(default=StatePropagatorOutputs)
