...
def may_have_subcomponents(obj):
    """
    Args:
        obj: an object.
    Returns:
        ...
        False.
    """
    return hasattr(obj, "component_objects") and callable(obj.component_objects)


def _set_active(obj, attr_value):
    """
    ...
    def change_active_attr(_obj, active):
...
class StoreSpec(object):
    ...
    def __init__(
        ...
        skip_with_classes = [(i, []) for i in skip_classes if i not in classes] + list(
            classes
        )
    ...
    def get_class_attr_list(self, obj):
        """
    ...
    def get_data_class_attr_list(self, obj):
        """
        ...
        for i, cl in enumerate(self.data_classes):
            if isinstance(obj, cl) or (isinstance(obj, type) and issubclass(obj, cl)):
                ...
                filter_function = self.data_class_filter[i]  # this does not make sense
        return attr_list, filter_function
