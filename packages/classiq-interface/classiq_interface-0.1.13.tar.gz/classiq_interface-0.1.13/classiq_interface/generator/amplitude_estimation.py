...
AmplitudeEstimationInputs = function_params.DefaultInputEnum
AmplitudeEstimationOutputs = function_params.DefaultOutputEnum
...
class AmplitudeEstimation(function_params.FunctionParams):
    ...
    _input_enum: Type[Enum] = pydantic.PrivateAttr(default=AmplitudeEstimationInputs)
    _output_enum: Type[Enum] = pydantic.PrivateAttr(default=AmplitudeEstimationOutputs)
