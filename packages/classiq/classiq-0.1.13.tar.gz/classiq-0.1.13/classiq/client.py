...
class Client:
    ...
    def __init__(self, conf: config.Configuration):
        ...
        self._client_args = self._make_client_args()
    ...
    async def call_api(
        ...
        async with httpx.AsyncClient(**self._client_args) as async_client:
    ...
    def sync_call_api(
        ...
        with httpx.Client(**self._client_args) as sync_client:
