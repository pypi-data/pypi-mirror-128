...
def log(func_to_log):
    ...
    def log_saver(*args, **kwargs):
        logger.debug(
            'Была вызвана функция %s', func_to_log.__name__, 'c параметрами', args , kwargs,
            '. Вызов из модуля', func_to_log.__module__)
...
def login_required(func):
    ...
    def checker(*args, **kwargs):
        ...
        from server.server3 import MessageProcessor
        from server.common.variables import ACTION, PRESENCE
