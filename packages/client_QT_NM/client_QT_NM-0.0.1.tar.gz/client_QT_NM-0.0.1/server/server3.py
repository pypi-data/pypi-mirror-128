...
from server.server2.core import MessageProcessor
from server.server2.database import ServerStorage
from server.server2.main_window import MainWindow
...
def arg_parser(default_port, default_address):
    ...
    logger.debug(
        'Инициализация парсера аргументов коммандной строки: %s', sys.argv)
...
def config_load():
    ...
    dir_path = os.getcwd()
    config.read(f"{dir_path}/{'server2.ini'}")
