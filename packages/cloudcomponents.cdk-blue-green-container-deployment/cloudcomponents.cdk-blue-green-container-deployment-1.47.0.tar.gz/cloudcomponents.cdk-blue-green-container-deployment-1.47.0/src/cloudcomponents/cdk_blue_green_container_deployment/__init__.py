...
from aws_cdk.aws_codedeploy.TrafficRoutingConfigProperty import TrafficRoutingConfigProperty
from aws_cdk.aws_codedeploy.TimeBasedCanaryProperty import TimeBasedCanaryProperty
from aws_cdk.aws_codepipeline_actions import CodeDeployEcsContainerImageInput
from aws_cdk.aws_codepipeline import StageProps, StageProps, StageProps
from aws_cdk.core import Construct, Duration, Stack, StackProps
...
class BlueGreenContainerDeploymentStack(Stack):
    def __init__(self, scope, id, *, description=None, env=None, stackName=None, tags=None, synthesizer=None, terminationProtection=None, analyticsReporting=None):
        ...
        prod_listener = load_balancer.add_listener("ProdListener",
            port=80
        )
        ...
        deployment_config = EcsDeploymentConfig(self, "DeploymentConfig",
            ...
            traffic_routing_config=TrafficRoutingConfigProperty(
                type="TimeBasedCanary",
                time_based_canary=TimeBasedCanaryProperty(
                    canary_interval=5,
        ...
        deployment_group = EcsDeploymentGroup(self, "DeploymentGroup",
            ...
            target_groups=[prod_target_group, test_target_group],
            prod_traffic_listener=prod_listener,
            test_traffic_listener=test_listener,
            termination_wait_time=Duration.minutes(100),
