...
def get_account_membership(
    ...
    if account is None:
        account = response.get("username", "").lower()
...
def notebooks_jobs_deprecation(func):
    @functools.wraps(func)
    def inner(*args, **kwargs):
        warnings.warn(
            "The Coiled Notebooks and Coiled Jobs functionality is being deprecated. After December 1, 2021, "
            "these functionalities will no longer be available. "
            "Ensure that you list your job configurations and save them "
            "before the end of the deprecation period (if desired). "
            "Ensure that you save your notebooks to your local machine "
            "before the end of the deprecation period (if desired). ",
