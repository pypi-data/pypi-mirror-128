...
.. toctree::
   ...
   Microsoft Azure <backends_azure>
...
of your own infrastructure. You can also run Coiled in your preferred
:doc:`cloud provider <backends>` or in your own AWS, GCP, or Azure account.
...
.. panels::
   ...
   Use Coiled with Azure
   ^^^^^^^^^^^^^^^^^^^^^

   .. figure:: images/logo-azure.png
      :width: 100%
      :alt: Use Coiled with Microsoft Azure
...
or your own AWS, GCP, or Azure cloud account.
...
* **Cloud Computing Environment**
  ...
  :doc:`different backends <backends>` and cloud providers, including AWS, GCP,
  or Azure.
