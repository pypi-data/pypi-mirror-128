...
class IAMConstructConti(core.Construct):
    def __init__(
            self,
        ...
        print('this is the IAM Constrcut from the PIP POC')
...
class IAMConstructConti2(core.Construct):
    def __init__(
            self,
            scope: core.Construct,
            id: str,
        ...
        super().__init__(scope, id, **kwargs)
        print('this is the IAM Construct2 from the PIP POC')
