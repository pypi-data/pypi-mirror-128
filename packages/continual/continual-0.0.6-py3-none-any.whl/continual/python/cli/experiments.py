...
def list(
    ...
    if model_version is not None:
        mv_slug = "projects/%s/models/%s/versions/%s" % (
            project,
            model,
            model_version,
        )
        c = c.model_versions.get(mv_slug)
        model_snippet = "for model version %s of model %s " % (model_version, model)
...
def get(
    ...
    model_version: str = typer.Option(None, help="Model version ID."),
    project: str = typer.Option(None, help="Project ID."),
    model: str = typer.Option(None, help="Project ID."),
