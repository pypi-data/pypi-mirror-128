...
from gateways.common.cs18_api_classes import AccessLink, TerraformModuleDescriptor, \
    TerraformModuleInput, TerraformModuleComputeService
...
class AccountRepositoryResponse:
    def __init__(self, repository_id: str, name: str, provider_id: str, provider_name: str, allow_sharing: str,
...
class TerraformModuleDescriptorResponse(TerraformModuleDescriptor):
    def __init__(self, module_name: str = None, module_repo_name: str = None, module_root_path: str = None,
                 ...
                 outputs: List[TerraformModuleInput] = None,
        ...
        super().__init__(module_name, module_repo_name, module_root_path, description,
                         terraform_version, enable_auto_tagging, exclude_from_tagging,
                         inputs, outputs, compute_services, allowed_spaces)
        self.created_date = created_date
        self.created_by = created_by
        self.last_modified = last_modified
        self.modified_by = modified_by
