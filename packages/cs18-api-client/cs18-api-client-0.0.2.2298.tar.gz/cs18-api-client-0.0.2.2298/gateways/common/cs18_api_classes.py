...
class TerraformModuleDescriptor:
    ...
    def __eq__(self, other):
        ...
        exclude_from_tagging = self.compare_arrays(self.exclude_from_tagging, other.exclude_from_tagging)
        allowed_spaces = self.compare_arrays(self.allowed_spaces, other.allowed_spaces)
