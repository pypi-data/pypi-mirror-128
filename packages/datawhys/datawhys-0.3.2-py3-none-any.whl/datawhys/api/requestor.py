...
from datawhys.api.util import encode_multipart, get_token


class APIRequestor(object):
    def __init__(self, token=None, client=None, api_base=None, auth_enabled=None):
        self.api_base = api_base or datawhys.api_base
        self.api_token = token or datawhys.api_token
        ...
        if self.auth_enabled:
            ...
            elif datawhys.api_token:
                self.api_token = datawhys.api_token
            else:
                datawhys.api_token = get_token(datawhys.api_key, datawhys.api_secret)
                self.api_token = datawhys.api_token
