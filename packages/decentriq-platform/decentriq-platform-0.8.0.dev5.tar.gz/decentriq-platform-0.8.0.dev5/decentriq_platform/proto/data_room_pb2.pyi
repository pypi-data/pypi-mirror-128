...
class DataRoom(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"attestationSpecifications",b"attestationSpecifications",u"authenticationMethods",b"authenticationMethods",u"computeNodes",b"computeNodes",u"id",b"id",u"userPermissions",b"userPermissions"]) -> None: ...
...
class ComputeNode(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"node",b"node"]) -> typing_extensions.Literal["leaf","branch"]: ...
...
class ComputeNodeBranch(google.protobuf.message.Message):
    ...
    dependencies: google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text] = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"attestationSpecificationIndex",b"attestationSpecificationIndex",u"config",b"config",u"dependencies",b"dependencies"]) -> None: ...
...
class AuthenticationMethod(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_trustedPki",b"_trustedPki"]) -> typing_extensions.Literal["trustedPki"]: ...
...
class Permission(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"permission",b"permission"]) -> typing_extensions.Literal["executeComputePermission","leafCrudPermission","retrieveDataRoomPermission","retrieveAuditLogPermission","retrieveDataRoomStatusPermission","updateDataRoomStatusPermission","retrievePublishedDatasetsPermission","dryRunPermission"]: ...
