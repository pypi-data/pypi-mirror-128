...
_DATANONCEPUBKEY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pki', full_name='delta_enclave_api.DataNoncePubkey.pki', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='auth', full_name='delta_enclave_api.DataNoncePubkey.auth',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_PKI = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='certChainPem', full_name='delta_enclave_api.Pki.certChainPem', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATANONCEPUBKEY.fields_by_name['pki'].message_type = _PKI
_DATANONCEPUBKEY.oneofs_by_name['auth'].fields.append(
  _DATANONCEPUBKEY.fields_by_name['pki'])
_DATANONCEPUBKEY.fields_by_name['pki'].containing_oneof = _DATANONCEPUBKEY.oneofs_by_name['auth']
