# -*- coding: utf-8 -*-
#
# decimalfp documentation build configuration file, created by
# sphinx-quickstart on Sat Nov 22 18:00:30 2014.
#
...
full_version = get_distribution(project).version
...
htmlhelp_basename = 'decimalfpdoc'
...
latex_documents = [
    ('index', 'decimalfp.tex', u'decimalfp Documentation',
     u'Michael Amrhein', 'manual'),
]
...
man_pages = [
    ('index', 'decimalfp', u'decimalfp Documentation',
     [u'Michael Amrhein'], 1)
]
...
type_aliases = {
    "SupportsIntOrFloat": "SupportsIntOrFloat",
    "DecValueT": "DecValueT",
    "Integer": "Integral",
    }
