...
def eval_jahreszahl(update: Update, context: CallbackContext, echter_wert, richtig_text, vorher_singular_text, vorher_plural_text, spaeter_singular_text, spaeter_plural_text):
    import re
...
def eval_prozentzahl(update: Update, context: CallbackContext, echter_wert, richtig_text, falsch_text):
...
action_functions = {"eval_jahreszahl": eval_jahreszahl,
                    "eval_prozentzahl": eval_prozentzahl,
                    }
