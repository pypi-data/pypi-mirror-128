...
@get_input_type_from_lookup.register(ExtractYear)
...
@get_input_type_from_lookup.register(ExtractIsoYear)
...
def convert_lookup_to_int(lookup, field):
    return convert_lookup(convert_field_to_int, lookup, field)
