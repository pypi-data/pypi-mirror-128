...
from bluexpress24.settings import api_settings

logger = logging.getLogger(__name__)


class Bluexpress24Handler:
    """
    ...
    def get_shipping_label(self, shipping_id):
        raise NotImplementedError(
            'get_shipping_label is not a method implemented for Bluexpress24Handler')
    ...
    def get_tracking(self, identifier):
        ...
        """
        raise NotImplementedError(
            'get_tracking is not a method implemented for Bluexpress24Handler')
