...
class ProductsItem(ParentItem):
    ...
    def __init__(
            ...
            children=[
                 ...
                 ChildItem(model='categories.category'),
                 ChildItem(model='manufacturers.manufacturer'),
                 ChildItem(model='attributes.attribute'),
                 ChildItem(model='cars.car'),
             ],
            **kwargs):
        super().__init__(
            app=app,
...
class UsersItem(ParentItem):
    ...
    def __init__(
            ...
            children=[
                ...
                ChildItem(model='reviews.review')
            ],
            **kwargs):
        super().__init__(
            label=label,
...
class FlatpagesItem(ParentItem):

    def __init__(
            self,
            label=_('Static pages'),
            icon='fa fa-columns',
            children=[
                ChildItem(model='flatpages.flatpage'),
                ChildItem(model='seo.pagemeta'),
                ChildItem(_('Analytics'), model='sitemetrics.keycode'),
            ],
            **kwargs):
        super().__init__(
            label=label,
...
class OffersItem(ParentItem):

    def __init__(
            self,
            label=_('Price offers'),
            icon='fa fa-tag',
            url='admin:offers_productpriceoffer_changelist',
            **kwargs):
        super().__init__(
            label=label,
            icon=icon,
