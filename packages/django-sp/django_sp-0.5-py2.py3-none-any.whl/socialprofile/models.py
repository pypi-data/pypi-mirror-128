...
class AbstractSocialProfile(AbstractBaseUser, PermissionsMixin):
    ...
    edited_by_user = models.NullBooleanField(
        verbose_name=_("Manually Edited"), default=False, null=True, blank=True
    )
    ...
    visible = models.NullBooleanField(
        verbose_name=_("Visible in the Public Pages"),
        default=False,
        null=True,
        blank=True,
        help_text=_(
