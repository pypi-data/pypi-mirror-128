...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            for relation_filename in kwargs["relation_and_filename"]:
                relation, filename = relation_filename.split("--")
                temp_table_name = "temp_import_relations_{}".format(random_name())
                try:
                    self.execute_import_data(relation, filename, temp_table_name, *args, **kwargs)
                except:  # noqa
                    traceback.print_exc()
                    ok = False
    ...
    def execute_import_data(self, relation_name, input_filename, temp_table_name, *args, **kwargs):
        ...
        total_imported, batch_size = rows_ouput["rows_imported"], kwargs["batch_size"]
