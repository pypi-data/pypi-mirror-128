...
class UrlidGraphDbMixin(GraphDbMixin):
    node_serializer_class = NodeSerializer
    edge_serializer_class = EdgeSerializer
...
class SavedGraphViewSet(UrlidGraphDbMixin, viewsets.ModelViewSet):
...
class SavedGraphDetails(UrlidGraphDbMixin, APIView):
    edge_serializer_class = EdgeSerializer
