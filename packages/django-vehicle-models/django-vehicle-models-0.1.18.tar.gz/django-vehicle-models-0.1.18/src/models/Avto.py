...
class Avto(models.Model):
    ...
    odometer = models.FloatField(default=-1, verbose_name='Odometer', default='')
    ...
    condition = models.CharField(blank=True, default=None, choices=conditions, verbose_name='Status of vehicle, repaired/damaged')
