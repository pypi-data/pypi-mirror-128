...
class Avto(models.Model):
    ...
    year_car = models.CharField(max_length=255, blank=True, verbose_name='Manufacturing year')
    selling_branch = models.CharField(max_length=255, blank=True, verbose_name='Selling Branch')
    vin_status = models.CharField(max_length=255, blank=True, verbose_name='VIN')
    ...
    odometer = models.FloatField(default=-1, verbose_name='Odometer')
    odometer_desc = models.CharField(max_length=255, blank=True, verbose_name='Odometer extra', default='')
    ...
    data1 = models.CharField(max_length=255, blank=True, verbose_name='Description (data1)')
    data2 = models.CharField(max_length=255, blank=True, verbose_name='Description (data2)')
    ...
    YESNOT = (('yes', 'yes'),('not', 'not'),('new', 'new'),('del', 'del'))
    ...
    BUY = ((None, 'No_info'),('BB', 'New buy it now price'),('AA', 'New our price'),)
    ...
    locations = (('et', 'estonia'),('us', 'united states'),('de', 'germany'),('pl', 'poland'),('lv', 'latvia'),('lt', 'lithuania'))
    conditions = (('repaired', 'repaired'),('damaged', 'damaged'),(None, 'unknown'))
    location = models.CharField(blank=True, max_length=20, default='-', choices=locations, verbose_name="current location (country)")
    posted_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, default=22)
    STATUS = (("AVAILABLE", "Available"), ("BOOKED", "Booked"), ("SOLD", "Sold"))
    condition = models.CharField(max_length=16, blank=True, default=None, choices=conditions, verbose_name='Status of vehicle, repaired/damaged')
    ...
    class Meta:
        verbose_name = "avto object (Site iaai.com)"
        ordering = ['id']
        app_label = 'avto'
