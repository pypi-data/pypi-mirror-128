...
def update_with_122(
    ...
    import_keys = {"type", "default_value", "values", "values_range", "example_values", "format"}
...
def preprocess_schema(raw_schema: raw_schema_type_hint, include_level0=False) -> schema_type_hint:
    """
