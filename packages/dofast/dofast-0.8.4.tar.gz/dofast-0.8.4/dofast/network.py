...
def shorten_url(url: str) -> str:
    _url = cf.net.post(author.get('DOMAIN_CN') + '/s', json={'url': url}).text
...
class Twitter(twitter.Api):
    def __init__(self, consumer_key, consumer_secret, access_token_key, access_token_secret):
        super(Twitter, self).__init__(consumer_key, consumer_secret, access_token_key, access_token_secret)
