...
from eavesdropper.pkg_data.mitmproxy import ctx, http
from eavesdropper.pkg_data.mitmproxy import exceptions
from eavesdropper.pkg_data.mitmproxy import flow
from eavesdropper.pkg_data.mitmproxy.net.http.http1 import assemble
...
class Export():
    ...
    def file(self, format: str, flow: flow.Flow, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
