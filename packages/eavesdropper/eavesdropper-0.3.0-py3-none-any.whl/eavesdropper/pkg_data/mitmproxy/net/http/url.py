...
from eavesdropper.pkg_data.mitmproxy.net.check import is_valid_host, is_valid_port
from eavesdropper.pkg_data.mitmproxy.utils.strutils import always_str
