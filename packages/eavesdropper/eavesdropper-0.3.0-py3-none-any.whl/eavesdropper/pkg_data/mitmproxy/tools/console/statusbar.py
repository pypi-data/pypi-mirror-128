...
from eavesdropper.pkg_data.mitmproxy.tools.console import commandexecutor
...
from eavesdropper.pkg_data.mitmproxy.tools.console.commander import commander
...
class StatusBar(urwid.WidgetWrap):
    ...
    def __init__(
            self, master: "eavesdropper.mitmproxy.tools.console.master.ConsoleMaster"
    ) -> None:
        self.master = master
