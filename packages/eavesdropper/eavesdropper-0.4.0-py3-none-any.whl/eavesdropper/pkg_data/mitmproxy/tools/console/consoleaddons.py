...
import eavesdropper.pkg_data.mitmproxy.types
from eavesdropper.pkg_data.mitmproxy import command, command_lexer
from eavesdropper.pkg_data.mitmproxy import contentviews
from eavesdropper.pkg_data.mitmproxy import ctx
from eavesdropper.pkg_data.mitmproxy import exceptions
from eavesdropper.pkg_data.mitmproxy import flow
from eavesdropper.pkg_data.mitmproxy import http
from eavesdropper.pkg_data.mitmproxy import log
from eavesdropper.pkg_data.mitmproxy import tcp
from eavesdropper.pkg_data.mitmproxy.tools.console import keymap
from eavesdropper.pkg_data.mitmproxy.tools.console import overlay
from eavesdropper.pkg_data.mitmproxy.tools.console import signals
from eavesdropper.pkg_data.mitmproxy.utils import strutils
...
class ConsoleAddon:
    ...
    def console_choose(
            ...
            cmd: eavesdropper.pkg_data.mitmproxy.types.Cmd,
            *args: eavesdropper.pkg_data.mitmproxy.types.CmdArgs
    ) -> None:
        """
    ...
    def console_choose_cmd(
            self,
            prompt: str,
            choicecmd: eavesdropper.pkg_data.mitmproxy.types.Cmd,
            subcmd: eavesdropper.pkg_data.mitmproxy.types.Cmd,
            *args: eavesdropper.pkg_data.mitmproxy.types.CmdArgs
    ) -> None:
        """
    ...
    @command.argument("part", type=eavesdropper.pkg_data.mitmproxy.types.Choice("console.bodyview.options"))
    ...
    @command.argument("flow_part", type=eavesdropper.pkg_data.mitmproxy.types.Choice("console.edit.focus.options"))
    ...
    def grideditor_load(self, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
    ...
    def grideditor_load_escaped(self, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
    ...
    def grideditor_save(self, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
    ...
    @command.argument("mode", type=eavesdropper.pkg_data.mitmproxy.types.Choice("console.flowview.mode.options"))
