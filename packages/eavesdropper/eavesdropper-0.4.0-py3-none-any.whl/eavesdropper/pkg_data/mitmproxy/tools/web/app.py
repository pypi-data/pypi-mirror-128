...
import eavesdropper.pkg_data.mitmproxy.tools.web.master  # noqa
...
from eavesdropper.pkg_data.mitmproxy import optmanager
from eavesdropper.pkg_data.mitmproxy import version


def flow_to_json(flow: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> dict:
    """
...
class RequestHandler(tornado.web.RequestHandler):
    ...
    @property
    def view(self) -> "eavesdropper.mitmproxy.addons.view.View":
        return self.application.master.view

    @property
    def master(self) -> "eavesdropper.mitmproxy.tools.web.master.WebMaster":
        return self.application.master

    @property
    def flow(self) -> eavesdropper.pkg_data.mitmproxy.flow.Flow:
...
class Application(tornado.web.Application):
    master: "eavesdropper.mitmproxy.tools.web.master.WebMaster"

    def __init__(self, master: "eavesdropper.mitmproxy.tools.web.master.WebMaster", debug: bool) -> None:
        self.master = master
        super().__init__(
