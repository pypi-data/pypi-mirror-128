...
from eavesdropper.pkg_data.mitmproxy import platform
from eavesdropper.pkg_data.mitmproxy.net import server_spec
from eavesdropper.pkg_data.mitmproxy.net.http import status_codes
...
class Core:
    ...
    @command.argument("attr", type=eavesdropper.pkg_data.mitmproxy.types.Choice("flow.set.options"))
    def flow_set(
        self,
    ...
    @command.argument("encoding", type=eavesdropper.pkg_data.mitmproxy.types.Choice("flow.encode.options"))
    def encode(
        self,
        flows: typing.Sequence[flow.Flow],
        part: str,
    ...
    def options_load(self, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
    ...
    def options_save(self, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
