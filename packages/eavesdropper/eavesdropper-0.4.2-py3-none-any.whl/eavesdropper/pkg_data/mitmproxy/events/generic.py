...
from eavesdropper.pkg_data.mitmproxy import addonmanager
from eavesdropper.pkg_data.mitmproxy import connections
from eavesdropper.pkg_data.mitmproxy import log
from eavesdropper.pkg_data.mitmproxy.proxy import protocol
...
class Events:
    ...
    def clientdisconnect(self, layer: protocol.Layer):
        """
            A client has disconnected from mitmproxy.
        """

    def serverconnect(self, conn: connections.ServerConnection):
        """
            Mitmproxy has connected to a server. Note that a connection can
            correspond to multiple requests.
        """

    def serverdisconnect(self, conn: connections.ServerConnection):
        """
            Mitmproxy has disconnected from a server.
        """

    def next_layer(self, layer: protocol.Layer):
        """
