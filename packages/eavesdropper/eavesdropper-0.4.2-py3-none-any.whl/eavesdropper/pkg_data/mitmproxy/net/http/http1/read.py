...
from eavesdropper.pkg_data.mitmproxy.net.http import request
from eavesdropper.pkg_data.mitmproxy.net.http import response
from eavesdropper.pkg_data.mitmproxy.net.http import url
