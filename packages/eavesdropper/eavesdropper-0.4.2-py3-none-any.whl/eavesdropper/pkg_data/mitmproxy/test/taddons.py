...
import eavesdropper.pkg_data.mitmproxy.options
from eavesdropper.pkg_data.mitmproxy import addonmanager
from eavesdropper.pkg_data.mitmproxy import command
from eavesdropper.pkg_data.mitmproxy import eventsequence
from eavesdropper.pkg_data.mitmproxy.addons import script, core
...
class RecordingMaster(eavesdropper.pkg_data.mitmproxy.master.Master):
...
class context:
    ...
    def __init__(self, *addons, options=None, loadcore=True):
        options = options or eavesdropper.pkg_data.mitmproxy.options.Options()
