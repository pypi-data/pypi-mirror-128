...
from eavesdropper.pkg_data.mitmproxy import certs
...
class Cut:
    ...
    def cut(
        ...
        cuts: eavesdropper.pkg_data.mitmproxy.types.CutSpec,
    ) -> eavesdropper.pkg_data.mitmproxy.types.Data:
        """
    ...
    def save(
        ...
        flows: typing.Sequence[flow.Flow],
        cuts: eavesdropper.pkg_data.mitmproxy.types.CutSpec,
        path: eavesdropper.pkg_data.mitmproxy.types.Path
    ) -> None:
        """
        ...
        if path.startswith("+"):
            ...
            path = eavesdropper.pkg_data.mitmproxy.types.Path(epath)
        try:
