...
import eavesdropper.pkg_data.mitmproxy.flow
from eavesdropper.pkg_data.mitmproxy import flowfilter
from eavesdropper.pkg_data.mitmproxy import exceptions
from eavesdropper.pkg_data.mitmproxy import command
from eavesdropper.pkg_data.mitmproxy import connections
from eavesdropper.pkg_data.mitmproxy import ctx
from eavesdropper.pkg_data.mitmproxy import io
from eavesdropper.pkg_data.mitmproxy import http
from eavesdropper.pkg_data.mitmproxy import tcp
from eavesdropper.pkg_data.mitmproxy.utils import human
...
class _OrderKey:
    ...
    def generate(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> typing.Any:  # pragma: no cover
        pass
...
class OrderRequestStart(_OrderKey):
    def generate(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> float:
        return f.timestamp_start


class OrderRequestMethod(_OrderKey):
    def generate(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> str:
...
class OrderKeySize(_OrderKey):
    def generate(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> int:
        if isinstance(f, http.HTTPFlow):
            size = 0
...
class View(collections.abc.Sequence):
    ...
    def _bisect(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> int:
        v = self._view.bisect_right(f)
        return self._rev(v - 1) + 1

    def index(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow, start: int = 0, stop: typing.Optional[int] = None) -> int:
    ...
    def getvalue(self, flow: eavesdropper.pkg_data.mitmproxy.flow.Flow, key: str, default: str) -> str:
        """
    ...
    def setvalue_toggle(
        self,
        flows: typing.Sequence[eavesdropper.pkg_data.mitmproxy.flow.Flow],
        key: str
    ) -> None:
        """
    ...
    def duplicate(self, flows: typing.Sequence[eavesdropper.pkg_data.mitmproxy.flow.Flow]) -> None:
        """
    ...
    def remove(self, flows: typing.Sequence[eavesdropper.pkg_data.mitmproxy.flow.Flow]) -> None:
        """
    ...
    def resolve(self, flow_spec: str) -> typing.Sequence[eavesdropper.pkg_data.mitmproxy.flow.Flow]:
        """
    ...
    def load_file(self, path: eavesdropper.pkg_data.mitmproxy.types.Path) -> None:
        """
    ...
    def add(self, flows: typing.Sequence[eavesdropper.pkg_data.mitmproxy.flow.Flow]) -> None:
        """
    ...
    def get_by_id(self, flow_id: str) -> typing.Optional[eavesdropper.pkg_data.mitmproxy.flow.Flow]:
        """
    ...
    def update(self, flows: typing.Sequence[eavesdropper.pkg_data.mitmproxy.flow.Flow]) -> None:
        """
...
class Focus:
    ...
    def __init__(self, v: View) -> None:
        self.view = v
        self._flow: typing.Optional[eavesdropper.pkg_data.mitmproxy.flow.Flow] = None
    ...
    @property
    def flow(self) -> typing.Optional[eavesdropper.pkg_data.mitmproxy.flow.Flow]:
        return self._flow

    @flow.setter
    def flow(self, f: typing.Optional[eavesdropper.pkg_data.mitmproxy.flow.Flow]):
...
class Settings(collections.abc.Mapping):
    ...
    def __getitem__(self, f: eavesdropper.pkg_data.mitmproxy.flow.Flow) -> dict:
