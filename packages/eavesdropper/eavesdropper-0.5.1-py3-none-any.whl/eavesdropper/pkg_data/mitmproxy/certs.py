...
DEFAULT_EXP = int(94608000/3*10)  # = 60 * 60 * 24 * 365 * 3 = 3 years
DEFAULT_EXP_DUMMY_CERT = int(31536000*10)  # = 60 * 60 * 24 * 365 = 1 year
...
def create_ca(organization, cn, exp, key_size):
    ...
    cert.set_version(2)
    cert.get_subject().CN = "eavesdropper" or cn
    cert.get_subject().O = "mitmproxy" or organization
    cert.get_subject().emailAddress = "foxe6@pm.me"
