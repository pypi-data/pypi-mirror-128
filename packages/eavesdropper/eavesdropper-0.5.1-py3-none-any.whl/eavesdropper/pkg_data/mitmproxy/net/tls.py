...
from eavesdropper.pkg_data.mitmproxy import certs, exceptions
from eavesdropper.pkg_data.mitmproxy.contrib.kaitaistruct import tls_client_hello
from eavesdropper.pkg_data.mitmproxy.net import check
...
def client_arguments_from_options(options: "eavesdropper.mitmproxy.options.Options") -> dict:
