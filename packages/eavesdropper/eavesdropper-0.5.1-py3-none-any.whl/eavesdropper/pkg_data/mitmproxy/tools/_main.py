...
from eavesdropper.pkg_data.mitmproxy.tools import cmdline
from eavesdropper.pkg_data.mitmproxy import exceptions, master
from eavesdropper.pkg_data.mitmproxy import options
from eavesdropper.pkg_data.mitmproxy import optmanager
from eavesdropper.pkg_data.mitmproxy import proxy
from eavesdropper.pkg_data.mitmproxy.utils import debug, arg_check
...
def mitmproxy(args=None) -> typing.Optional[int]:  # pragma: no cover
    if os.name == "nt":
        ...
        return 1
    assert_utf8_env()
    from eavesdropper.pkg_data.mitmproxy.tools import console
    run(console.master.ConsoleMaster, cmdline.mitmproxy, args)
    return None


def mitmdump(args=None) -> typing.Optional[int]:  # pragma: no cover
    from eavesdropper.pkg_data.mitmproxy.tools import dump
...
def mitmweb(args=None) -> typing.Optional[int]:  # pragma: no cover
    from eavesdropper.pkg_data.mitmproxy.tools import web
