...
from eavesdropper.pkg_data.mitmproxy.tools.console import layoutwidget
from eavesdropper.pkg_data.mitmproxy.tools.console import flowdetailview
from eavesdropper.pkg_data.mitmproxy.tools.console import searchable
from eavesdropper.pkg_data.mitmproxy.tools.console import tabs
import eavesdropper.pkg_data.mitmproxy.tools.console.master  # noqa
...
class FlowViewHeader(urwid.WidgetWrap):
    ...
    def __init__(
            self,
            master: "eavesdropper.mitmproxy.tools.console.master.ConsoleMaster",
    ) -> None:
        self.master = master
        self.focus_changed()
