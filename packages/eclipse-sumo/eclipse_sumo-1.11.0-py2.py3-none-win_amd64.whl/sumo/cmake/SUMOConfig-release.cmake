...
set_target_properties(SUMO::libsumocpp PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libsumocpp.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsumocpp.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS SUMO::libsumocpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_SUMO::libsumocpp "${_IMPORT_PREFIX}/lib/libsumocpp.lib" "${_IMPORT_PREFIX}/bin/libsumocpp.dll" )
...
set_target_properties(SUMO::libtracicpp PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libtracicpp.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libtracicpp.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS SUMO::libtracicpp )
list(APPEND _IMPORT_CHECK_FILES_FOR_SUMO::libtracicpp "${_IMPORT_PREFIX}/lib/libtracicpp.lib" "${_IMPORT_PREFIX}/bin/libtracicpp.dll" )
