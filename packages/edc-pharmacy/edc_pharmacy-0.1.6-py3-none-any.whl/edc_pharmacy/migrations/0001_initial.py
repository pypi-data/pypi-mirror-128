...
import edc_pharmacy.models.medication_product
import edc_pharmacy.models.medication_stock
import edc_pharmacy.models.medication_stock_create_labels
import edc_pharmacy.models.medication_stock_receiving
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', django_audit_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.')),
                ('stock_identifier', models.CharField(db_index=True, default=uuid.uuid4, max_length=36)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', django_audit_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.')),
                ('product_identifier', models.CharField(db_index=True, default=uuid.uuid4, max_length=36)),
                ('name', models.CharField(db_index=True, editable=False, max_length=250)),
                ('count_per_container', models.DecimalField(decimal_places=1, max_digits=6, verbose_name='Items per container')),
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_identifier', models.CharField(db_index=True, max_length=50, null=True)),
                ...
                ('rx_expiration_date', models.DateField(blank=True, help_text='Leave blank. Will be filled when end of study report is submitted', null=True, verbose_name='Date RX expires')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_at_site_datetime', models.DateTimeField(blank=True, null=True)),
                ...
                ('weight_in_kgs', models.DecimalField(blank=True, decimal_places=1, max_digits=6, null=True)),
                ('refill_date', models.DateField(default=edc_utils.date.get_utcnow_as_date, verbose_name='Refill date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', django_audit_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('stock_identifier', models.CharField(default=uuid.uuid4, max_length=36, unique=True)),
                ('printed', models.BooleanField(default=False)),
                ('printed_datetime', models.DateTimeField(blank=True, null=True)),
                ('in_stock', models.BooleanField(default=False)),
                ('in_stock_datetime', models.DateTimeField(blank=True, null=True)),
            ...
            managers=[
                ('objects', edc_pharmacy.models.medication_stock_create_labels.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Medication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', django_audit_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('product_identifier', models.CharField(default=uuid.uuid4, max_length=36, unique=True)),
            ...
            managers=[
                ('objects', edc_pharmacy.models.medication_product.Manager()),
            ],
        ),
        migrations.CreateModel(
            ...
            managers=[
                ('objects', edc_pharmacy.models.medication_stock.Manager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', edc_pharmacy.models.medication_stock_receiving.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='ReturnHistory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_item_reason', models.TextField(editable=False, null=True)),
                ('slug', models.CharField(db_index=True, default='', editable=False, help_text='a field used for quick search', max_length=250, null=True)),
                ('action_identifier', models.CharField(max_length=50, null=True, unique=True)),
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow)),
                ('rx_date', models.DateField(default=edc_utils.date.get_utcnow, verbose_name='Date RX written')),
                ('rx_expiration_date', models.DateField(blank=True, help_text='Leave blank. Will be filled when end of study report is submitted', null=True, verbose_name='Date RX expires')),
                ('status', models.CharField(choices=[('New', 'New'), ('partial', 'Partially filled'), ('filled', 'Filled'), ('cancelled', 'Cancelled')], default='New', max_length=25)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.medicationstock'),
        ),
        migrations.AddField(
            model_name='rxrefill',
            name='rx',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.medicationproduct'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='container',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.container'),
        ),
        migrations.AddField(
            model_name='medicationproduct',
            name='formulation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.formulation'),
        ),
        migrations.AddField(
            model_name='medicationproduct',
            name='lot_no',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.medicationlot'),
        ),
        migrations.AddField(
            model_name='medicationproduct',
            name='site',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.medicationstockcreatelabels'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='historicalrxrefill',
            name='medication_stock',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_pharmacy.medicationstock'),
        ),
        migrations.AddField(
            model_name='historicalrxrefill',
            name='rx',
        ...
        migrations.AddField(
            model_name='historicalmedicationstockreceiving',
            name='medication_product',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_pharmacy.medicationproduct'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='container',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_pharmacy.container'),
        ),
        migrations.AddField(
            model_name='historicalmedicationproduct',
            name='formulation',
        ...
        migrations.AddField(
            model_name='historicalmedicationproduct',
            name='lot_no',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_pharmacy.medicationlot'),
        ),
        migrations.AddField(
            model_name='historicalmedicationproduct',
            name='site',
        ...
        migrations.AddField(
            model_name='historicallabels',
            name='medication_stock_create_labels',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_pharmacy.medicationstockcreatelabels'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='rxrefill',
            unique_together={('rx', 'visit_code', 'visit_code_sequence'), ('rx', 'dosage_guideline', 'refill_date')},
        ),
        migrations.AlterUniqueTogether(
            name='returnhistory',
