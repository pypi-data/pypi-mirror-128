...
from elementalcms.services.pages import GetDraft, UpdateDraft
...
class Push:
            ...
            with open(spec_file_path) as page_spec_content:
                try:
                    ...
                    with open(content_file_path) as page_content:
                        ...
                        update_me_result = UpdateDraft(self.context.cms_db_context).execute(_id, page_spec)
    ...
    def build_draft_backup(self, _id):
        get_one_result = GetDraft(self.context.cms_db_context).execute(_id)
