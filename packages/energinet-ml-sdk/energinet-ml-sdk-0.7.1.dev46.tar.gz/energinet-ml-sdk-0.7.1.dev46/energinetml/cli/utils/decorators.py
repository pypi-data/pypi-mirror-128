    ...
    def _model_from_path_callback(
        ...
        if not os.path.isfile(model_file_path):
            ...
            click.echo(
                (
                    "I am looking for a folder which contains a file "
                    f"named '{Model.SCRIPT_FILE_NAME}' - either in the folder itself "
        ...
        try:
            ...
            click.echo(
                f"Failed to import your model class from file: {model_file_path}"
            )
        ...
        try:
            ...
            if required:
                ...
                click.echo(
                    (
                        "I am looking for a folder which contains a file "
                        f"named '{Model.CONFIG_FILE_NAME}' - either in the folder "
                        "itself or in one of its parent folders."
                    )
                )
