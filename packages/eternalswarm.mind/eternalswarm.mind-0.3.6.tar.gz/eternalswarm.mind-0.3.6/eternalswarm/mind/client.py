...
class Client:
    ...
    def __init__(self, ip: str, port: int, ssl: bool = False,
                 ca: Optional[bytes] = None, cert: Optional[bytes] = None,
...
class DroneClient(Client):
    ...
    def ping(self, message: str = "test") -> information_pb2.PongMessage:
        """Ping"""
    ...
    def get_info(self) -> information_pb2.Info:
        """
    ...
    def get_settings(self) -> information_pb2.SettingsList:
        """
            Get the settings list.
        """
        return self.perform_request(self.info_stub.GetSettings, information_pb2.SettingsRequest())

    def set_setting(self, section, key, value) -> information_pb2.Setting:
        """
    ...
    def enable_ssl(self, cert: str, key: str, ca: str) -> information_pb2.StatusMsg:
    ...
    def set_callback_certs(self, host: str, port: int, cert: str, key: str, ca: str) -> information_pb2.StatusMsg:
        """Enable SSL on the drone grpc socket."""
        request = information_pb2.Certificates(
            cert=cert,
            key=key,
    ...
    def restart_drone(self) -> information_pb2.StatusMsg:
        """Restart the drone"""
        return self.perform_request(
    ...
    def get_drone_capabilities(self) -> information_pb2.DroneCapabilities:
    ...
    def list_scans(self) -> models_pb2.ScanList:
        """
            List all the scans
        """
        return self.perform_request(self.scanner_stub.ListScans, scanner_pb2.ScanListRequest())

    def create_scan(self, name: str, description: str) -> models_pb2.Scan:
        """
            Create a new scan.
        """
    ...
    def update_scan(self, scan_id: int, name: str, description: str) -> models_pb2.Scan:
    ...
    def delete_scan(self, scan_id: int) -> models_pb2.EmptyMessage:
        """Update the name and description of a scan"""
        scan = models_pb2.Scan(id=scan_id)
        return self.perform_request(self.scanner_stub.DeleteScan, scan)

    def add_targets(self, scan_id: int, targets: List[str], ping: bool, nmap: bool = True,
                    masscan: bool = False, masscan_rate: int = 0, masscan_ports: Optional[List[int]] = None) -> models_pb2.Scan:
        """
    ...
    def list_hosts(self, pagination: models_pb2.Pagination) -> models_pb2.HostList:
        """
            List the hosts with the given pagination.
        """
        return self.perform_request(self.scanner_stub.ListHosts, pagination)

    def list_host_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListHostFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_host_types(self, pagination: models_pb2.Pagination) -> models_pb2.HostTypeList:
        return self.perform_request(
            self.scanner_stub.ListHostTypes,
            pagination
        )

    def get_host(self, host_id: int) -> models_pb2.Host:
    ...
    def list_services(self, pagination: models_pb2.Pagination) -> models_pb2.ServiceList:
        return self.perform_request(self.scanner_stub.ListServices, pagination)

    def get_service(self, service_id: int) -> models_pb2.Service:
        return self.perform_request(
            self.scanner_stub.GetService,
            scanner_pb2.GetRequest(id=service_id)
        )

    def list_service_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListServiceFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_vulnerabilities(self, pagination: models_pb2.Pagination) -> models_pb2.VulnerabilityList:
        return self.perform_request(self.scanner_stub.ListVulns, pagination)

    def list_vulnerability_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListVulnFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_exploits(self, pagination: models_pb2.Pagination) -> models_pb2.ExploitList:
        return self.perform_request(self.scanner_stub.ListExploits, pagination)

    def get_exploit(self, exploit_id: int) -> models_pb2.Exploit:
        return self.perform_request(
            self.scanner_stub.GetExploit,
            scanner_pb2.GetRequest(id=exploit_id)
        )

    def list_exploit_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListExploitFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_credentials(self, pagination: models_pb2.Pagination) -> models_pb2.CredentialList:
        return self.perform_request(self.scanner_stub.ListCredentials, pagination)

    def get_credential(self, credential_id: int) -> models_pb2.Credential:
        return self.perform_request(
            self.scanner_stub.GetCredential,
            scanner_pb2.GetRequest(id=credential_id)
        )

    def list_credential_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListCredentialFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_targets(self, pagination: models_pb2.Pagination) -> models_pb2.TargetList:
        return self.perform_request(self.scanner_stub.ListTargets, pagination)

    def scan_stats(self, scan_id: int) -> scanner_pb2.ScanStats:
    ...
    def pin_object(self, host_id: int = 0, service_id: int = 0, credential_id: int = 0, user_id: int = 0,
                   group_id: int = 0, domain_id: int = 0, file_id: int = 0, hash_id: int = 0) -> models_pb2.EmptyMessage:
    ...
    def list_loot_modules(self) -> models_pb2.LootModuleList:
        return self.perform_request(self.exploit_stub.ListLootModules, models_pb2.EmptyRequest())

    def list_login_modules(self) -> models_pb2.LoginModuleList:
        return self.perform_request(self.exploit_stub.ListLoginModules, models_pb2.EmptyRequest())

    def list_indexer_modules(self) -> models_pb2.IndexerModuleList:
        return self.perform_request(self.exploit_stub.ListIndexerModules, models_pb2.EmptyRequest())

    def list_remote_shares(self, service_id: int, credential_id: int, module_name: str) -> exploitation_pb2.Count:
        request = exploitation_pb2.IndexRequest(
            service_id=service_id,
            credential_id=credential_id,
            module_name=module_name,
        )
        return self.perform_request(self.exploit_stub.ListRemoteShares, request)

    def list_multiple_remote_shares(self, scan_id: int, credential_id: int, module_name: str, port: int,
                                    domain_id: int = 0, max_number: int = 0) -> exploitation_pb2.Count:
        request = exploitation_pb2.IndexRequest(
            scan_id=scan_id,
            credential_id=credential_id,
            module_name=module_name,
        ...
        return self.perform_request(self.exploit_stub.ListMultipleRemoteShares, request)

    def index_share(self, share_id: int, max_depth: int, max_duration_seconds: int, workers: int = 0) -> exploitation_pb2.Count:
        request = exploitation_pb2.IndexRequest(
            share_id=share_id,
            max_depth=max_depth,
        ...
        return self.perform_request(self.exploit_stub.IndexShare, request)

    def index_multiple_shares(self, scan_id: int, max_duration_seconds: int = 0, domain_id: int = 0,
                              port: int = 0, max_number: int = 0, workers: int = 0) -> exploitation_pb2.Count:
        request = exploitation_pb2.IndexRequest(
            scan_id=scan_id,
            max_duration_seconds=max_duration_seconds,
            domain_id=domain_id,
        ...
        return self.perform_request(self.exploit_stub.IndexMultipleShares, request)

    def exploit(self, vuln_id, exploit_id: str, credential_id: int, payload_id: str = '') -> models_pb2.Exploit:
    ...
    def list_loot(self, pagination: models_pb2.Pagination) -> models_pb2.LootList:
        return self.perform_request(self.scanner_stub.ListLoot, pagination)

    def get_loot(self, loot_id: int) -> models_pb2.Loot:
        return self.perform_request(
            self.scanner_stub.GetLoot,
            scanner_pb2.GetRequest(id=loot_id)
        )

    def list_loot_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
    ...
    def loot(self, service_id: int, credential_id: int, module_name: str,
             only_not_looted: bool = False) -> models_pb2.Loot:
        """
            Loot a service with the given credential and module name.
            The only_not_looted  flag can be given to have the drone first check the database.
            In case of only_not_looted the drone will check if the combination of service_id and module_name does not already exists.
        """
        request = exploitation_pb2.LootRequest(
            service_id=service_id,
            credential_id=credential_id,
            module_name=module_name,
            only_not_looted=only_not_looted,
        )
    ...
    def multi_loot(self, scan_id: int, credential_id: int, module_name: str, domain_id: int, port: int, max_number: int,
                   not_looted: bool, admin_only: bool = False, host_type: str = '') -> models_pb2.LootList:
        request = exploitation_pb2.LootRequest(
            credential_id=credential_id,
            module_name=module_name,
            domain_id=domain_id,
    ...
    def cancel_loot(self, loot_id: int = 0) -> models_pb2.EmptyMessage:
        request = exploitation_pb2.CancelRequest(
            id=loot_id,
        )
        return self.perform_request(self.exploit_stub.CancelLoot, request)

    def cancel_exploit(self, exploit_id: int = 0) -> models_pb2.EmptyMessage:
        request = exploitation_pb2.CancelRequest(
            id=exploit_id,
        )
        return self.perform_request(self.exploit_stub.CancelExploit, request)

    def list_discovery(self, pagination: models_pb2.Pagination) -> models_pb2.DiscoveryList:
        return self.perform_request(self.scanner_stub.ListDiscovery, pagination)

    def list_discovery_modules(self) -> models_pb2.DiscoveryModuleList:
        return self.perform_request(self.scanner_stub.ListDiscoveryModules, models_pb2.EmptyRequest())

    def create_discovery(self, scan_id: int, ping: bool, modules: List[str]) -> models_pb2.Discovery:
    ...
    def cancel_discovery(self, discovery_id: int) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def list_sessions(self, pagination: models_pb2.Pagination) -> models_pb2.SessionList:
        return self.perform_request(self.scanner_stub.ListSession, pagination)

    def get_session(self, session_id: int) -> models_pb2.Session:
        return self.perform_request(
            self.scanner_stub.GetSession,
            models_pb2.Scan(id=session_id)
        )

    def list_session_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListSessionFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_local_admins(self, pagination: models_pb2.Pagination) -> models_pb2.LocalAdminList:
        return self.perform_request(self.scanner_stub.ListLocalAdmins, pagination)

    def get_local_admin(self, admin_id: int) -> models_pb2.LocalAdmin:
        return self.perform_request(
            self.scanner_stub.GetLocalAdmin,
            models_pb2.Scan(id=admin_id)
        )

    def list_local_admin_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListLocalAdminFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_artifacts(self, pagination: models_pb2.Pagination) -> models_pb2.ArtifactList:
        return self.perform_request(self.scanner_stub.ListArtifacts, pagination)

    def get_artifact(self, artifact_id: int) -> models_pb2.Artifact:
        return self.perform_request(self.scanner_stub.GetArtifact, models_pb2.Artifact(id=artifact_id))

    def list_artifact_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(self.scanner_stub.ListArtifactFilters, models_pb2.Scan(id=scan_id))

    def get_relaying_status(self) -> relaying_pb2.RelayingStatus:
        return self.perform_request(
            self.relaying_stub.GetStatus,
            relaying_pb2.RelayingRequest()
        )

    def list_relaying_targets(self, pagination: models_pb2.Pagination) -> models_pb2.RelayingTargetList:
        return self.perform_request(
            self.scanner_stub.ListRelayingTargets,
            pagination
        )

    def list_relaying_log(self, pagination: models_pb2.Pagination) -> models_pb2.RelayingLogList:
        return self.perform_request(
            self.scanner_stub.ListRelayingLog,
            pagination
        )

    def start_responder(self, scan_id: int, arguments: str = '') -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.StartResponder,
            relaying_pb2.StartMessage(scan_id=scan_id, arguments=arguments)
        )

    def add_relaying_target(self, scan_id: int, service_id: int = 0, target_string: str = '') -> models_pb2.RelayingTarget:
        return self.perform_request(
    ...
    def add_relaying_targets(self, scan_id: int, domain_id: int = 0, max_targets: int = 1000) -> relaying_pb2.RelayingAddTargetsResponse:
        return self.perform_request(
            self.relaying_stub.AddRelayingTargets,
            relaying_pb2.RelayingAddTargetsRequest(scan_id=scan_id, domain_id=domain_id, max_targets=max_targets)
        )

    def remove_relaying_target(self, target_string: str) -> models_pb2.EmptyMessage:
        return self.perform_request(
            self.relaying_stub.RemoveRelayingTarget,
            models_pb2.RelayingTarget(target_string=target_string)
        )

    def sync_relaying_targets(self) -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.SyncRelayingTargets,
            relaying_pb2.Response()
        )

    def clear_relaying_targets(self) -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.ClearRelayingTargets,
            relaying_pb2.Response()
        )

    def start_mitm6(self, scan_id: int, arguments: str = '') -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.StartMitm6,
            relaying_pb2.StartMessage(scan_id=scan_id, arguments=arguments)
        )

    def start_relaying(self, scan_id: int, arguments: str = '') -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.StartRelaying,
            relaying_pb2.StartMessage(scan_id=scan_id, arguments=arguments)
        )

    def stop_responder(self, scan_id: int) -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.StopResponder,
            relaying_pb2.StopMessage()
        )

    def stop_mitm6(self, scan_id: int) -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.StopMitm6,
            relaying_pb2.StopMessage()
        )

    def stop_relaying(self, scan_id: int) -> relaying_pb2.Response:
        return self.perform_request(
            self.relaying_stub.StopRelaying,
            relaying_pb2.StopMessage()
        )

    def get_responder_output(self) -> relaying_pb2.OutputResponse:
        return self.perform_request(
            self.relaying_stub.GetResponderOutput,
            relaying_pb2.OutputRequest()
        )

    def get_mitm6_output(self) -> relaying_pb2.OutputResponse:
        return self.perform_request(
            self.relaying_stub.GetMitm6Output,
            relaying_pb2.OutputRequest()
        )

    def get_relaying_output(self) -> relaying_pb2.OutputResponse:
        return self.perform_request(
            self.relaying_stub.GetRelayingOutput,
            relaying_pb2.OutputRequest()
        )

    def list_files(self, pagination: models_pb2.Pagination) -> models_pb2.FileList:
        return self.perform_request(self.scanner_stub.ListFiles, pagination)

    def get_file(self, file_id: int) -> models_pb2.File:
        return self.perform_request(
            self.scanner_stub.GetFile,
            scanner_pb2.GetRequest(id=file_id)
        )

    def list_file_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListFileFilters,
            models_pb2.Scan(id=scan_id)
        )

    def stream_image(self, file_id: int) -> Generator[bytes, None, None]:
        for chunk in self.scanner_stub.GetFileStream(models_pb2.File(id=file_id)):
            yield chunk.chunk

    def get_file_contents(self, file_id: int) -> models_pb2.FileContents:
        return self.perform_request(
            self.scanner_stub.GetFileContents,
            models_pb2.File(id=file_id)
        )

    def add_credential(self, scan_id: int, username: str, password: str, domain: str,
                       domain_id: int, lm: str, nt: str, credential_type: int = 0) -> models_pb2.Credential:
    ...
    @staticmethod
    def list_credential_types() -> Dict[str, List[dict]]:
        entries = []
    ...
    def change_credential(self, credential_id: int, username: str = '', password: str = '',
                          domain: str = '', domain_id: int = 0,
                          lm: str = '', nt: str = '',
                          credential_type: int = 0) -> models_pb2.Credential:
        credential = models_pb2.Credential(
    ...
    def list_out_of_scope(self, pagination: models_pb2.Pagination) -> models_pb2.OutOfScopeList:
        return self.perform_request(
            self.scanner_stub.ListOutOfScope,
            pagination
        )

    def add_out_of_scope(self, scan_id: int, ip_range: str, description: str) -> models_pb2.OutOfScope:
        return self.perform_request(
    ...
    def get_log(self, log_id: int) -> models_pb2.LogFile:
        return self.perform_request(
            self.scanner_stub.GetLog,
            scanner_pb2.GetRequest(id=log_id)
        )

    def list_domains(self, pagination: models_pb2.Pagination) -> models_pb2.DomainList:
        return self.perform_request(self.scanner_stub.ListDomains, pagination)

    def get_domain(self, domain_id: int) -> models_pb2.Domain:
        return self.perform_request(
            self.scanner_stub.GetDomain,
            scanner_pb2.GetRequest(id=domain_id)
        )

    def list_domain_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListDomainFilters,
            models_pb2.Scan(id=scan_id)
        )

    def get_application_log(self, log_type, start: int, count: int) -> information_pb2.Log:
        return self.perform_request(
    ...
    def list_users(self, pagination: models_pb2.Pagination) -> models_pb2.UserList:
        return self.perform_request(self.scanner_stub.ListUsers, pagination)

    def get_user(self, user_id: int) -> models_pb2.User:
        return self.perform_request(
            self.scanner_stub.GetUser,
            scanner_pb2.GetRequest(id=user_id)
        )

    def list_user_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListUserFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_groups(self, pagination: models_pb2.Pagination) -> models_pb2.GroupList:
        return self.perform_request(self.scanner_stub.ListGroups, pagination)

    def get_group(self, group_id: int) -> models_pb2.Group:
        return self.perform_request(
            self.scanner_stub.GetGroup,
            scanner_pb2.GetRequest(id=group_id)
        )

    def list_group_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListGroupFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_group_memberships(self, pagination: models_pb2.Pagination) -> models_pb2.GroupMembershipList:
        return self.perform_request(self.scanner_stub.ListGroupMemberships, pagination)

    def get_group_membership(self, membership_id: int) -> models_pb2.GroupMembership:
        return self.perform_request(
            self.scanner_stub.GetGroupMembership,
            scanner_pb2.GetRequest(id=membership_id)
        )

    def list_group_membership_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListGroupMembershipFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_trusts(self, pagination: models_pb2.Pagination) -> models_pb2.TrustList:
        return self.perform_request(self.scanner_stub.ListTrusts, pagination)

    def get_trust(self, trust_id: int) -> models_pb2.Trust:
        return self.perform_request(
            self.scanner_stub.GetTrust,
            scanner_pb2.GetRequest(id=trust_id)
        )

    def list_trust_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListTrustFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_policies(self, pagination: models_pb2.Pagination) -> models_pb2.PolicyList:
        return self.perform_request(self.scanner_stub.ListPolicies, pagination)

    def get_policy(self, trust_id: int) -> models_pb2.Policy:
        return self.perform_request(
            self.scanner_stub.GetPolicy,
            scanner_pb2.GetRequest(id=trust_id)
        )

    def list_policy_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListPolicyFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_hashes(self, pagination: models_pb2.Pagination) -> models_pb2.HashList:
        return self.perform_request(self.scanner_stub.ListHashes, pagination)

    def get_hash(self, hash_id: int) -> models_pb2.Hash:
        return self.perform_request(
            self.scanner_stub.GetHash,
            scanner_pb2.GetRequest(id=hash_id)
        )

    def list_hash_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListHashFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_spider_results(self, pagination: models_pb2.Pagination) -> models_pb2.SpiderResultList:
        return self.perform_request(self.scanner_stub.ListSpiderResults, pagination)

    def get_spider_result(self, share_id: int) -> models_pb2.SpiderResult:
        return self.perform_request(
            self.scanner_stub.GetSpiderResult,
            scanner_pb2.GetRequest(id=share_id)
        )

    def list_spider_result_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListSpiderResultFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_shares(self, pagination: models_pb2.Pagination) -> models_pb2.ShareList:
        return self.perform_request(self.scanner_stub.ListShares, pagination)

    def get_share(self, share_id: int) -> models_pb2.Share:
        return self.perform_request(
            self.scanner_stub.GetShare,
            scanner_pb2.GetRequest(id=share_id)
        )

    def list_share_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListShareFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_share_files(self, pagination: models_pb2.Pagination) -> models_pb2.ShareFileList:
        return self.perform_request(self.scanner_stub.ListShareFiles, pagination)

    def get_share_file(self, share_file_id: int) -> models_pb2.ShareFile:
        return self.perform_request(
            self.scanner_stub.GetShareFile,
            scanner_pb2.GetRequest(id=share_file_id)
        )

    def list_share_file_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListShareFileFilters,
            models_pb2.Scan(id=scan_id)
        )

    def change_share_file_status(self, share_file_id: int, status: int) -> models_pb2.ShareFile:
        return self.perform_request(
            self.scanner_stub.ChangeShareFileStatus,
            models_pb2.ShareFile(id=share_file_id, status=status)  # type: ignore
        )
    ...
    def index_directory(self, share_file_id: int, max_depth: int = 0, credential_id: int = 0) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def download_file(self, share_file_id: int, parse_credentials: bool = False, credential_id: int = 0) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def get_finding(self, finding_id: int) -> models_pb2.Finding:
        return self.perform_request(
            self.scanner_stub.GetFinding,
            scanner_pb2.GetRequest(id=finding_id)
        )

    def list_finding_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListFindingFilters,
            models_pb2.Scan(id=scan_id)
        )

    def export_findings(self, scan_id: int) -> models_pb2.FindingsExport:
        return self.perform_request(
            self.scanner_stub.ExportFindings,
            models_pb2.Scan(id=scan_id)
        )

    def list_credential_sources(self, pagination: models_pb2.Pagination) -> models_pb2.CredentialSourceList:
        return self.perform_request(
            self.scanner_stub.ListCredentialSources,
            pagination
        )

    def get_credential_source(self, credential_source_id: int) -> models_pb2.CredentialSource:
        return self.perform_request(
            self.scanner_stub.GetCredentialSource,
            scanner_pb2.GetRequest(id=credential_source_id)
        )

    def list_credential_source_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
    ...
    def perform_custom_scan(self, scan_id: int, description: str,
                            nmap_args: str, auto_import: bool) -> models_pb2.CustomScan:
        return self.perform_request(
    ...
    def import_custom_scan(self, custom_scan_id: int) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def cancel_custom_scan(self, custom_scan_id: int) -> models_pb2.CustomScan:
        return self.perform_request(
    ...
    def list_custom_scans(self, pagination: models_pb2.Pagination) -> models_pb2.CustomScanList:
        return self.perform_request(
            self.scanner_stub.ListCustomScans,
            pagination
        )

    def get_custom_scans(self, custom_scan_id: int) -> models_pb2.CustomScan:
        return self.perform_request(
            self.scanner_stub.GetCustomScan,
            scanner_pb2.GetRequest(id=custom_scan_id)
        )

    def list_custom_scan_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListCustomScanFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_access(self, pagination: models_pb2.Pagination) -> models_pb2.AccessList:
        return self.perform_request(
            self.scanner_stub.ListAccess,
            pagination
        )

    def get_access(self, access_id: int) -> models_pb2.Access:
        return self.perform_request(
            self.scanner_stub.GetAccess,
            scanner_pb2.GetRequest(id=access_id)
        )

    def list_access_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListAccessFilters,
            models_pb2.Scan(id=scan_id)
        )

    def check_access(self, credential_id: int, service_id: int, scanner_name: str = '') -> models_pb2.Access:
        return self.perform_request(
    ...
    def check_multiple_access(self, credential_id: int, scan_id: int, max_check: int = 0,
                              ...
                              skip_checked: bool = False, host_type: str = '') -> models_pb2.AccessList:
        return self.perform_request(
    ...
    def create_password_spray(self, scan_id: int, service_id: int, domain_id: int = 0,
                              ...
                              load_domain_users: bool = False) -> models_pb2.PasswordSpray:
    ...
    def start_password_spray(self, password_spray_id: int) -> models_pb2.PasswordSpray:
        return self.perform_request(
            self.exploit_stub.StartPasswordSpray,
            models_pb2.PasswordSpray(id=password_spray_id)
        )

    def cancel_password_spray(self, password_spray_id: int) -> models_pb2.PasswordSpray:
        return self.perform_request(
            self.exploit_stub.CancelPasswordSpray,
            models_pb2.PasswordSpray(id=password_spray_id)
        )

    def add_password_spray_user(self, password_spray_id: int, user_id: int = 0, username: str = '') -> models_pb2.PasswordSprayUser:
    ...
    def delete_password_spray_user(self, password_spray_user_id: int) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def add_password_spray_run(self, password_spray_id: int, password: str) -> models_pb2.PasswordSprayRun:
        return self.perform_request(
    ...
    def delete_password_spray_run(self, password_spray_run_id: int) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def list_password_spray_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListPasswordSprayFilters,
            models_pb2.Scan(id=scan_id)
        )

    def list_password_sprays(self, pagination: models_pb2.Pagination) -> models_pb2.PasswordSprayList:
        return self.perform_request(
            self.scanner_stub.ListPasswordSprays,
            pagination
        )

    def get_password_spray(self, spray_id: int) -> models_pb2.PasswordSpray:
        return self.perform_request(
            self.scanner_stub.GetPasswordSpray,
            scanner_pb2.GetRequest(id=spray_id)
        )

    def list_password_spray_runs(self, pagination: models_pb2.Pagination) -> models_pb2.PasswordSprayRunList:
        return self.perform_request(
            self.scanner_stub.ListPasswordSprayRuns,
            pagination
        )

    def list_password_spray_run_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
            self.scanner_stub.ListPasswordSprayRunFilters,
            models_pb2.Pagination(id=scan_id)
        )

    def list_password_spray_users(self, pagination: models_pb2.Pagination) -> models_pb2.PasswordSprayUserList:
        return self.perform_request(
            self.scanner_stub.ListPasswordSprayUsers,
            pagination
        )

    def list_password_spray_user_filters(self, scan_id: int) -> models_pb2.FilterList:
        return self.perform_request(
    ...
    # Bloodhound methods
    def find_local_admins_for_group(self, scan_id: int, group_id: int) -> models_pb2.HostList:
        return self.perform_request(
    ...
    def find_local_admins_for_user(self, scan_id: int, user_id: int) -> models_pb2.HostList:
        return self.perform_request(
    ...
    def run_bloodhound(self, scan_id: int, domain_id: int, credential_id: int, collection_methods: List[str]) -> bloodhound_pb2.BloodHoundRun:
        return self.perform_request(
    ...
    def list_bloodhound_runs(self, pagination: models_pb2.Pagination) -> bloodhound_pb2.BloodHoundRunList:
        return self.perform_request(
            self.bloodhound_stub.ListBloodHoundRuns,
            pagination
        )

    def get_bloodhound_run(self, bloodhound_run_id: int) -> bloodhound_pb2.BloodHoundRun:
        return self.perform_request(
            self.bloodhound_stub.GetBloodHoundRun,
            scanner_pb2.GetRequest(id=bloodhound_run_id)
        )

    def list_collection_methods(self) -> bloodhound_pb2.CollectionMethods:
        return self.perform_request(
    ...
    def list_metasploit_consoles(self) -> metasploit_pb2.ConsoleList:
        return self.perform_request(
            self.metasploit_stub.ListConsoles,
            models_pb2.EmptyRequest()
        )

    def get_metasploit_console(self, id) -> metasploit_pb2.Console:
        return self.perform_request(
    ...
    def create_metasploit_console(self) -> metasploit_pb2.Console:
        return self.perform_request(
            self.metasploit_stub.CreateConsole,
            models_pb2.EmptyRequest()
        )

    def stop_metasploit_console(self, cid: str) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def write_to_console(self, cid: str, message: str) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def list_metasploit_sessions(self) -> metasploit_pb2.MetasploitSessionList:
        return self.perform_request(
            self.metasploit_stub.ListSessions,
            models_pb2.EmptyRequest()
        )

    def get_metasploit_session(self, id: str) -> metasploit_pb2.MetasploitSession:
        return self.perform_request(
            self.metasploit_stub.GetSession,
            metasploit_pb2.MetasploitSession(id=id)
        )

    def write_to_session(self, sid: str, message: str) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def calc_ranges(self, scan_id: int, prefix: int) -> scanner_pb2.Ranges:
        return self.perform_request(
    ...
    def list_terminals(self) -> terminal_pb2.TerminalList:
        return self.perform_request(
            self.terminal_stub.ListTerminals,
            models_pb2.EmptyRequest()
        )

    def get_terminal(self, terminal_id: int) -> terminal_pb2.Terminal:
        return self.perform_request(
    ...
    def new_terminal(self) -> terminal_pb2.Terminal:
        return self.perform_request(
            self.terminal_stub.NewTerminal,
            models_pb2.EmptyRequest()
        )

    def terminal_send_input(self, terminal_id: int, input_bytes: bytes) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def stop_terminal(self, terminal_id: int) -> models_pb2.EmptyMessage:
        return self.perform_request(
    ...
    def update_terminal(self, terminal_id: int, label: str) -> terminal_pb2.Terminal:
    ...
    def resize_terminal(self, terminal_id: int, rows: int, cols: int) -> terminal_pb2.Terminal:
...
class CallbackClient(Client):
    ...
    def login_status(self, login_id: int, scan_id: int, status: int, service_id: int, access_level: int = 0, domain_id: int = 0,
                     credential_id: int = 0, port: int = 0, host_types: Optional[List[str]] = None) -> None:
        self.perform_request(
