...
class RelayingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddRelayingTargets = channel.unary_unary(
                '/Relaying/AddRelayingTargets',
                request_serializer=relaying__pb2.RelayingAddTargetsRequest.SerializeToString,
                response_deserializer=relaying__pb2.RelayingAddTargetsResponse.FromString,
                )
...
class RelayingServicer(object):
    ...
    def AddRelayingTargets(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RelayingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddRelayingTargets': grpc.unary_unary_rpc_method_handler(
                    servicer.AddRelayingTargets,
                    request_deserializer=relaying__pb2.RelayingAddTargetsRequest.FromString,
                    response_serializer=relaying__pb2.RelayingAddTargetsResponse.SerializeToString,
            ),
...
class Relaying(object):
    ...
    @staticmethod
    def AddRelayingTargets(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Relaying/AddRelayingTargets',
            relaying__pb2.RelayingAddTargetsRequest.SerializeToString,
            relaying__pb2.RelayingAddTargetsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
