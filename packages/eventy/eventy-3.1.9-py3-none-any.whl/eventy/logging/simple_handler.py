...
>>> logger.info('test')
[...] [RID:] [CID:] INFO my_logger (<doctest eventy.logging L1) test
"""
...
from .info_providers import correlation_id_provider, request_id_provider
...
class SimpleHandler(StreamHandler):
    ...
    def __init__(
        self,
        stream=None,
        fmt='%(asctime)s [RID:%(request_id)s] [CID:%(correlation_id)s] '
