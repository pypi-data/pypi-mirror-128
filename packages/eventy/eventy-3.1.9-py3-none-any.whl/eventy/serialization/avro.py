...
def _decode_avro_record_legacy(
    ...
    name = avro_record_data.get('name') or avro_schema_data.get('name') or 'Unspecified'
    record_data['name'] = name

    namespace = avro_record_data.get('namespace') or avro_schema_data.get('namespace') or 'urn:unspecified'
