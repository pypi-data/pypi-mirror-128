...
class ClassifyWorker(JobWorker):
    def __init__(self, k, out_dir, temp_dir, kmer_db, lca_matrix, n_readers, logging_dir, status_index,
    ...
    def process_read(self, read):
        ...
        # Map the kmers.
        cls, common_clade, mapped_kmers = classify(self.k, self.read_array[:n_kmers], self.keys, self.values,
                                                   self.lca_matrix, NULL_VALUE)
        kmer_string = self.format_mapped_kmers(mapped_kmers)
