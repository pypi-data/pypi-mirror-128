    ...
    def log_batch(self, image_batch, output_batch, annotations):
        for idx, image in enumerate(image_batch):
            if random.random() < float(self._vlog_size):
                ...
                if "bbox" in annotations[idx]:
                    annotations[idx]["bbox"]["x_min"] *= scale
                    annotations[idx]["bbox"]["y_min"] *= scale
                    annotations[idx]["bbox"]["x_max"] *= scale
                    annotations[idx]["bbox"]["y_max"] *= scale
