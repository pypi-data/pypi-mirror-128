...
class socketController():
	...
	def transmitWidgets(self,**kwargs):
		...
		data['widgets'] = self.prepareWidgetList(True) #Enable cleanup. Only send values for active widgets.
		data.update(kwargs)
	...
	def addMonitor(self,a,**kwargs):
		...
		if a.property("remote"):
			self.monitorWidgets[a.objectName()].params.update({'remote':a.property("remote")})
