...
class AppWindow(QtWidgets.QMainWindow, layout.Ui_MainWindow):
	...
	def interpretMessage(self,data):
		if 'chatmsg' in data:
			...
			print('Got modified widget list from Remote',l, ' PREVIOUS:',activeWidgets, ' Now:',self.socklib.monitorWidgets.keys())
			self.loggedIn = True
		#elif 'add to widget list' in data:
		#elif 'remove from widget list' in data:
