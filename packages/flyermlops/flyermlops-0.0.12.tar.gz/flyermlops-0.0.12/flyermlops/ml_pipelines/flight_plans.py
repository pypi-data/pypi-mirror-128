...
def add_leg(
    ...
    def inner_func(func):
        def wrapper(self, *args, **kwargs):
            ...
            # Pass if begin or end
            # if any(i == origin_name for i in ["begin_flight", "end_flight"]):
            # pass

            # else:

            # Write to file
            ac_type = utils.write_step_to_file(
                self._config["project_name"], leg_name, func, req_file,
            )
