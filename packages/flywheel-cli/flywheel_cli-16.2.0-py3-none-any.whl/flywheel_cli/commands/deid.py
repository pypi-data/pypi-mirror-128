...
class DeidTestCommand(Command):
    ...
    def run(self, args):
        ...
        ingest_config = i_config.IngestConfig(
            ...
            de_identify=True,
            deid_profile=copy.deepcopy(args.deid_profile),
            deid_profiles=copy.deepcopy(args.deid_profiles),
            include=[
                "*.dcm",
                "*.dcm.gz",
                "*.dicom",
    ...
    def _configure_deid(self, ingest_config):
        ...
        deid_profile = deid.load_deid_profile(
            copy.deepcopy(ingest_config.deid_profile),
            copy.deepcopy(ingest_config.deid_profiles),
        )
