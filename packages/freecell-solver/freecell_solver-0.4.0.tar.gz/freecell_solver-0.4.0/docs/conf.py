# -*- coding: utf-8 -*-
#
# freecell_solver documentation build configuration file, created by
...
htmlhelp_basename = 'freecell_solverdoc'
...
latex_documents = [
  ('index', 'freecell_solver.tex', u'freecell_solver Documentation',
...
man_pages = [
    ('index', 'freecell_solver', u'freecell_solver Documentation',
     [u'Shlomi Fish'], 1)
]
