...
class InputBox:
    def __init__(self, screen, rect, boxname='None', fontcolor='black' ,rectcolor='black', fontname='fangsong.ttf', fontsize=18):
        self.screen = screen
        self.rect = rect
    ...
    def draw(self):
        ...
        text = ''.join(self.list)
        text_pic = ptext.draw(self.boxname + '：' + text, pos=(self.rect.x, self.rect.y), color=self.fontcolor, fontsize=self.fontsize, fontname=self.fontname)
