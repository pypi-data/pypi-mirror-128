...
def load_air_pollution(roles=True, as_pandas=False):
    """
...
def load_atherosclerosis(roles=True, as_pandas=False, as_dict=False):
    """
...
def load_biodegradability(roles=True, as_pandas=False, as_dict=False):
    """
...
def load_consumer_expenditures(roles=True, units=True, as_pandas=False, as_dict=False):
    """
...
def load_interstate94(roles=True, units=True, as_pandas=False):
    """
...
def load_loans(roles=True, units=True, as_pandas=False, as_dict=False):
    """
...
# TODO: Update notebook
def load_occupancy(roles=True, as_pandas=False, as_dict=False):
    """
