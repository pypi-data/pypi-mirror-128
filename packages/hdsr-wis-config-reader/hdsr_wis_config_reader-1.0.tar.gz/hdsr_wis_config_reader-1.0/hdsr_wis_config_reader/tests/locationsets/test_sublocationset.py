...
def test_sublocationset(fews_config):
    subloc = location_sets.sub.SubLocationSet(fews_config=fews_config)
    assert subloc.fews_config.path == paths.WIS_CONFIG_TEST_DIR
    assert subloc.idmap_section_name == expected_idmap_section_name
    assert subloc.name == expected_name
    assert subloc.csv_filename == expected_csvfile
    assert subloc.fews_name == expected_fews_name
    assert subloc.get_validation_attributes(int_pars=None) == expected_validation_attributes
