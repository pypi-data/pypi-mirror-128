...
class RepositoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateBundleFromRefList = channel.stream_stream(
                ...
                request_serializer=repository__service__pb2.CreateBundleFromRefListRequest.SerializeToString,
                response_deserializer=repository__service__pb2.CreateBundleFromRefListResponse.FromString,
                )
        self.FetchBundle = channel.stream_unary(
                '/gitaly.RepositoryService/FetchBundle',
                request_serializer=repository__service__pb2.FetchBundleRequest.SerializeToString,
                response_deserializer=repository__service__pb2.FetchBundleResponse.FromString,
                )
        ...
        self.SetFullPath = channel.unary_unary(
                ...
                request_serializer=repository__service__pb2.SetFullPathRequest.SerializeToString,
                response_deserializer=repository__service__pb2.SetFullPathResponse.FromString,
                )
...
def add_RepositoryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateBundleFromRefList': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=repository__service__pb2.CreateBundleFromRefListRequest.FromString,
                    response_serializer=repository__service__pb2.CreateBundleFromRefListResponse.SerializeToString,
            ),
            'FetchBundle': grpc.stream_unary_rpc_method_handler(
                    servicer.FetchBundle,
                    request_deserializer=repository__service__pb2.FetchBundleRequest.FromString,
                    response_serializer=repository__service__pb2.FetchBundleResponse.SerializeToString,
            ),
            ...
            'SetFullPath': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=repository__service__pb2.SetFullPathRequest.FromString,
                    response_serializer=repository__service__pb2.SetFullPathResponse.SerializeToString,
            ),
    }
...
class RepositoryService(object):
    ...
    def CreateBundleFromRefList(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/gitaly.RepositoryService/CreateBundleFromRefList',
            repository__service__pb2.CreateBundleFromRefListRequest.SerializeToString,
            repository__service__pb2.CreateBundleFromRefListResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def FetchBundle(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/gitaly.RepositoryService/FetchBundle',
            repository__service__pb2.FetchBundleRequest.SerializeToString,
            repository__service__pb2.FetchBundleResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SetFullPath(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gitaly.RepositoryService/SetFullPath',
            repository__service__pb2.SetFullPathRequest.SerializeToString,
            repository__service__pb2.SetFullPathResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
