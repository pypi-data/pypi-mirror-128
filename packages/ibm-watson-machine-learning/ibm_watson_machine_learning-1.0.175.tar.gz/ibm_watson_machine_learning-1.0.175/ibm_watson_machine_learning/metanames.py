...
class ScriptMetaNames(MetaNamesBase):
    ...
    _meta_props_definitions = [
        MetaProp('NAME',    NAME,   STR_TYPE, True,   "Python script", path='/metadata/name'),
        MetaProp('DESCRIPTION', DESCRIPTION,    STR_TYPE, False,  "my_description", path='/metadata/description'),
...
class ShinyMetaNames(MetaNamesBase):
    ...
    _meta_props_definitions = [
        MetaProp('NAME',    NAME,   STR_TYPE, True,   "Shiny App", path='/metadata/name'),
        MetaProp('DESCRIPTION', DESCRIPTION,    STR_TYPE, False,  "my_description", path='/metadata/description'),
    ]
...
class ModelDefinitionMetaNames(MetaNamesBase):
    ...
    CUSTOM = "custom"
    _meta_props_definitions = [
        MetaProp('NAME', NAME, STR_TYPE, True, "my_model_definition", path='/metadata/name'),
        MetaProp('DESCRIPTION', DESCRIPTION, STR_TYPE, False, "my model_definition", path='/metadata/description'),
...
class DeploymentMetaNames(MetaNamesBase):
    ...
    _meta_props_definitions = [
        ...
        MetaProp('SERVING_NAME', SERVING_NAME, str, False, "deployment", hidden=True, path='/online/parameters/serving_name'),
...
class FactsheetsMetaNames(MetaNamesBase):
    ...
    _meta_props_definitions = [
        MetaProp('ASSET_ID', ASSET_ID, STR_TYPE, False, '13a53931-a8c0-4c2f-8319-c793155e7517'),
        MetaProp('NAME', NAME, STR_TYPE, False,  example_value="New model entry"),
        MetaProp('DESCRIPTION', DESCRIPTION, STR_TYPE, False, example_value='New model entry'),
        MetaProp('MODEL_ENTRY_CATALOG_ID', MODEL_ENTRY_CATALOG_ID, STR_TYPE, True, example_value='13a53931-a8c0-4c2f-8319-c793155e7517')
    ]
