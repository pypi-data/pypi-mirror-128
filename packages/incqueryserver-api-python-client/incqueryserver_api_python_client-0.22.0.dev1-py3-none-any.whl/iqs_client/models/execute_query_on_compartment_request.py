...
class ExecuteQueryOnCompartmentRequest(object):
    ...
    def __init__(self, model_compartment=None, query_fqn=None, parameter_binding=None, use_osmc_links_for_elements=None, query_mode=None, return_element_details=None, local_vars_configuration=None):  # noqa: E501
