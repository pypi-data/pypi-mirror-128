...
class ExecuteQueryOneOffRequest(object):
    ...
    def __init__(self, query_language=None, query_name=None, query_definitions=None, model_compartment=None, parameter_binding=None, use_osmc_links_for_elements=None, query_mode=None, return_element_details=None, local_vars_configuration=None):  # noqa: E501
