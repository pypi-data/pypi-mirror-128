...
from . import tokenfile, set_builtins_with_serverside_config
...
class CognitoAuthenticatedRestStore(mlflow.store.tracking.rest_store.RestStore):
    ...
    def _add_or_update_body_dict_with_projectid_tag(self, body:dict) -> dict:
        ...
        Args:
            body (dict): a dict to with the 'tags' key is added
    ...
    def create_experiment(self, name, artifact_location=None, tags:List[Dict]=None):
        """
    ...
    def __init__(self, store_uri=None, artifact_uri=None):
        self.srvc:Dict[str, Any] = new_login.bootstrap_from_mlflow_rest() 
        ...
        customerinfo:dict = new_login.get_customer_info_rest(self.get_id_token_string())
