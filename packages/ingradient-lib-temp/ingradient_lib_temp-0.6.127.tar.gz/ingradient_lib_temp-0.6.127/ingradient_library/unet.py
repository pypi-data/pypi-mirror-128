...
class UNet2d_GRU(nn.Module):
    def __init__(self, in_channels = 1, out_channels = 2, n_channels = 64, channel_bound = 1024, input_size = (48, 48)):
        super().__init__()
        ...
        self.gru1 = nn.Sequential(ConvGRUCell(input_size = input_size, input_dim = n_channels, hidden_dim = n_channels, kernel_size = 3),
                                  ConvGRUCell(input_size = input_size, input_dim = n_channels, hidden_dim = n_channels, kernel_size = 3))
        self.gru2 = nn.Sequential(ConvGRUCell(input_size = input_size //2, input_dim = n_channels*2, hidden_dim = n_channels*2, kernel_size = 3),
                                  ConvGRUCell(input_size = input_size //2, input_dim = n_channels*2, hidden_dim = n_channels*2, kernel_size = 3))
        self.gru3 = nn.Sequential(ConvGRUCell(input_size = input_size //4, input_dim = n_channels*4, hidden_dim = n_channels*4, kernel_size = 3),
                                  ConvGRUCell(input_size = input_size //4, input_dim = n_channels*4, hidden_dim = n_channels*4, kernel_size = 3))
        self.gru4 = nn.Sequential(ConvGRUCell(input_size = input_size //8, input_dim = n_channels*8, hidden_dim = n_channels*8, kernel_size = 3),
                                  ConvGRUCell(input_size = input_size //8, input_dim = n_channels*8, hidden_dim = n_channels*8, kernel_size = 3))
        self.gru5 = nn.Sequential(ConvGRUCell(input_size = input_size //16, input_dim = n_channels*16, hidden_dim = n_channels*16, kernel_size = 3),
                                  ConvGRUCell(input_size = input_size //16, input_dim = n_channels*16, hidden_dim = n_channels*16, kernel_size = 3))
    ...
    def forward(self, x, hidden_state = None):
        ...
        if hidden_state != None:
            ...
            x = self.gru1(x)
            x_downsample1 = self.gru2(x_downsample1)
            x_downsample2 = self.gru3(x_downsample2)
            x_downsample3 = self.gru4(x_downsample3)
            x_downsample4 = self.gru5(x_downsample4)
        ...
        return [l1_output, l2_output, l3_output, l4_output], [x, x_downsample1, x_downsample2, x_downsample3, x_downsample4]
