...
class Dataset2D(Dataset):
    def __init__(self, root_dir, axis, mode, hdf_img_keys = None, train = True, hdf_seg_key = None ,sampler = None, oversampling = True, device = None, normalizer = None, transform = None, resample = None, correct_direction = True):
