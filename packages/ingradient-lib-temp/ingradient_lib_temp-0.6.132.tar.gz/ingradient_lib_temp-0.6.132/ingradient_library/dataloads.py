...
class Dataset2D(Dataset):
    def __init__(self, root_dir, axis, mode, hdf_img_keys = None, train = True, hdf_seg_key = None ,sampler = None, size = (520, 520),
        ...
        self.train = train
        self.crop = RandomCrop(size = size, pad_if_needed = True)
    ...
    def __getitem__(self, idx):
        ...
        x, y = self.crop(image = x, target = y)
        return x, y
