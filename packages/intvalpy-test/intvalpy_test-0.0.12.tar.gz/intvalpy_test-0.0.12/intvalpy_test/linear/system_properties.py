...
from intvalpy_test.RealInterval import Interval
from intvalpy_test.intoper import zeros, asinterval, infinity
...
def Tol(A, b, x=None, maxQ=False, x0=None, tol=1e-12, maxiter=1e3):
    ...
    if maxQ==False:
        ...
        ccode, x, fun, _ = __tolsolvty(A.a, A.b, b.a, b.b, weight=x0, maxiter=maxiter, \
...
def outliers(A, b, functional='uni', x0=None, tol=1e-12, maxiter=1e3, method='standard deviations'):
    ...
    if method == 'standard deviations':
        index = standard_deviations(tt)
    elif method == 'interquartile':
        index = interquartile(tt)
    else:
    ...
    return WorkListA, WorkListb, index, tt
