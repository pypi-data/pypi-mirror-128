...
def obj_get_attr(obj: Atspi.Object, name:str) -> Either[str]:
    ...
    # TODO: Fix this getattr(obj, name) may not work when adding objects to the tree
    # TODO: Use the get_property method of GObject
...
def perform_on_each(roots: Iterable[Atspi.Object], **kwargs: MatchArgs) -> UIMultipleInteraction:
    ...
    **kwargs
    ...
    on_objs = []
    for root in roots:
        on_objs.extend(find_all_objs(root, **kwargs))
