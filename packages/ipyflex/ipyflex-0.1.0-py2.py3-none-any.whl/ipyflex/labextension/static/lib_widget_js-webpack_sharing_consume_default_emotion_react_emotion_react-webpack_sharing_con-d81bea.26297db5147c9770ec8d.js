...
class FlexWidget extends react_1.Component {
    constructor(props) {
        ...
        this.factory = (node) => {
            ...
            switch (component) {
                case 'Widget': {
                    return react_1.default.createElement(widgetWrapper_1.WidgetWrapper, { model: this.model, widget_name: name });
                }
                case 'sub': {
        ...
        this.onRenderTabSet = (tabSetNode, renderValues, nodeId) => {
            ...
            //   Add widget{' '}
            // </Button>
            react_1.default.createElement(widgetMenu_1.WidgetMenu, { widgetList: this.widgetList, nodeId: nodeId, tabsetId: tabsetId, addTabToTabset: (name) => {
...
//# sourceMappingURL=lib_widget_js-webpack_sharing_consume_default_emotion_react_emotion_react-webpack_sharing_con-d81bea.26297db5147c9770ec8d.js.map