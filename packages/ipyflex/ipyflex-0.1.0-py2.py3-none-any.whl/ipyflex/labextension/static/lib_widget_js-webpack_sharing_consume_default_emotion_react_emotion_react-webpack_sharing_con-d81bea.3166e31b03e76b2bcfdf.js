...
class FlexWidget extends react_1.Component {
    constructor(props) {
        ...
        this.onRenderOuterTabSet = (tabSetNode, renderValues) => {
            renderValues.buttons.push(react_1.default.createElement(Button_1.default, { variant: "outlined", onClick: this.onAddRow }, "Add section"));
        };
        this.innerlayoutRef = {};
        this.state = {
    ...
    render() {
        return (react_1.default.createElement(styles_1.StyledEngineProvider, { injectFirst: true },
            react_1.default.createElement("div", { style: { height: '100%' } },
                ...
                react_1.default.createElement(Toolbar_1.default, { variant: "dense", style: { height: '36px', minHeight: '36px' } },
                    react_1.default.createElement(Button_1.default, { variant: "outlined", onClick: this.onAddRow }, "Add section")))));
    }
}
...
//# sourceMappingURL=lib_widget_js-webpack_sharing_consume_default_emotion_react_emotion_react-webpack_sharing_con-d81bea.3166e31b03e76b2bcfdf.js.map