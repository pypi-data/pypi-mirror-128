...
class FlexWidget extends react_1.Component {
    constructor(props) {
        ...
        this.onRenderOuterTabSet = (tabSetNode, renderValues) => {
            renderValues.buttons.push(react_1.default.createElement(Button_1.default, { size: "small", variant: "outlined", onClick: this.onAddRow, style: { height: "27px" } }, "Add section"));
        };
        this.innerlayoutRef = {};
        this.state = {
...
//# sourceMappingURL=lib_widget_js-webpack_sharing_consume_default_emotion_react_emotion_react-webpack_sharing_con-d81bea.4f96483fcb19f92d6e7a.js.map