...
class FlexWidget extends react_1.Component {
    constructor(props) {
        ...
        this.onRenderOuterTabSet = (tabSetNode, renderValues) => {
            renderValues.buttons.push(react_1.default.createElement(Button_1.default, { size: "small", variant: "outlined", onClick: this.onAddRow }, "Add section"));
        };
        this.innerlayoutRef = {};
        this.state = {
...
//# sourceMappingURL=lib_widget_js-webpack_sharing_consume_default_emotion_react_emotion_react-webpack_sharing_con-d81bea.e26179965846a7dc251b.js.map