"""A setuptools based setup module for iris-validator"""
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
setup(
    ...
    long_description="Implementation of IRIS StationXML validation rules. >iris-validator --infile path/to/stationxml/file",
