...
setup(
    ...
    url="https://kludex.github.io/javali",
    license="BSD",
    ...
    entry_points="""
    [console_scripts]
    javali=uvicorn.main:main
    """,
    project_urls={
        "Funding": "https://github.com/Kludex",
        "Source": "https://github.com/Kludex/javali",
        "Changelog": "https://github.com/Kludex/javali/blob/main/CHANGELOG.md",
    },
)
