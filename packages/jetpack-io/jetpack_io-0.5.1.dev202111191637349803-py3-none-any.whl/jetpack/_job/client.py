...
class Client:
    ...
    def launch_job(
        ...
        response = cast(
            ...
            self._launch_job(LaunchJobMode.BLOCKING, job, args, kwargs),
        )
    ...
    async def launch_async_job(
        ...
        response = cast(
            ...
            self._launch_job(LaunchJobMode.ASYNC, job, args, kwargs),
        )
    ...
    def launch_fire_and_forget_job(
        ...
        docker image.
        """
        crete_task_reponse = self._launch_job(
            LaunchJobMode.FIRE_AND_FORGET, job, args, kwargs
        )
        assert isinstance(crete_task_reponse, remote_pb2.CreateTaskResponse)
        return Future(self, uuid.UUID(crete_task_reponse.task_id))
    ...
    def _launch_job(
        ...
        request = self._build_request(mode, job, args, kwargs)
