...
_TASK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='qualified_symbol', full_name='remote.Task.qualified_symbol', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='qualifiedSymbol', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='namespace', full_name='remote.Task.namespace', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='encoded_args', full_name='remote.Task.encoded_args', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='hostname', full_name='remote.Task.hostname', index=3,
