    ...
    createNew(panel, context) {
        ...
        const onClickHandler = () => {
            ...
            if (this.stickyLand === null) {
                this.stickyLand = new _stickyland__WEBPACK_IMPORTED_MODULE_2__.StickyLand(panel);
            }
...
class StickyCode {
    constructor() {
        ...
        this.codeOutputMutationHandler = (mutationList, observer) => {
            mutationList.forEach(d => {
                ...
                if (d.addedNodes !== null) {
                    (_b = (_a = this.outputNode) === null || _a === void 0 ? void 0 : _a.querySelector('.jp-OutputPrompt')) === null || _b === void 0 ? void 0 : _b.remove();
                }
            });
        };
        /**
        ...
        this.cleanCellClone = () => {
            ...
            (_d = this.cellNode.querySelector('.jp-OutputPrompt')) === null || _d === void 0 ? void 0 : _d.remove();
    ...
    constructor(cellType, stickyCell) {
        ...
        this.headerMousedownHandler = (e) => {
            ...
            const mouseMoveHandler = (e) => {
                ...
                e.stopPropagation();
                const mouseEvent = e;
                const newX = this.node.offsetLeft + mouseEvent.pageX - this.lastMousePos[0];
                const newY = this.node.offsetTop + mouseEvent.pageY - this.lastMousePos[1];
        ...
        (_a = document.querySelector('#jp-main-content-panel')) === null || _a === void 0 ? void 0 : _a.appendChild(this.node);
        ...
        let initLeft = 200;
        if (this.stickyCell.notebook.node.parentElement) {
            console.log(this.stickyCell.notebook.node.parentElement);
            initLeft =
                parseInt(this.stickyCell.notebook.node.parentElement.style.left) + 10;
        }
        // Position the node to the inner region and offset it a little bit when
        // users create multiple windows
        this.node.style.left = `${initLeft + this.stickyLand.floatingWindows.length * 20}px`;
        this.node.style.top = `${100 + this.stickyLand.floatingWindows.length * 20}px`;
...
//# sourceMappingURL=lib_index_js.fcd679060a624159161e.js.map