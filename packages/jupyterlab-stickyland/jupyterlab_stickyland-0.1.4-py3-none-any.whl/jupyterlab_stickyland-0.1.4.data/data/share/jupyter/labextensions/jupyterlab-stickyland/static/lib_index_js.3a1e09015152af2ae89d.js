            ...
            if (this.autoRunningCellNodes.has(args.cell.node)) {
                ...
                if (this.autoRunningCellNodes.size === 0) {
                    ...
                    this.autoRunTabs.forEach(d => {
                        const curCell = d.tabContent.curContent;
                        console.log(curCell.isFloating);
                        if (!d.tabNode.classList.contains('current') && !curCell.isFloating) {
...
//# sourceMappingURL=lib_index_js.3a1e09015152af2ae89d.js.map