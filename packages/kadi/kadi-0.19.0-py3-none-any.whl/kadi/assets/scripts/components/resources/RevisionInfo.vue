      ...
      <div v-for="(value, prop) in revision.data" :key="prop">
        ...
        <div class="row" v-if="revision.diff[prop]">
          <div class="col-md-10 offset-md-2 diff-add">
            ...
            <pre class="d-inline pre-wrap" v-if="revision.diff[prop]['new'] !== null">{{ revision.diff[prop]['new'] }}</pre>
...
export default {
  ...
  mounted() {
    axios.get(this.endpoint)
      ...
      .catch((error) => kadi.alert('Error loading revision.', {request: error.request}));
  },
};
</script>
