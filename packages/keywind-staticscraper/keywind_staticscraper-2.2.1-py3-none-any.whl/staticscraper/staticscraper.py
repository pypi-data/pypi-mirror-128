...
class SSTime:
    ...
    def name(basename = "", extension = ""):
        ...
        return (
            f"{basename}_D-{SSTime.month_table[month - 1]}{day}20{year}_T-{hour}{minute}{second}{extension}"
        )
...
class StaticScraper:
    ...
    def __show_progress(self, page = None, progress = None, pages = None, finish = False):
    ...
    def scrape(self, start = 1, pages = 1):
        ...
        for page in range(start, start + pages):
            ...
            self.__show_progress(page, progress, pages)
            ...
            self.__show_progress(finish = True)
