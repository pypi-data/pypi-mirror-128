...
.. sourcecode:: pycon
    ...
    >>> model_type = LdaMallet(path_to_mallet_binary, corpus=common_corpus, num_topics=20, id2word=common_dictionary)
    >>> vector = model_type[common_corpus[0]]  # LDA topics of a documents
"""
