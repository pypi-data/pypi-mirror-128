...
def newExperimentMaterial(user, experiment_id, name, resource_id=None, resource_item_id=None, amount=None, units=None, extraParams={}):
    params = {
        "experiment_id": experiment_id,
        "name": name,
...
def editExperimentMaterial(expermient_material, name=None, amount=None, units=None, resource_id=None, resource_item_id=None, extraParams={}):
    params = {
        "name": name,
        "value": amount,
        "units": units,
