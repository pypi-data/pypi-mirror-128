...
from ..py_scripts import lf_report
...
from ..py_scripts import csv_to_influx
from ..py_dashboard import InfluxRequest
...
--endp_type lf_udp --rates_are_totals --side_a_min_bps=20000 --side_b_min_bps=300000000 --test_rig CT-US-001 --test_tag 'l3_longevity'
    ...
    if args.influx_bucket is not None:
        from ..py_dashboard.InfluxRequest import RecordInflux
