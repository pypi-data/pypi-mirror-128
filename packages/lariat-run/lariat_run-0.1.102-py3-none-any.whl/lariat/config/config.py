...
class EnvConfig(object):
    ...
    def get_api_key(self):
        return os.environ.get("LARIAT_API_KEY", None)

    def get_application_key(self):
        return os.environ.get("LARIAT_APPLICATION_KEY", None)

    def get_endpoint(self):
        return os.environ.get("LARIAT_ENDPOINT", None)
...
class BaseConfig(object):
    ...
    @property
    def api_key(self):
        return self.env.get_api_key() or defaults.API_KEY

    @property
    def application_key(self):
        return self.env.get_application_key() or defaults.APPLICATION_KEY

    @property
    def endpoint(self):
        return self.env.get_endpoint() or defaults.ENDPOINT

    @property
    def event_buffer_size(self):
        return defaults.EVENT_BUFFER_SIZE

    @property
    def ingest_url(self):
        return defaults.INGEST_URL
