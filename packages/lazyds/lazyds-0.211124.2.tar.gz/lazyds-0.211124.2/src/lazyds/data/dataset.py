...
def dataset(name="wdbc"):
    ...
    return {"X": X, "y": y, "_history": ...}


dataset.metadata = {"id": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "name": "arff2df", "description": "Arff loader"}
...
def arff2df(name=None):
    ...
    with open(name + ".arff") as f:
        df = a2p.load(f)
    return {"df": df, "_history": ...}


arff2df.metadata = {"id": "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", "name": "arff2df", "description": "Arff loader"}
...
def csv2df(name=None):
    ...
    """
    return {"df": read_csv(name + ".arff"), "_history": ...}


csv2df.metadata = {"name": "csv2df", "description": "CSV loader"}
...
def df2arff(field=None, **kwargs):  # TODO: change Noine to a def value "df" and correct fosh
    ...
    """
    return {"arff": a2p.dumps(kwargs[field])}
