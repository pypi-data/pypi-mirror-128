...
add_tabpanel() on %s horizontal 'main' panel %r."""
    ...
    def get_layout_handle(self, ui=None):
        """
        Return the LayoutHandle for this layout on the specified front end `ui`.
        Create a LayoutHandle instance if this is the first call.

        TODO: replace get_layout_handle by a simple property. We no longer have
        Lino sites with several front ends
