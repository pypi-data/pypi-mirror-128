...
if __name__ == "__main__":
    print(decrypt('lIPA8Yl8wzzwWDf9FdQe4g'))
    ...
    # print(ciphertext)
    ciphertext = encrypt('mssql+pymssql://sa:resset@106.75.219.243:25779/Company_report?charset=utf8', "resset", "hello")
    print(ciphertext)
    ciphertext = encrypt('106.75.219.243:25779', "resset", "hello")
    print(ciphertext)
