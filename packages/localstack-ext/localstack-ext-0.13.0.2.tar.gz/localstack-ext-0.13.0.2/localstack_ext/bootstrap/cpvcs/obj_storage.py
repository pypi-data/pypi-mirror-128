...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=chMWX
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:chMWj)->chMWj:
  pass
 @chMWz
 def get(cls,requested_file_locator:chMWj):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=chMWX
 @chMWz
 def get(cls,state_file_locator:chMWj,requested_storage:chMWj,serializers:Dict[chMWj,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[chMWj,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:chMWj)->chMWj:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:chMWj)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:chMWj)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:chMWj)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:chMWj)->chMWj:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[chMWj]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:chMWj,new_key:chMWj,referenced_by_version:chMWj=chMWX):
  pass
 @abc.abstractmethod
 def version_exists(self,key:chMWj)->chMWT:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:chMWj,key:chMWj):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:chMWj,new_key:chMWj,base_path:chMWj)->chMWT:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[chMWj]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[chMWj,chMWj],remote_location:chMWj=chMWX)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[chMWj]:
  ...
  for cpvcs_obj in args:
   if chMWi(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif chMWi(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[chMWj,chMWj],remote_location:chMWj=chMWX)->List[Union[Revision,Version]]:
