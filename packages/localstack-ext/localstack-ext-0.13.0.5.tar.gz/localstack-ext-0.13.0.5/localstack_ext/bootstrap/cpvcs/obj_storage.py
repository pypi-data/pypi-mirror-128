...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=ojJUG
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:ojJUp)->ojJUp:
  pass
 @ojJUW
 def get(cls,requested_file_locator:ojJUp):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=ojJUG
 @ojJUW
 def get(cls,state_file_locator:ojJUp,requested_storage:ojJUp,serializers:Dict[ojJUp,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[ojJUp,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:ojJUp)->ojJUp:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:ojJUp)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:ojJUp)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:ojJUp)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:ojJUp)->ojJUp:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[ojJUp]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:ojJUp,new_key:ojJUp,referenced_by_version:ojJUp=ojJUG):
  pass
 @abc.abstractmethod
 def version_exists(self,key:ojJUp)->ojJUP:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:ojJUp,key:ojJUp):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:ojJUp,new_key:ojJUp,base_path:ojJUp)->ojJUP:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[ojJUp]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[ojJUp,ojJUp],remote_location:ojJUp=ojJUG)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[ojJUp]:
  ...
  for cpvcs_obj in args:
   if ojJUX(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif ojJUX(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[ojJUp,ojJUp],remote_location:ojJUp=ojJUG)->List[Union[Revision,Version]]:
