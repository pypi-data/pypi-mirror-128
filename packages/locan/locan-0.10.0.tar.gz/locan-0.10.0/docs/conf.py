...
copyright = '2018-2021, Locan Developers'

# Version number generated by setuptools_scm
# from pkg_resources import get_distribution
#release = get_distribution('locan').version
...
exclude_patterns = ['_build', 'jupyter_execute', '.jupyter_cache', '**.ipynb_checkpoints']
...
latex_documents = [
    (master_doc, 'Locan.tex', 'Locan Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'locan', 'Locan Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Locan', 'Locan Documentation',
     author, 'Locan', 'One line description of project.',
     'Miscellaneous'),
]
