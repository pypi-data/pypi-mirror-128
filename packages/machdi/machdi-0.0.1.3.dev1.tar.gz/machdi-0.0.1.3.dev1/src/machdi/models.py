...
class _LinearModels():
    ...
    def __init__(self, penalty='L2',alpha=0, bias_included=False,lr=.001,train_type='mini-batch',n_reports=0,maxIter=100,converLim=.001,n_converLim = 1,plotting = False):
...
class LinearRegressor(_LinearModels,_Optimization):
    ...
    def __init__(self, penalty='L2' ,alpha=0, bias_included=False,train_type=None,lr=.001,n_reports=0,maxIter=100, converLim=.001,n_converLim=1,plotting = False):
        super().__init__(penalty=penalty, alpha=alpha, bias_included=bias_included,train_type=train_type,lr=lr,n_reports=n_reports,maxIter=maxIter,converLim=converLim,n_converLim=n_converLim,plotting=plotting)
        self.activ = 'linear'
...
class LogisticRegressor(_LinearModels,_Optimization):
    ...
    def __init__(self,activation='sigmoid', penalty='L2' ,alpha=0, bias_included=False,train_type=None,lr=.001,n_reports=0,maxIter=100, converLim=.001,n_converLim=1,plotting= False):
        super().__init__(penalty=penalty, alpha=alpha, bias_included=bias_included,train_type=train_type,lr=lr,n_reports=n_reports,maxIter=maxIter,converLim=converLim,n_converLim=n_converLim,plotting=plotting)
