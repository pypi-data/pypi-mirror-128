...
from mad_notifications.settings import webhook_settings
...
def get_notification_model():
    ...
    return apps.get_model(webhook_settings.NOTIFICATION_MODEL)


def get_email_template_model():
    """Return the Notification model that is active in this project."""
    return apps.get_model(webhook_settings.EMAIL_TEMPLATE_MODEL)


def get_device_model():
    """Return the Notification model that is active in this project."""
    return apps.get_model(webhook_settings.DEVICE_MODEL)