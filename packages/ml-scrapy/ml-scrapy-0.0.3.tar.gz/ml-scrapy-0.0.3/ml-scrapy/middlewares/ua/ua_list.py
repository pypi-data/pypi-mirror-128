...
def ua_list(agent_type='pc'):
    """
    :param agent_type: 默认pc,传入非pc字符串则为手机版ua
    :return: str ua字符串
    """
    if agent_type == 'pc':
        return choice(USER_AGENTS_PC)
    return choice(USER_AGENTS_MOBILE)
...
if __name__ == '__main__':
    ...
    for ua in USER_AGENTS_MOBILE:
        headers = {
            'User-Agent': ua
        }
        resp = requests.get('https://byne.newhouse.fang.com/house/s/a73-b93/', headers=headers, allow_redirects=False)
