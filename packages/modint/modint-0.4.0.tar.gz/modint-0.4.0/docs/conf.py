# -*- coding: utf-8 -*-
#
# modint documentation build configuration file, created by
...
latex_documents = [
  ('index', 'modint.tex', u'modint Documentation',
...
man_pages = [
    ('index', 'modint', u'modint Documentation',
     [u'Shlomi Fish'], 1)
]
