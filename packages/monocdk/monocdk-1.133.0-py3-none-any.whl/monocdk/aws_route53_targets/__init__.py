...
* API Gateway custom domains
  ...
  from monocdk import aws_apigateway as apigw
...
* API Gateway V2 custom domains
  ...
  ```python
  # Example automatically generated from non-compiling source. May contain errors.
  from monocdk import aws_apigatewayv2 as apigwv2
...
* ELBv2 load balancers
  ...
  ```python
  # Example automatically generated from non-compiling source. May contain errors.
  from monocdk import aws_elasticloadbalancingv2 as elbv2
...
* Classic load balancers
  ...
  ```python
  # Example automatically generated from non-compiling source. May contain errors.
  from monocdk import aws_elasticloadbalancing as elb
...
class ApiGatewayDomain(
    ...
    Example::
        ...
        from monocdk import aws_route53_targets as targets
