...
[boto3.ChimeSDKMeetings 1.20.9](https://boto3.amazonaws.com/v1/documentation/api/1.20.9/reference/services/chime-sdk-meetings.html#ChimeSDKMeetings)
...
def check_value(value: TranscribeContentIdentificationTypeType) -> bool:
    ...
```
