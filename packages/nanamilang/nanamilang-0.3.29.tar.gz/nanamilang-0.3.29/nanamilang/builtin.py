"""NanamiLang Builtin and BuiltinMacro Class"""
...
from nanamilang.arity import Arity
...
class BuiltinMacro:
    ...
    def let_macro(tree_slice: list, env: dict, ev_func, token_cls) -> list:
        ...
        # Skip `make-vector' Identifier token
        ...
        for [key_token, value_token_or_form] in partitioned:
            ...
            # -- update local env now using ev_func() ---
...
class BuiltinFunctions:
    ...
    def get_func(args: List[datatypes.Base]) -> datatypes.Base:
        ...
        # Let the collection.get() handle key_or_index type checking
