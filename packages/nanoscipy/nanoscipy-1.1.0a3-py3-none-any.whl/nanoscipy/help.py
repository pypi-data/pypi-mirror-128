...
def _help_plot_data():
    ...
    if help_id_inner == '1': 
        ...
        print()
        print('<v_ax> defines a vertical axis, according to multiple variables')
        print('--- Input: either the bool: False, or a list containing [True, axis-color, axis-style, alpha] according to https://matplotlib.org/stable/gallery/color/named_colors.html and https://matplotlib.org/stable/gallery/lines_bars_and_markers/linestyles.html')
        print('--- Default: [True,strig(black),string(dashed),0.5]')
        print()
        print('<h_ax> defines a vertical axis, according to multiple variables')
        print('--- Input: either the bool: False, or a list containing [True, axis-color, axis-style, alpha] according to https://matplotlib.org/stable/gallery/color/named_colors.html and https://matplotlib.org/stable/gallery/lines_bars_and_markers/linestyles.html')
        print('--- Default: [True,strig(black),string(dashed),0.5]')
        print()
