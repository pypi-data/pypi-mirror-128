...
#define nrn_init _nrn_init__kChan
#define _nrn_initial _nrn_initial__kChan
#define nrn_cur _nrn_cur__kChan
#define _nrn_current _nrn_current__kChan
#define nrn_jacob _nrn_jacob__kChan
#define nrn_state _nrn_state__kChan
#define _net_receive _net_receive__kChan 
#define rates rates__kChan 
#define states states__kChan 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kChan", _hoc_setdata,
 "rates_kChan", _hoc_rates,
 0, 0
};
 ...
 "gmax_kChan", "S/cm2",
 "conductance_kChan", "uS",
 "n_forwardRate_rate_kChan", "kHz",
 "n_forwardRate_midpoint_kChan", "mV",
 "n_forwardRate_scale_kChan", "mV",
 "n_reverseRate_rate_kChan", "kHz",
 "n_reverseRate_midpoint_kChan", "mV",
 "n_reverseRate_scale_kChan", "mV",
 "gion_kChan", "S/cm2",
 "n_forwardRate_r_kChan", "kHz",
 "n_reverseRate_r_kChan", "kHz",
 "n_alpha_kChan", "kHz",
 "n_beta_kChan", "kHz",
 "n_tau_kChan", "ms",
 "g_kChan", "uS",
...
"kChan",
 ...
 "conductance_kChan",
 "n_instances_kChan",
 "n_forwardRate_rate_kChan",
 "n_forwardRate_midpoint_kChan",
 "n_forwardRate_scale_kChan",
 "n_reverseRate_rate_kChan",
 "n_reverseRate_midpoint_kChan",
 "n_reverseRate_scale_kChan",
 0,
 "gion_kChan",
 "n_forwardRate_x_kChan",
 "n_forwardRate_r_kChan",
 "n_reverseRate_r_kChan",
 "n_rateScale_kChan",
 "n_alpha_kChan",
 "n_beta_kChan",
 "n_fcond_kChan",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	n_forwardRate_midpoint = -55;
 	n_forwardRate_scale = 10;
 	n_reverseRate_rate = 0.125;
 	n_reverseRate_midpoint = -65;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kChan /Users/padraig/NeuroMLlite/examples/test_files/x86_64/kChan.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=kChan type=ionChannelHH)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/padraig/NeuroMLlite/examples/test_files/kChan.mod";
static const char* nmodl_file_text = 
