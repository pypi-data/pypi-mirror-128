...
#define nrn_init _nrn_init__poissonFiringSyn
#define _nrn_initial _nrn_initial__poissonFiringSyn
#define nrn_cur _nrn_cur__poissonFiringSyn
#define _nrn_current _nrn_current__poissonFiringSyn
#define nrn_jacob _nrn_jacob__poissonFiringSyn
#define nrn_state _nrn_state__poissonFiringSyn
#define _net_receive _net_receive__poissonFiringSyn 
#define noiseFromRandom noiseFromRandom__poissonFiringSyn 
#define rates rates__poissonFiringSyn 
#define seed seed__poissonFiringSyn 
#define states states__poissonFiringSyn 
...
#define H H_poissonFiringSyn
#define erand erand_poissonFiringSyn
#define random_float random_float_poissonFiringSyn
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 poissonFiringSyn /Users/padraig/NeuroMLlite/examples/test_files/x86_64/poissonFiringSyn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=poissonFiringSyn type=poissonFiringSynapse)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/padraig/NeuroMLlite/examples/test_files/poissonFiringSyn.mod";
static const char* nmodl_file_text = 
  ...
  "    ? DerivedVariable is based on path: synapse/i, on: Component(id=poissonFiringSyn type=poissonFiringSynapse), from synapse; Component(id=synInput type=expTwoSynapse)\n"
