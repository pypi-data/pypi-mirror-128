...
#define rates rates__ampaSyn 
#define states states__ampaSyn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 ampaSyn /Users/padraig/NeuroMLlite/examples/x86_64/ampaSyn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=ampaSyn type=alphaCondSynapse)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/padraig/NeuroMLlite/examples/ampaSyn.mod";
static const char* nmodl_file_text = 
