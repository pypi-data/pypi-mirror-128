...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 gaba /Users/padraig/NeuroMLlite/examples/x86_64/gaba.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=gaba type=alphaCurrSynapse)";
...
static int  rates ( _threadargsproto_ ) {
   i = - 1.0 * I * NAMP ;
   rate_I = ( 2.7182818 * A - I ) / ( tau_syn * MSEC ) ;
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(I) - _p;  _dlist1[0] = &(DI) - _p;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/padraig/NeuroMLlite/examples/gaba.mod";
static const char* nmodl_file_text = 
