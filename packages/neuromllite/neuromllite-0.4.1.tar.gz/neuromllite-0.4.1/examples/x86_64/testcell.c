...
#define nrn_init _nrn_init__testcell
#define _nrn_initial _nrn_initial__testcell
#define nrn_cur _nrn_cur__testcell
#define _nrn_current _nrn_current__testcell
#define nrn_jacob _nrn_jacob__testcell
#define nrn_state _nrn_state__testcell
#define _net_receive _net_receive__testcell 
#define rates rates__testcell 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 testcell /Users/padraig/NeuroMLlite/examples/x86_64/testcell.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=testcell type=IF_cond_alpha)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/padraig/NeuroMLlite/examples/testcell.mod";
static const char* nmodl_file_text = 
