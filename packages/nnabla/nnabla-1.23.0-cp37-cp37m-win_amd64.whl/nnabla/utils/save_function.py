...
def _create_function_nntxt(f, name, function):
    ...
    if f.type == 'Affine':
        ...
        pass
    elif f.type == 'RoiAlign':
        f.roi_align_param.output_size.dim.extend(function['args']['output_size'])
        f.roi_align_param.spatial_scale.extend(function['args']['spatial_scale'])
        f.roi_align_param.sampling_ratio = function['args']['sampling_ratio']
        f.roi_align_param.channel_last = bool(function['args']['channel_last'])
        pass
    elif f.type == 'Sigmoid':
        pass
    elif f.type == 'Swish':
        ...
        f.spectral_norm_param.output_u = bool(function['args']['output_u'])
        pass
        ...
        pass
    elif f.type == 'BoolGather':
        pass
    elif f.type == 'ScatterNd':
        f.scatter_nd_param.shape.extend(function['args']['shape'])
        f.scatter_nd_param.add = bool(function['args']['add'])
        pass
    elif f.type == 'ScatterAdd':
        f.scatter_add_param.axis = function['args']['axis']
        pass
    elif f.type == 'BoolScatter':
        pass
    elif f.type == 'BoolFill':
        f.bool_fill_param.value = function['args']['value']
        pass
