...
def _create_function_instance(ctx, f):
    ...
    if f.type == 'Affine':
        ...
        function = F.RoiAlign(
            ctx,
            output_size=f.roi_align_param.output_size.dim,
            spatial_scale=f.roi_align_param.spatial_scale,
            sampling_ratio=f.roi_align_param.sampling_ratio,
            channel_last=f.roi_align_param.channel_last,
            )
    elif f.type == 'Sigmoid':
        function = F.Sigmoid(
            ctx,
        ...
        function = F.SpectralNorm(
            ...
            output_u=f.spectral_norm_param.output_u,
            )
        ...
        function = F.BoolScatter(
            ctx,
            )
    elif f.type == 'BoolFill':
        function = F.BoolFill(
            ctx,
            value=f.bool_fill_param.value,
            )
