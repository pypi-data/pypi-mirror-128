...
from nomad_pilot_cli.api.locker_api import LockerApi  # noqa: E501
from nomad_pilot_cli.rest import ApiException


class TestLockerApi(unittest.TestCase):
    """LockerApi unit test stubs"""

    def setUp(self):
        self.api = nomad_pilot_cli.api.locker_api.LockerApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_query_locker(self):
        """Test case for query_locker
