...
import pandas as pd
from noquant_futu.common.open_context_base import OpenContextBase, ContextStatus
from noquant_futu.quote.quote_query import *
...
class OpenQuoteContext(OpenContextBase):
    ...
    def get_stock_basicinfo(self, market, stock_type=SecurityType.STOCK, code_list=None):
        ...
        :param stock_type: 股票类型， noquant_futu.common.constant.SecurityType
