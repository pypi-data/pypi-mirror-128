...
from noquant_futu.common.utils import *
from noquant_futu.common.pb import Common_pb2
from noquant_futu.quote.quote_stockfilter_info import *
from noquant_futu.quote.quote_get_warrant import *
...
class InitConnect:
    ...
    def pack_req(cls, client_ver, client_id, recv_notify, is_encrypt, push_proto_fmt):
        ...
        from noquant_futu.common.pb.InitConnect_pb2 import Request
        req = Request()
...
class RequestTradeDayQuery:
    ...
    def pack_req(cls, market, conn_id, start_date=None, end_date=None, code=None):
        ...
        # pack to json
        from noquant_futu.common.pb.Qot_RequestTradeDate_pb2 import Request
        req = Request()
        req.c2s.market = v
...
class StockBasicInfoQuery:
    ...
    def pack_req(cls, market, conn_id, stock_type='STOCK', code_list=None):
        ...
        from noquant_futu.common.pb.Qot_GetStaticInfo_pb2 import Request
        req = Request()
        if query_code:
            req.c2s.market = 0
            req.c2s.secType = 0
...
class MarketSnapshotQuery:
    ...
    def pack_req(cls, stock_list, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetSecuritySnapshot_pb2 import Request
        req = Request()
...
class RtDataQuery:
    ...
    def pack_req(cls, code, conn_id):
        ...
        market_code, stock_code = content
        from noquant_futu.common.pb.Qot_GetRT_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
...
class SubplateQuery:
    ...
    def pack_req(cls, market, plate_class, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetPlateSet_pb2 import Request
        req = Request()
        _, req.c2s.market = Market.to_number(market)
...
class PlateStockQuery:
    ...
    def pack_req(cls, plate_code, sort_field, ascend, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetPlateSecurity_pb2 import Request
        req = Request()
...
class BrokerQueueQuery:
    ...
    def pack_req(cls, code, conn_id):
        ...
        market, code = content
        from noquant_futu.common.pb.Qot_GetBroker_pb2 import Request
        req = Request()
...
class RequestHistoryKlineQuery:
    ...
    def pack_req(cls, code, start_date, end_date, ktype, autype, fields,
        ...
        from noquant_futu.common.pb.Qot_RequestHistoryKL_pb2 import Request
...
class SubscriptionQuery:
    ...
    def pack_sub_or_unsub_req(cls,
        ...
        from noquant_futu.common.pb.Qot_Sub_pb2 import Request
        req = Request()
    ...
    def pack_subscription_query_req(cls, is_all_conn, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetSubInfo_pb2 import Request
        req = Request()
    ...
    def pack_push_or_unpush_req(cls, code_list, subtype_list, is_push, conn_id, is_first_push):
        ...
        from noquant_futu.common.pb.Qot_RegQotPush_pb2 import Request
        req = Request()
        for market_code, stock_code in stock_tuple_list:
            stock_inst = req.c2s.securityList.add()
            stock_inst.code = stock_code
...
class StockQuoteQuery:
    ...
    def pack_req(cls, stock_list, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetBasicQot_pb2 import Request
        req = Request()
        for market_code, stock_code in stock_tuple_list:
            stock_inst = req.c2s.securityList.add()
            stock_inst.market = market_code
...
class TickerQuery:
    ...
    def pack_req(cls, code, num, conn_id):
        ...
        market_code, stock_code = content
        from noquant_futu.common.pb.Qot_GetTicker_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
...
class CurKlineQuery:
    ...
    def pack_req(cls, code, num, ktype, autype, conn_id):
        ...
        if num < 0:
            error_str = ERROR_STR_PREFIX + "num is %s, which is less than 0" % num
            return RET_ERROR, error_str, None
        from noquant_futu.common.pb.Qot_GetKL_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
        _, req.c2s.rehabType = AuType.to_number(autype)
...
class OrderBookQuery:
    ...
    def pack_req(cls, code, num, conn_id):
        ...
        market_code, stock_code = content
        from noquant_futu.common.pb.Qot_GetOrderBook_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
        req.c2s.num = num
...
class SuspensionQuery:
    ...
    def pack_req(cls, code_list, start, end, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetSuspend_pb2 import Request
        req = Request()
        if start:
...
class GlobalStateQuery:
    ...
    def pack_req(cls, user_id, conn_id):
        ...
        from noquant_futu.common.pb.GetGlobalState_pb2 import Request
        req = Request()
...
class KeepAlive:
    ...
    def pack_req(cls, conn_id):
        ...
        from noquant_futu.common.pb.KeepAlive_pb2 import Request
        req = Request()
...
class StockReferenceList:
    ...
    def pack_req(cls, code, ref_type, conn_id):
        from noquant_futu.common.pb.Qot_GetReference_pb2 import Request
...
class OwnerPlateQuery:
    ...
    def pack_req(cls, code_list, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetOwnerPlate_pb2 import Request
        req = Request()
        for market_code, stock_code in stock_tuple_list:
            stock_inst = req.c2s.securityList.add()
            stock_inst.market = market_code
...
class HoldingChangeList:
    ...
    def pack_req(cls, code, holder_type, conn_id, start_date, end_date=None):
        ...
        from noquant_futu.common.pb.Qot_GetHoldingChangeList_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
...
class OptionChain:
    ...
    def pack_req(cls, code, index_option_type, conn_id, start_date, end_date=None, option_type=OptionType.ALL, option_cond_type=OptionCondType.ALL, data_filter = None):
        ...
        from noquant_futu.common.pb.Qot_GetOptionChain_pb2 import Request
        req = Request()
...
class QuoteWarrant:
    ...
    def pack_req(cls, req, conn_id):
        from noquant_futu.quote.quote_get_warrant import Request as WarrantRequest
    ...
    @classmethod
    def unpack_rsp(cls, rsp_pb):
        from noquant_futu.quote.quote_get_warrant import Response as WarrantResponse
...
class HistoryKLQuota:
    ...
    def pack_req(cls, get_detail, conn_id):
        from noquant_futu.common.pb.Qot_RequestHistoryKLQuota_pb2 import Request
        req = Request()
...
class RequestRehab:
    ...
    def pack_req(cls, stock, conn_id):
        ...
        from noquant_futu.common.pb.Qot_RequestRehab_pb2 import Request
        req = Request()
        req.c2s.security.market = market
        req.c2s.security.code = code
...
class GetUserInfo:
    ...
    def pack_req(cls, info_field, conn_id):
        from noquant_futu.common.pb.GetUserInfo_pb2 import Request
        req = Request()
...
class GetCapitalDistributionQuery:
    ...
    def pack_req(cls, code, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetCapitalDistribution_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
...
class GetCapitalFlowQuery:
    ...
    def pack_req(cls, code, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetCapitalFlow_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
...
class GetDelayStatisticsQuery:
    ...
    def pack_req(cls, type_list, qot_push_stage, segment_list, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.GetDelayStatistics_pb2 import Request
        req = Request()
        for t in type_list:
...
class Verification:
    ...
    def pack_req(cls, verification_type, verification_op, code, conn_id):
        from noquant_futu.common.pb.Verification_pb2 import Request
        req = Request()
...
class ModifyUserSecurityQuery:
    ...
    def pack_req(cls, group_name, op, code_list, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_ModifyUserSecurity_pb2 import Request
        req = Request()
...
class GetUserSecurityQuery:
    ...
    def pack_req(cls, group_name, conn_id):
        """check group_name 分组名,有同名的返回首个"""
        # 开始组包
        from noquant_futu.common.pb.Qot_GetUserSecurity_pb2 import Request
        req = Request()
        req.c2s.groupName = group_name
...
class StockFilterQuery:
    ...
    def pack_req(cls, market, filter_list, plate_code, begin, num, conn_id):
        """check group_name 分组名,有同名的返回首个"""
        # 开始组包
        from noquant_futu.common.pb.Qot_StockFilter_pb2 import Request
        req = Request()
        req.c2s.begin = begin
        req.c2s.num = num
...
class GetCodeChangeQuery:
    ...
    def pack_req(cls, code_list, time_filter_list, type_list, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetCodeChange_pb2 import Request
        req = Request()
...
class GetIpoListQuery:
    ...
    def pack_req(cls, conn_id, market):
        # 开始组包
        from noquant_futu.common.pb.Qot_GetIpoList_pb2 import Request
        req = Request()
        _, req.c2s.market = Market.to_number(market)
...
class GetFutureInfoQuery:
    ...
    def pack_req(cls, code_list, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetFutureInfo_pb2 import Request
        req = Request()
        for market_code, stock_code in stock_tuple_list:
            stock_inst = req.c2s.securityList.add()
            stock_inst.market = market_code
...
class TestCmd:
    ...
    def pack_req(cls, cmd, params):
        ...
        from noquant_futu.common.pb.TestCmd_pb2 import Request
        req = Request()
        req.c2s.cmd = cmd
...
class SetPriceReminderQuery:
    ...
    def pack_req(cls, code, op, key, reminder_type, reminder_freq, value, note, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_SetPriceReminder_pb2 import Request
        req = Request()
        req.c2s.security.market = market_code
        req.c2s.security.code = stock_code
...
class GetPriceReminderQuery:
    ...
    def pack_req(cls, code, market, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetPriceReminder_pb2 import Request
        req = Request()
        if code is not None:
            req.c2s.security.market = market_code
            req.c2s.security.code = stock_code
...
class GetUserSecurityGroupQuery:
    ...
    def pack_req(cls, group_type, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetUserSecurityGroup_pb2 import Request
        req = Request()
...
class GetMarketStateQuery:
    ...
    def pack_req(cls, code_list, conn_id):
        ...
        # 开始组包
        from noquant_futu.common.pb.Qot_GetMarketState_pb2 import Request
        req = Request()
        for market_code, stock_code in stock_tuple_list:
            stock_inst = req.c2s.securityList.add()
            stock_inst.market = market_code
...
class GetOptionExpirationDate:
    ...
    def pack_req(cls, code, index_option_type, conn_id):
        ...
        from noquant_futu.common.pb.Qot_GetOptionExpirationDate_pb2 import Request
        req = Request()
        req.c2s.owner.market = market_code
        req.c2s.owner.code = stock_code
        if index_option_type is not None:
