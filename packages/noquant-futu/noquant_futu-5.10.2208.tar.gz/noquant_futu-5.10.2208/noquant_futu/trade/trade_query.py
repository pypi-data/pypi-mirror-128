...
from noquant_futu.quote.quote_query import pack_pb_req
...
class GetAccountList:
    ...
    def pack_req(cls, user_id, conn_id, trd_category, need_general_sec_acc):
        from noquant_futu.common.pb.Trd_GetAccList_pb2 import Request
...
class UnlockTrade:
    ...
    def pack_req(cls, is_unlock, password_md5, conn_id, security_firm):
        ...
        from noquant_futu.common.pb.Trd_UnlockTrade_pb2 import Request
        req = Request()
...
class SubAccPush:
    ...
    def pack_req(cls, acc_id_list, conn_id):
        from noquant_futu.common.pb.Trd_SubAccPush_pb2 import Request
        req = Request()
...
class AccInfoQuery:
    ...
    def pack_req(cls, acc_id, trd_market, trd_env, conn_id, refresh_cache, currency):
        from noquant_futu.common.pb.Trd_GetFunds_pb2 import Request
        req = Request()
...
class PositionListQuery:
    ...
    def pack_req(cls, code, pl_ratio_min,
        ...
        """Convert from user request for trading days to PLS request"""
        from noquant_futu.common.pb.Trd_GetPositionList_pb2 import Request
        req = Request()
        _, req.c2s.header.trdEnv = TrdEnv.to_number(trd_env)
        req.c2s.header.accID = acc_id
...
class OrderListQuery:
    ...
    def pack_req(cls, order_id, status_filter_list, code, start, end,
        ...
        """Convert from user request for trading days to PLS request"""
        from noquant_futu.common.pb.Trd_GetOrderList_pb2 import Request
        req = Request()
        _, req.c2s.header.trdEnv = TrdEnv.to_number(trd_env)
        req.c2s.header.accID = acc_id
        _, req.c2s.header.trdMarket = TrdMarket.to_number(trd_mkt)
...
class PlaceOrder:
    ...
    def pack_req(cls, trd_side, order_type, price, qty,
        ...
        from noquant_futu.common.pb.Trd_PlaceOrder_pb2 import Request
        req = Request()
...
class ModifyOrder:
    ...
    def pack_req(cls, modify_order_op, order_id, price, qty,
        ...
        """Convert from user request for place order to PLS request"""
        from noquant_futu.common.pb.Trd_ModifyOrder_pb2 import Request
        req = Request()
        serial_no = get_unique_id32()
        req.c2s.packetID.serialNo = serial_no
        req.c2s.packetID.connID = conn_id
...
class DealListQuery:
    ...
    def pack_req(cls, code, trd_env, acc_id, trd_mkt, conn_id, refresh_cache):
        """Convert from user request for place order to PLS request"""
        from noquant_futu.common.pb.Trd_GetOrderFillList_pb2 import Request
        req = Request()
        _, req.c2s.header.trdEnv = TrdEnv.to_number(trd_env)
        req.c2s.header.accID = acc_id
        _, req.c2s.header.trdMarket = TrdMarket.to_number(trd_mkt)
...
class HistoryOrderListQuery:
    ...
    def pack_req(cls, status_filter_list, code, start, end,
        ...
        from noquant_futu.common.pb.Trd_GetHistoryOrderList_pb2 import Request
        req = Request()
        _, req.c2s.header.trdEnv = TrdEnv.to_number(trd_env)
        req.c2s.header.accID = acc_id
        _, req.c2s.header.trdMarket = TrdMarket.to_number(trd_mkt)
...
class HistoryDealListQuery:
    ...
    def pack_req(cls, code, start, end, trd_env, acc_id, trd_mkt, conn_id):
        ...
        from noquant_futu.common.pb.Trd_GetHistoryOrderFillList_pb2 import Request
        req = Request()
        _, req.c2s.header.trdEnv = TrdEnv.to_number(trd_env)
        req.c2s.header.accID = acc_id
        _, req.c2s.header.trdMarket = TrdMarket.to_number(trd_mkt)
...
class AccTradingInfoQuery:
    ...
    def pack_req(cls, order_type, code, price, order_id, adjust_limit, sec_mkt_str, trd_env, acc_id, trd_mkt, conn_id):
        ...
        from noquant_futu.common.pb.Trd_GetMaxTrdQtys_pb2 import Request
        req = Request()
        _, req.c2s.header.trdEnv = TrdEnv.to_number(trd_env)
        req.c2s.header.accID = acc_id
        _, req.c2s.header.trdMarket = TrdMarket.to_number(trd_mkt)
    ...
    @classmethod
    def unpack_rsp(cls, rsp_pb):
        from noquant_futu.common.pb.Trd_Common_pb2 import MaxTrdQtys
...
class MarginRatio:
    ...
    def pack_req(cls, code_list, conn_id, acc_id, trd_mkt):
        ...
        from noquant_futu.common.pb.Trd_GetMarginRatio_pb2 import Request
        req = Request()
