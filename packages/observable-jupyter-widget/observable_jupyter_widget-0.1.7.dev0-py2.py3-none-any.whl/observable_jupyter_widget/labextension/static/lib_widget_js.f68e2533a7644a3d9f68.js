...
ObservableWidgetModel.view_name = 'ObservableWidgetView'; // Set to null if no view
ObservableWidgetModel.view_module = version_1.MODULE_NAME; // Set to null if no view
...
class ObservableWidgetView extends base_1.DOMWidgetView {
    constructor() {
        super(...arguments);
        // ugly hack until I figure out how to add code to the constructor
        this.pAndR = promiseAndResolve();
        this.iframeReadyForInputs = this.pAndR[0];
        this.iframeReadyForInputsResolve = this.pAndR[1];
        this.queuedInputs = [];
        this.onInputs = (inputs) => __awaiter(this, void 0, void 0, function* () {
    ...
    */
    render() {
        ...
        const iframe_id = 'observable-iframe-' + Math.floor(Math.random() * 1000000);
    ...
    <div class="value">initial</div>`;
        ...
        wrapper_code_1.listenToSizeAndValuesAndReady(this.iframe, this.onPublishValues, onReady);
...
function get_srcdoc(slug, cells, inputs) {
    return `<!DOCTYPE html>
