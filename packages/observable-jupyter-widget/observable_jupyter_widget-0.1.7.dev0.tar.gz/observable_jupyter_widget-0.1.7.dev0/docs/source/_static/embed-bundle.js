define("observable-jupyter-widget", ["@jupyter-widgets/base"], (__WEBPACK_EXTERNAL_MODULE__jupyter_widgets_base__) => { return /******/ (() => { // webpackBootstrap
...
const wrapper_code_1 = __webpack_require__(/*! ./wrapper_code */ "./src/wrapper_code.ts");
const observable_logo_1 = __webpack_require__(/*! ./observable_logo */ "./src/observable_logo.ts");
...
class ObservableWidgetView extends base_1.DOMWidgetView {
    constructor() {
        ...
        this.onInputs = () => __awaiter(this, void 0, void 0, function* () {
            const inputs = Object.assign({}, this.model.get('inputs'));
...
function get_srcdoc(slug, cells, outputs) {
    return `<!DOCTYPE html>
