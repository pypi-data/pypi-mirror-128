...
class MotorConfig(ConfigType):
    ...
    db_ref: str = ""
    scale: str = "" # [scalar], default: 1.0
    phase_resistance: str = "" # [H]
    phase_inductance: str = "" # [Ohm]
    ...
    def get_status(self, odrives):
        ...
        for net in self.get_nets(NetType.RS485):
            ...
            for enc_ref in enc_refs:
                ...
                if encoder_config.db_ref != 'amt21':
                    issues.append(enc_ref, f"Encoder type {encoder_config.db_ref} not supported over RS485.")
