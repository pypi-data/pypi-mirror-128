...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        self.status = ' 💎 {party_size}/16 Use Code LACOSTE 💎'
        ...
        super().__init__(
            ...
            status=self.status,
            platform=fortnitepy.Platform('SWT'),
            **kwargs
        ...
        self.server = server
        self.welcome_message =  " Use Code LACOSTE in the Item Shop (#EpicPartner)\n Follow my tiktok : AerozOff \n Mon discord : https://discord.gg/w9HPhrU3n4"
    ...
    async def status_change(self) -> None:
        ...
        await self.set_presence("💎 {party_size}/16 Use Code LACOSTE 💎")
