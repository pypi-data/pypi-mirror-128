...
class Tracking:
    def __init__(self, pedido_id: int, codigo_rastreio: str, link_rastreio: str, data_previsao_entrega: str, codigo_erp_rastreio: str, codigo_sku: str,
                 cnpj_transportadora: str, trasportadora: str, codigo_trasportadora: str, tipo_servico: str, quantidade: int):
        ...
        self.transportadora: str = trasportadora
        self.codigo_transportadora: str = codigo_trasportadora
