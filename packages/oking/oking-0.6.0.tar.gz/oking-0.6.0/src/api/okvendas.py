...
def post_invoices(url: str, invoice: Invoice, token) -> Optional[InvoiceResponse]:
    ...
    try:
        ...
        if response.ok:
            ...
            if invoice_response.message.__contains__('_okvendas') or invoice_response.message.__contains__('_openkuget'):
...
def post_tracking(url: str, tracking: Tracking, token) -> Optional[TrackingResponse]:
    ...
    try:
        ...
        if response.ok:
            ...
            if tracking_response.message.__contains__('_okvendas') or tracking_response.message.__contains__('_openkuget'):
