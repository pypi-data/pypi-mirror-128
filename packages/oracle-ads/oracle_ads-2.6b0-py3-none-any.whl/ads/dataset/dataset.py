...
class ADSDataset(PandasDataset):
    ...
    def to_dask(
        ...
        try:
            ...
            utils._log_missing_module("dask", "dask")
            raise e
        res = self.to_pandas(
            filter=filter,
            frac=frac,
    ...
    def to_hdf(self, path, key, storage_options=None, **kwargs):
        """
        ...
        return self.df.to_hdf(path, key, storage_options=storage_options, **kwargs)
    ...
    def merge(self, data, **kwargs):
        ...
        data : Union[ADSDataset, pandas.DataFrame]
            Data to merge.
        kwargs : dict, optional
            kwargs: additional keyword arguments that would be passed to underlying dataframe's merge API.
            supported.
