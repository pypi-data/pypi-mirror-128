...
def find_object_prefix_recursive(obj, needle, make_mutable = False):
    ...
    if not obj or not isinstance(obj, ovito.plugins.PyScript.RefTarget): return None
        ...
        for attr_name in obj.__dir__():
            ...
            if isinstance(attr, property):
                ...
                try:
                    ...
                    if make_mutable and isinstance(value, ovito.plugins.PyScript.DataObject) and (attr_name + '_') in obj.__dir__():
                    ...
                    if search_pass == 1:
                        ...
                        if isinstance(value, collections.abc.Mapping):
                            ...
                            for key in value.keys():
                                ...
                                subobj = value[key]
                                if not isinstance(subobj, ovito.plugins.PyScript.RefTarget):
                        ...
                        if isinstance(value, collections.abc.Sequence) and not isinstance(value, str):
                            ...
                            for index in range(len(value)):
                                ...
                                if not path is None:
                                    ...
                                    if isinstance(obj, ovito.plugins.StdObjPython.Property) and isinstance(subobj, ovito.plugins.StdObjPython.ElementType) and attr_name == "types": 
                                        if make_mutable:
...
def codegen_pipeline(pipeline, include_vis):
    ...
    if include_vis:
        ...
        stream.write("import PySide2.QtCore\n")
    ...
    while isinstance(modapp, ovito.plugins.PyScript.ModifierApplication):
