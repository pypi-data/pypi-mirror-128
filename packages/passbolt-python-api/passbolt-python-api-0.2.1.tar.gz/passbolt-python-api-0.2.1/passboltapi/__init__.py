...
class PassboltAPI(APIClient):
    ...
    def iterate_resources(self, params=None):
        if params is None:
            params = {}
    ...
    def create_new_resource(self, username, password, folder=None):
        ...
        r = self.post("/resources.json", {
            ...
            **(folder or {"folder_parent_id": folder}),
        }, return_response_object=True)
        r.raise_for_status()
        r_json = r.json()
