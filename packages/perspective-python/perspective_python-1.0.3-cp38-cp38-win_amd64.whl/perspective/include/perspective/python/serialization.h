...
get_data_slice_unit(std::shared_ptr<View<t_ctxunit>> view, std::uint32_t start_row, std::uint32_t end_row, std::uint32_t start_col, std::uint32_t end_col);
...
t_val get_from_data_slice_unit(std::shared_ptr<t_data_slice<t_ctxunit>> data_slice, t_uindex ridx, t_uindex cidx);
...
std::vector<t_val> get_pkeys_from_data_slice_unit(std::shared_ptr<t_data_slice<t_ctxunit>> data_slice, t_uindex ridx, t_uindex cidx);
