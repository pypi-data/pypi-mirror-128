...
NAME = "pipelit"
MAIN_PACKAGE = "pipelit"
DESCRIPTION = "Tool to automagically build data pipelines."
URL = "https://github.com/lukasmasuch/pipelit"
...
setup(
    ...
    zip_safe=False,
    install_requires=["streamlit>=1.0.0", "pydantic", "streamlit-pydantic"],
