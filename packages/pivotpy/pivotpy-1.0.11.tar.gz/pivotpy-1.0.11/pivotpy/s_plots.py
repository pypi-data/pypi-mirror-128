...
__all__ = ['modify_axes', 'get_axes', 'break_spines', 'add_text', 'splot_bands', 'add_legend', 'add_colorbar',
           'color_wheel', 'splot_rgb_lines', 'splot_color_lines', 'splot_dos_lines', 'plt2html', 'show', 'savefig',
           'plt2text', 'plot_potential']
