...
def generar_kpis_agg_servicios(df,anio_df=None , anio_h =None ,t_anios=None,modalidad="EBR"):
    ...
    for anio in range(anio_h,ultimo_anio,-1):
        ...
        **dic_valores        
        ...
        df_agg_serv.rename(columns={'RATIO_RETIRADO': col_name.format("RATIO","DESAPROBADO")}, inplace=True)
...
def agregar_notas(df,anio_df=None,anio_notas=None,df_notas=None,
    ...
    #notas_gp = notas_group
    #notas_selected = get_notas_by_gp(notas_gp)  
