...
class Component:
    ...
    def _inner_horizontals(self) -> str:
        ...
        """
        return u"{}".format(
            self.border.horizontal * (self._calculate_border_width() - 2)
        )
    ...
    def _inner_horizontal_border(self) -> str:
        ...
        return u"{ml}{vl}{h}{vr}".format(
            ml=" " * self.margin.left,
            vl=self.border.vertical_left,
            vr=self.border.vertical_right,
    ...
    def _outer_horizontal_border_bottom(self) -> str:
        ...
        return u"{ml}{vl}{h}{vr}".format(
            ml=" " * self.margin.left,
            vl=self.border.bottom_left,
            vr=self.border.bottom_right,
            h=self._inner_horizontals(),
        )
    ...
    def _outer_horizontal_border_top(self) -> str:
        ...
        return u"{ml}{vl}{h}{vr}".format(
            ml=" " * self.margin.left,
            vl=self.border.top_left,
            vr=self.border.top_right,
...
class Box(Component):
    ...
    def __init__(
        ...
        super().__init__(style=style, max_dimension=max_dimension)
        self.title = title
