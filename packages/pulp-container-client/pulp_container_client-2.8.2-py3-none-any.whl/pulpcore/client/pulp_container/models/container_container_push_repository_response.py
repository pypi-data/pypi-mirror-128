...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, description=None, latest_version_href=None, name=None, pulp_created=None, retain_repo_versions=None, pulp_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
