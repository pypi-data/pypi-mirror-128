...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, versions_href=None, pulp_labels=None, latest_version_href=None, pulp_href=None, name=None, description=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
