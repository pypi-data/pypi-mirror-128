...
class PatchedpythonPythonDistribution(object):
    ...
    def __init__(self, base_path=None, content_guard=None, pulp_labels=None, name=None, repository=None, publication=None, allow_uploads=True, local_vars_configuration=None):  # noqa: E501
