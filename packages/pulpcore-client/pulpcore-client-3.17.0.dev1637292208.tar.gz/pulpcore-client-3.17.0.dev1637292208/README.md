...
- API version: v3
- Package version: 3.17.0.dev1637292208
...
*GroupsRolesApi* | [**create**](docs/GroupsRolesApi.md#create) | **POST** {auth_group_href}roles/ | Create a group role
*GroupsRolesApi* | [**delete**](docs/GroupsRolesApi.md#delete) | **DELETE** {auth_groups_group_role_href} | Delete a group role
*GroupsRolesApi* | [**list**](docs/GroupsRolesApi.md#list) | **GET** {auth_group_href}roles/ | List group roles
*GroupsRolesApi* | [**read**](docs/GroupsRolesApi.md#read) | **GET** {auth_groups_group_role_href} | Inspect a group role
