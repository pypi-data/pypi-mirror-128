...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '3.5.0-alpha.1637769894+585e7ddf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 3.5.0-alpha.1637769894+585e7ddf`
                """)
            else:
                raise
