...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'frontegg', '0.2.16', '--server', 'https://github.com/benesch/pulumi-frontegg/releases/download/v0.2.16/'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource frontegg 0.2.16`
                """)
            else:
                raise
