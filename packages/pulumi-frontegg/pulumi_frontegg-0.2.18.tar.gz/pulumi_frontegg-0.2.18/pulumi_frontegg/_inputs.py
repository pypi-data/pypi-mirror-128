...
class WorkspaceCaptchaPolicyArgs:
    def __init__(__self__, *,
                 ...
                 ignore_emails: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        pulumi.set(__self__, "min_score", min_score)
        pulumi.set(__self__, "secret_key", secret_key)
        pulumi.set(__self__, "site_key", site_key)
        if ignore_emails is not None:
            pulumi.set(__self__, "ignore_emails", ignore_emails)
    ...
    @property
    @pulumi.getter(name="ignoreEmails")
    def ignore_emails(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        return pulumi.get(self, "ignore_emails")

    @ignore_emails.setter
    def ignore_emails(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "ignore_emails", value)
