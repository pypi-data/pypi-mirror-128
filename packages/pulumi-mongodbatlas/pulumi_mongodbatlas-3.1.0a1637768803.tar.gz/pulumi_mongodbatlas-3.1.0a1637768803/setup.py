...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '3.1.0-alpha.1637768803+fd0bf384'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 3.1.0-alpha.1637768803+fd0bf384`
                """)
            else:
                raise
