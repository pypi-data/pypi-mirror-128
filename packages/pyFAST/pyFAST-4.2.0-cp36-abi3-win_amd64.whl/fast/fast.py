...
class ImageFileStreamer(FileStreamer):
    ...
    @staticmethod
    def create(filenameFormat: "std::string", loop: "bool"=False, useTimestamps: "bool"=True) -> "std::shared_ptr< fast::ImageFileStreamer >":
        r"""
        ...
        :return: instance
        """
        return _fast.ImageFileStreamer_create(filenameFormat, loop, useTimestamps)
...
def ImageFileStreamer_create(filenameFormat: "std::string", loop: "bool"=False, useTimestamps: "bool"=True) -> "std::shared_ptr< fast::ImageFileStreamer >":
    r"""
    Create a ImageFileStreamer instance
...
class ImagePyramidLevelExtractor(ProcessObject):
    ...
    @staticmethod
    def create(level: "int"=-1) -> "std::shared_ptr< fast::ImagePyramidLevelExtractor >":
        r"""
        Create instance
        :type level: int
        ...
        :return: instance
        """
        return _fast.ImagePyramidLevelExtractor_create(level)
...
def ImagePyramidLevelExtractor_create(level: "int"=-1) -> "std::shared_ptr< fast::ImagePyramidLevelExtractor >":
    r"""
    Create instance
    :type level: int
    :param level: Specify which level to extract from image pyramid. Negative level means last level,
...
class TissueMicroArrayExtractor(Streamer):
    ...
    @staticmethod
    def create(level: "int"=0) -> "std::shared_ptr< fast::TissueMicroArrayExtractor >":
        r"""
        Create instance
        :type level: int
        ...
        :return: instance
        """
        return _fast.TissueMicroArrayExtractor_create(level)
...
def TissueMicroArrayExtractor_create(level: "int"=0) -> "std::shared_ptr< fast::TissueMicroArrayExtractor >":
    r"""
    Create instance
    :type level: int
    :param level: Which image pyramid level to extract TMAs from. Default is 0 which is highest resolution level.
...
class ComputationThread(Object):
    ...
    def finished(self) -> "void":
        return _fast.ComputationThread_finished(self)
