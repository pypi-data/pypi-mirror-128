...
def recordWithoutVD(filename,buf=None,dur=3,deviceIndex=None):
    '''
    record limit duration to filename (without voice detection)
    =================================
    ...
    #return AudioData(collections.deque(buf),RATE,sampwidth)
...
def record(filename,dur=25,TH=0.01,Samples=None,deviceIndex=None,SilenceNum=5):
    '''
    ...
    SilenceNum:cut off silence number
...
def recordSerial(dur=25,TH=0.01,label="",Samples=None,deviceIndex=None,SilenceNum=5):
    '''
    =================================
    record one bye one in serial
    dur:total duration of voice activitive detection
    TH:threshold of endpoint detection rms Energy
...
def recordSerialAndPlot(dur=25,TH=0.01,label="",Samples=None,endPoints=None,deviceIndex=None,SilenceNum=5):
    '''
    =================================
    ...
    Samples:normalized recorded samples (list)
    SilenceNum:cut off silence number
    Return:list of recorded filenames
    =================================
    '''
    filenames = []
    #WAVE_OUTPUT_FILENAME = "output.wav"
...
#filenames = recordSerialAndPlot(dur=5,TH=0.01,label="test",Samples=None,endPoints=None,deviceIndex=1)
#print(filenames)