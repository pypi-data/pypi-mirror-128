...
class Nativemethods(metaclass=Singleton):
    ...
    def init_autd3capi(self):
        if hasattr(self, 'autd3capi'):
            return
        self.autd3capi = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.3" + self._bin_ext))
    ...
    def init_autd3capi_from_file_modulation(self):
        ...
        self.autd3capi_from_file_modulation = ctypes.CDLL(
            os.path.join(
                self._bin_location,
                self._bin_prefix +
                "autd3capi_1.9.3-from-file-modulation" +
                self._bin_ext))
    ...
    def init_autd3capi_holo_gain(self):
        if hasattr(self, 'autd3capi_holo_gain'):
            return
        self.autd3capi_holo_gain = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.3-holo-gain" + self._bin_ext))
    ...
    def init_autd3capi_remote_twincat_link(self):
        ...
        self.autd3capi_remote_twincat_link = ctypes.CDLL(
            os.path.join(
                self._bin_location,
                self._bin_prefix +
                "autd3capi_1.9.3-remote-twincat-link" +
                self._bin_ext))
    ...
    def init_autd3capi_soem_link(self):
        if hasattr(self, 'autd3capi_soem_link'):
            return
        self.autd3capi_soem_link = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.3-soem-link" + self._bin_ext))
    ...
    def init_autd3capi_twincat_link(self):
        if hasattr(self, 'autd3capi_twincat_link'):
            return
        self.autd3capi_twincat_link = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.3-twincat-link" + self._bin_ext))
    ...
    def init_autd3capi_arrayfire_backend(self):
        ...
        self.autd3capi_arrayfire_backend = ctypes.CDLL(
            os.path.join(
                self._bin_location,
                self._bin_prefix +
                "autd3capi_1.9.3-arrayfire-backend" +
                self._bin_ext))
    ...
    def init_autd3capi_blas_backend(self):
        if hasattr(self, 'autd3capi_blas_backend'):
            return
        self.autd3capi_blas_backend = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.3-blas-backend" + self._bin_ext))
    ...
    def init_autd3capi_cuda_backend(self):
        if hasattr(self, 'autd3capi_cuda_backend'):
            return
        self.autd3capi_cuda_backend = ctypes.CDLL(os.path.join(self._bin_location, self._bin_prefix + "autd3capi_1.9.3-cuda-backend" + self._bin_ext))
