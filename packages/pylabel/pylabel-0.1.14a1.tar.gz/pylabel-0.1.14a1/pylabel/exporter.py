    ...
    def ExportToYoloV5(self, output_path=None, yaml_file=None, copy_images=False):
        ...
        Args:
            ...
            output_path (str): 
                This is where the annotation files will be written.
                If not-specified then the path will be derived from the .path_to_annotations and
                .name properties of the dataset object. If you are exporting images to train a model, the recomended path 
            ...
            yaml_file (str):
                ...
                The recomended name for the YAML file is 'dataset.yaml'.
            copy_images (boolean):
        ...
        path_dict["root_path_from_yolo_dir"] = str(PurePath("../",path.parent))
