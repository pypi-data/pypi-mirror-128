...
with open(os.path.join(repository_dir, 'src', 'pymessege', '_version.py')) as fh:
    exec(fh.read())
...
setup(
    ...
    python_requires='>=2.7.10, !=3.0.*, !=3.1.*, !=3.2.*, !=3.3.*, !=3.4.0, !=3.4.1, !=3.4.2, ==3.9.* , <4',
    url="https://github.com/toqp/pymessege",
    version=__version__,
)