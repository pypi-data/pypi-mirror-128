...
import pyprocessors_silero


# -- Project information -----------------------------------------------------

project = "pyprocessors_silero"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyprocessors_silero.__version__
release = pyprocessors_silero.__version__
...
apidoc_module_dir = os.path.dirname(pyprocessors_silero.__file__)
