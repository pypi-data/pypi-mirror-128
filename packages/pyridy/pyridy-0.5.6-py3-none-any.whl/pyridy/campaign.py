...
from .osm.utils import calc_perpendicular_distance
...
class Campaign:
    def __init__(self, name="", folder: Union[list, str] = None, recursive=True, exclude: Union[list, str] = None,
                 ...
                 lon_ne: float = None, download_osm_region: bool = False, filter_osm_region: bool = True,
        ...
        filter_osm_region: bool, default: True
    ...
    def filter_osm_region(self, d_min: float = 10.0):
        ...
        if self.osm_region:
            ...
            for f in self:
                ...
                for i, el in enumerate(self.osm_region.railway_elements):
                    if mask[i]:
                        continue
                    else:
