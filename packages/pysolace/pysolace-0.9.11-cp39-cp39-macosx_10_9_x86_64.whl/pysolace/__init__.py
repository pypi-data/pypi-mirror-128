...
class SolClient:
    def __init__(
        ...
        solclient.set_session_down_callback(
            self.sol, self.session_down_callback_wrap
        )
    ...
    def publish(self, topic: str, msg: dict, format: str = "msgpack", cos: int = 1) -> int:
        """
    ...
    def publish_raw(self, topic: str, content_type: str, buf: bytes, cos: int = 1) -> int:
