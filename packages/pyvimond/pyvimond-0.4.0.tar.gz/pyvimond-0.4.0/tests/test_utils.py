...
class UtilsTest(unittest.TestCase):
    ...
    def test_get_category_metadata_value(self):
        ...
        self.assertEqual('Category Foo', utils.get_category_metadata_value('foo', category))
        self.assertEqual('Category Bar', utils.get_category_metadata_value('bar', category))
        self.assertEqual(None, utils.get_category_metadata_value('baz', category))
