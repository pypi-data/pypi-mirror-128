...
if __name__ == "__main__":
    ...
    # all_pre_files = main(project_folder, startdate, enddate, latlim, lonlim, level = level, diagnostics = diagnostics, composite_length = composite_length)

    # all_files = pywapor.et_look.main(project_folder, startdate)
    ...
    # raw_ndvi_files = glob.glob(r"/Volumes/Data/FAO/WaPOR_vs_pyWaPOR/pyWAPOR_v1/RAW/MODIS/MOD13/*.tif")
    # example_fh, example_ds, example_geoinfo = select_template([raw_ndvi_files])
