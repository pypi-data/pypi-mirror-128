...
- Important Information
   - QualysETL provides Extract, Transform, Load(ETL) of Qualys data with one command.  CSV, JSON, SQLite3 Database outputs are supported.
   ...
   - Ubuntu 20.40 and Red Hat 8.4 are the supported platforms.
...
>>
>     - qetl_manage_user will create csv, json and sqlite from GAV/CSAM API V2. 
>     - sqlite database will contain one table:  
>       1) Q_Asset_Inventory - Asset Inventory of Asset Last Updated -d 'DATE' to now 
>          - GAV/CSAM V2 API Endpoint: 
>            /rest/2.0/search/am/asset?assetLastUpdated=1970-01-01T00:00:00Z
>
...
# asset_inventory_concurrency_limit: 1               # Leave at 1
# asset_inventory_multi_proc_batch_size: 300         # Leave at 300
# asset_inventory_limit_hosts: 1000                  # Set to maximum number of hosts in your subscription.
#                                                    # If unsure, set to 1000000 ( 1 million ).  If you have over
#                                                    # 1000000 hosts, please contact dgregory@qualys.com
# asset_inventory_csv_truncate_cell_limit: 32000     # Truncate all cells to integer value.  Useful for reading csv
#                                                      in excel. Will also truncate database cells.
...
asset_inventory_concurrency_limit: 1
asset_inventory_multi_proc_batch_size: 300
asset_inventory_limit_hosts: 1000
asset_inventory_csv_truncate_cell_limit: 32000
...
[![](https://user-images.githubusercontent.com/82658653/135726118-9523c6cf-0e91-4942-9767-1be11a39b8bb.png)](https://user-images.githubusercontent.com/82658653/135726118-9523c6cf-0e91-4942-9767-1be11a39b8bb.png)
...
------------ | -------------
   ...
   qetl_home/data/asset_inventory_json_dir | Asset Inventory Extracts of last scan date of asset in JSON Format.
   qetl_home/data/asset_inventory_shelve | Asset Inventory Python Shelve
   qetl_home/data/asset_inventory_sqlite.db | Asset Inventory SQLite Database
   qetl_home/data/asset_inventory.csv | Asset Inventory CSV File
...
Web Application Scanning(WAS) | Nov 2021 | Automate download and transform of WAS Findings into CSV, JSON and SQLite Database
Docker Image | Jan 2022 | Encapsulate Python Application into distributable docker image for ease os operation and upgrade.
