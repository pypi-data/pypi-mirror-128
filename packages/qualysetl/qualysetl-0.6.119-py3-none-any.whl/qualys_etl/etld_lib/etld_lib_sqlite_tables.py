...
def bulk_insert_csv_file(table_name, csv_file_name, csv_columns, sqlite_file):
    global count_rows_added_to_table
    count_rows_added_to_table_display_progress = 0
    ...
    try:
        ...
        with open(csv_file_name, "r", encoding='utf-8') as csv_file:
            ...
            for row in csv_reader:
                ...
                count_rows_added_to_table_display_progress += 1
                if count_rows_added_to_table_display_progress > 9999:
                    etld_lib_functions.logger.info(f"sqlite rows written: {count_rows_added_to_table}")
                    count_rows_added_to_table_display_progress = 0
