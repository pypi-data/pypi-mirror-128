...
def cachify(name, load_all=False, load_mensioned=True):
    return {"name": name, "load_all": load_all, "load_mensioned": load_mensioned}
...
class Database:
    ...
    def cache_send(self, id, object):
        self.cached[id] = object
