    ...
    """
{
    ...
    "package_data": {
        "renovo-instance-service._jsii": [
            "cdk-library-renovo-instance-service@0.1.30.jsii.tgz"
        ],
        "renovo-instance-service": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.cloud-assembly-schema>=1.132.0, <2.0.0",
        "aws-cdk.core>=1.132.0, <2.0.0",
        "constructs>=3.2.27, <4.0.0",
        "jsii>=1.44.1, <2.0.0",
        "publication>=0.0.3",
        "renovosolutions.aws-cdk-aspects-security-group>=0.1.26, <0.2.0",
        "renovosolutions.aws-cdk-managed-instance-role>=0.0.42, <0.0.43"
    ],
    "classifiers": [
