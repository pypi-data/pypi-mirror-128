from Devices.Weather.WeatherAntecedentDTO import HumidityAntecedent
        ...
        try:
            ...
            if dto.check_humidity == "true":
                ...
                if dto.humidity_condition == "between":
                    if dto.humidity_start_value < dto.humidity_value <= dto.humidity_stop_value:
                        evaluation = "true"
                elif dto.humidity_condition == ">":
                    if dto.humidity_value > dto.humidity_start_value:
                        evaluation = "true"
                elif dto.humidity_condition == "<":
                    if dto.humidity_value < dto.humidity_stop_value:
                        evaluation = "true"
