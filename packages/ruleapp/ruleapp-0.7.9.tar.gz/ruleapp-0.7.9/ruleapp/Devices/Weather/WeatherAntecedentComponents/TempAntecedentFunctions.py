from Devices.Weather.WeatherAntecedentDTO import TempAntecedent
        ...
        try:
            ...
            if dto.check_temp == "true":
                ...
                if dto.temp_condition == "between":
                    if dto.temp_start_value < dto.temp_value <= dto.temp_stop_value:
                        evaluation = "true"
                elif dto.temp_condition == ">":
                    if dto.temp_value > dto.temp_start_value:
                        evaluation = "true"
                elif dto.temp_condition == "<":
                    if dto.temp_value < dto.temp_stop_value:
                        evaluation = "true"
