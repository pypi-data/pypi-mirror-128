from Devices.Weather.WeatherAntecedentDTO import WindAntecedent
        ...
        try:
            ...
            if dto.check_wind_speed == "true":
                ...
                if dto.wind_speed_condition == "between":
                    if dto.wind_speed_start_value < dto.wind_speed_value <= dto.wind_speed_stop_value:
                        evaluation = "true"
                elif dto.wind_speed_condition == ">":
                    if dto.wind_speed_value > dto.wind_speed_start_value:
                        evaluation = "true"
                elif dto.wind_speed_condition == "<":
                    if dto.wind_speed_value < dto.wind_speed_stop_value:
                        evaluation = "true"
