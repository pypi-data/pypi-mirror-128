from Devices.Weather.WeatherAntecedentComponents.CloudAntecedentFunctions import CloudAntecedentFunction
from Devices.Weather.WeatherAntecedentComponents.HumidityAntecedentFunctions import HumidityAntecedentFunction
from Devices.Weather.WeatherAntecedentComponents.IconAntecedentFunctions import IconAntecedentFunction
from Devices.Weather.WeatherAntecedentComponents.PressureAntecedentFunctions import PressureAntecedentFunction
from Devices.Weather.WeatherAntecedentComponents.TempAntecedentFunctions import TempAntecedentFunction
from Devices.Weather.WeatherAntecedentComponents.TimeAntecedentFunctions import TimeAntecedentFunction
from Devices.Weather.WeatherAntecedentComponents.WindSpeedAntecedentFunctions import WindSpeedAntecedentFunction
from Devices.Weather.WeatherAntecedentDTO import WeatherAntecedent
...
class WeatherAntecedentFunction(object):
    ...
    def get_antecedent(self, user_id, rule_id, device_id):
        try:
            ...
            antecedent.set_icon_antecedent(self.icon_antecedent_functions.get_icon_antecedent(user_id, rule_id, device_id))
            antecedent.set_temp_antecedent(self.temp_antecedent_functions.get_temp_antecedent(user_id, rule_id, device_id))
            ...
            antecedent.set_time_antecedent(self.time_antecedent_functions.get_time_antecedent(user_id, rule_id, device_id))
    ...
    def set_antecedent(self, user_id, rule_id, device_id, antecedent: WeatherAntecedent):
        try:
            self.icon_antecedent_functions.set_icon_antecedent(user_id, rule_id, device_id,
                                                               antecedent.get_icon_antecedent())
            self.cloud_antecedent_functions.set_cloud_antecedent(user_id, rule_id, device_id,
                                                                 antecedent.get_cloud_antecedent())
            self.humidity_antecedent_functions.set_humidity_antecedent(user_id, rule_id, device_id,
                                                                       antecedent.get_humidity_antecedent())
            self.pressure_antecedent_functions.set_pressure_antecedent(user_id, rule_id, device_id,
                                                                       antecedent.get_pressure_antecedent())
            self.temp_antecedent_functions.set_temp_antecedent(user_id, rule_id, device_id,
                                                               antecedent.get_temp_antecedent())
            self.time_antecedent_functions.set_time_antecedent(user_id, rule_id, device_id,
                                                               antecedent.get_time_antecedent())
            self.wind_speed_antecedent_functions.set_wind_antecedent(user_id, rule_id, device_id,
    ...
    def register_antecedent(self, user_id, rule_id, device_id):
        try:
