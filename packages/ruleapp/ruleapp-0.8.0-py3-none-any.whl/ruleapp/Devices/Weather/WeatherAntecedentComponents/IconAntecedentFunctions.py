from Devices.Weather.WeatherAntecedentDTO import IconAntecedent
...
class IconAntecedentFunction(object):
    ...
    def get_icon_antecedent(self, user_id, rule_id, device_id):
        ...
        dto.icon_start_value = self.r.get(key_pattern + ":icon_start_value")
        dto.icon_stop_value = self.r.get(key_pattern + ":icon_stop_value")
    ...
    def set_icon_antecedent(self, user_id, rule_id, device_id, dto: IconAntecedent):
        ...
        self.r.set(key_pattern + ":icon_start_value", dto.icon_start_value)
        self.r.set(key_pattern + ":icon_stop_value", dto.icon_stop_value)
    ...
    def delete_icon_antecedent(self, user_id, rule_id, device_id):
        ...
        self.r.delete(key_pattern + ":icon_stop_value")
    ...
    def icon_antecedent_evaluation(self, user_id, rule_id, device_id):
        try:
            ...
            if dto.check_icon == "true":
                evaluation = "false"
                icon_value = self.icon_codes[dto.icon_value]
                start_value = self.icon_codes[dto.icon_start_value]
                stop_value = self.icon_codes[dto.icon_stop_value]
                if dto.icon_condition == "between":
                    if start_value < icon_value <= stop_value:
                        evaluation = "true"
                elif dto.icon_condition == ">":
                    if icon_value > start_value:
                        evaluation = "true"
                elif dto.icon_condition == "<":
                    if icon_value < stop_value:
                        evaluation = "true"
