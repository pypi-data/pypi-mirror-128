...
class S3FileSystem(AsyncFileSystem):
    ...
    def __init__(
        ...
        assert "AWS_ACCESS_KEY_ID" in os.environ, "'AWS_ACCESS_KEY_ID' not found in environment"
        assert "AWS_SECRET_ACCESS_KEY" in os.environ, "'AWS_SECRET_ACCESS_KEY' not found in environment"
        assert "S3_ENDPOINT" in os.environ, "'S3_ENDPOINT' not found in environment"
        if key and username:
        ...
        self.client_kwargs = client_kwargs or {"endpoint_url": os.environ["S3_ENDPOINT"]}
