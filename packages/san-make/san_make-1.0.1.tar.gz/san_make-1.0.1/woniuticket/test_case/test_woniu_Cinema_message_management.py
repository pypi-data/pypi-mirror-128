...
def setup_function():
    r1=request_t('get','http://192.168.255.180:14200/cinema-stage/admin/login',{'username':'Wanda','password':'123456'})
    return r1
...
def teardown_function():
    r1=request_t('delete','http://192.168.255.180:14200/cinema-stage/admin/logout')
