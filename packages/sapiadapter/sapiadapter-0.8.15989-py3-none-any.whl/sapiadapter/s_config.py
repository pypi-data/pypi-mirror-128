...
def unpack_key( ) :
    ...
    ################################################################
    if( endpoint_key.endswith( "_LOCAL_CONFIGENDPOINTKEY_" ) ) :
        endpoint_key_ip = os.environ[ "_CONTAINER_HOSTNETWORKIP" ]
        endpoint_key_port = 10443
        endpoint_key_token = "OMA1f18fe0463afee7cba3014123d60e01aa0272d6cc8a2ca44e25cb030481d4a28"
        endpoint_key_host = "sapiomnibus1.test"
        endpoint_key = endpoint_key_ip + ":" + str( endpoint_key_port ) + endpoint_key_token + "|" + endpoint_key_host
