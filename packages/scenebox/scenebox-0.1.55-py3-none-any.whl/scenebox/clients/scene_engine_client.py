...
from ..constants import (AUXILIARY_KEY, TIMESTAMP_FIELD,
                         ...
                         SetsAssets, SetTags, ValidExtensions, AuxiliaryDataTypes, Sensors)
...
class SceneEngineClient(object):
    ...
    def delete_annotations(self,
        ...
        for _ in annotations_meta:
            asset_ann_id_map[_["asset_id"]] = _["id"]
        ...
        def update_asset_meta(asset_id, asset_meta, ann_id, media_type):
