...
def make_rules():
	...
	print('installing rules for accessing SEELab hardware...', sys.argv)
...
setuptools.setup(
    ...
    description="Python package for seelablet",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/csparkresearch/seelablet",
    packages=setuptools.find_packages(exclude=['contrib', 'tests']),
    package_data = {
        '': ['*.qss','*.rules','*.conf','*.html','*.png','*.jpg','*.qm','*.txt'],
    },
    classifiers=[
    ...
    entry_points={
    'console_scripts': [
        'seelabv2=seelabv2GUI.main:run',
    		],
	},
	cmdclass = {'install':InstallCommand},
    keywords = 'seelablet v2 data-acquisition lab-at-home oscilloscope waveform-generator sensors physics',
    python_requires='>=3',
