...
GasIndexAlgorithm_SAMPLING_INTERVAL = _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithm_SAMPLING_INTERVAL
...
class GasIndexAlgorithmParams(object):
    ...
    def __init__(self, algorithm_type: "int32_t"):
        _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithmParams_swiginit(self, _sensirion_gas_index_algorithm_wrap.new_GasIndexAlgorithmParams(algorithm_type))
    __swig_destroy__ = _sensirion_gas_index_algorithm_wrap.delete_GasIndexAlgorithmParams

    def init(self, algorithm_type: "int32_t") -> "void":
        return _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithmParams_init(self, algorithm_type)
...
def GasIndexAlgorithm_process(params: "GasIndexAlgorithmParams", sraw: "int32_t", gas_index: "int32_t *") -> "void":
    return _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithm_process(params, sraw, gas_index)
