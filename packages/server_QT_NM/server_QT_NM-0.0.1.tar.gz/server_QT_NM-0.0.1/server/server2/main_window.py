...
from server.server2.stat_window import StatWindow
from server.server2.config_window import ConfigWindow
from server.server2.add_user import RegisterUser
from server.server2.remove_user import DelUserDialog
