...
@LastEditTime: 2021-11-22 14:03:37
...
class LeftNavigationHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        invoke_result_data = app_base_model.get_left_navigation(self.get_user_nick(), self.get_param("access_token"),self.get_param("app_id"))
