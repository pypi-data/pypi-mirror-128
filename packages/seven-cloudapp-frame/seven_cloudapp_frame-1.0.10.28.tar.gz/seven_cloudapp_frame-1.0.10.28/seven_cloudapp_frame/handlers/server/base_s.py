...
@LastEditTime: 2021-11-26 14:03:19
...
class CmsInfoListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        cms_base_model = CmsBaseModel(context=self)
        page_list, total = self.business_process_executed(cms_base_model.get_cms_info_list(place_id=place_id, page_size=page_size, page_index=page_index, app_id=app_id, act_id=act_id, is_cache=False), ref_params={})
