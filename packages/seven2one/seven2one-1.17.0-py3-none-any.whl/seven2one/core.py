...
class TechStack(Utils, Meta):
    ...
    def updateBasicItems(self, inventoryName:str, items:list) -> None:
        """
        Updates from a list of dicts existing basic items. The '_inventoryItemId'
        ...
        >>> updateBasicItems('meterData', items)
        """
        items = Utils._propertiesToString(items)
        #_inventoryFieldName = utils._upperFirst(inventoryFieldName)

        graphQLString= f'''mutation updateBasicItems {{
    ...
    def updateArrayProperty(self, inventoryName:str, inventoryItemId:str, arrayProperty:str, 
        operation:str, arrayItems:list, cascadeDelete:bool=False) -> None:
        """
        ...
        operations = ['insert', 'removeById', 'removeByIndex']
