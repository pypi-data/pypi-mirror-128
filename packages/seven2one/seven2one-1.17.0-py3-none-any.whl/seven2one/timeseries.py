...
class TimeSeries():
    ...
    def addTimeSeriesItemsToGroup(self, inventoryName:str, groupInventoryId:str, timeSeriesItems:list):

        properties = Utils._addToGroupPropertiesToString(groupInventoryId, timeSeriesItems)
        if properties == None: return
