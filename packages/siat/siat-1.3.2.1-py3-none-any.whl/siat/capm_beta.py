...
def capm_beta_yearly(stkcd,mktidx,yearlist):
    ...
    print(" 数据来源：新浪财经/雅虎财经，基于"+codetranslate(mktidx)+'，'+str(today))
    ...
    foot="\n数据来源：新浪财经/雅虎财经，基于"+codetranslate(mktidx)+'，'+str(today)
...
def compare2_betas_yearly(stkcd1,stkcd2,mktidx,yearlist):
    ...
    import datetime; today = datetime.date.today()
    plt.xlabel("数据来源：新浪财经/雅虎财经，基于"+codetranslate(mktidx)+'，'+str(today))
    plt.show()
