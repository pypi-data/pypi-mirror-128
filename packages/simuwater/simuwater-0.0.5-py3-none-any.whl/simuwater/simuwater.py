...
class Simuwater:
    ...
    def simuuwater_setSwmmNodeDepth(self, inp_id, obj_id, value):
        return self._simuwater_setSwmmNodeDepth(inp_id.encode('utf-8'),
                                                obj_id.encode('utf-8'),
                                                ctypes.c_double(value))
    
    def simuuwater_setSwmmLinkDepth(self, inp_id, obj_id, value):
        return self._simuwater_setSwmmLinkDepth(inp_id.encode('utf-8'),
                                                obj_id.encode('utf-8'),
                                                ctypes.c_double(value))
        
    def simuuwater_setSwmmLinkFlow(self, inp_id, obj_id, value):
        return self._simuwater_setSwmmLinkFlow(inp_id.encode('utf-8'),
                                                obj_id.encode('utf-8'),
                                                ctypes.c_double(value))
