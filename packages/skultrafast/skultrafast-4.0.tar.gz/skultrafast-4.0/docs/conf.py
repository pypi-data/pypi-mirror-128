# -*- coding: utf-8 -*-
#
# skultrafast documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../skultrafast'))
...
project = u'skultrafast'
copyright = u'2020, Till Stensitzki'
...
htmlhelp_basename = 'skultrafastdoc'
