...
from soco_yolo.utils.general import user_config_dir, is_ascii, xywh2xyxy, xyxy2xywh
from soco_yolo.utils.metrics import fitness
...
def profile_idetection(start=0, stop=0, labels=(), save_dir=''):
    ...
    for fi, f in enumerate(files):
        try:
            results = np.loadtxt(f, ndmin=2).T[:, 90:-30]  # itc first and last rows
