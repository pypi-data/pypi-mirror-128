...
{'console_scripts': ['deduplicate-feature-counts = '
                     'stjudecloud_utilities.deduplicate_feature_counts:main',
                     'gtf-to-rseqc-bed = '
                     'stjudecloud_utilities.gtf_to_rseqc_bed:main',
                     'warden-counts-utils = '
                     'stjudecloud_utilities.warden_counts_utils:main']}
