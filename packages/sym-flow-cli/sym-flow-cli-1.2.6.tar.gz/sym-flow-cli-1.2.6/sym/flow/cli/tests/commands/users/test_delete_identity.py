...
class TestUsersDeleteIdentity:
    ...
    def test_delete_user_identity(self, mock_apply, click_setup, users):
    ...
    def test_delete_user_identity_bad_input(
        self,
        mock_apply,
        service_type,
        external_id,
    ...
    def test_delete_user_identity_unknown_email(
        self,
        mock_apply,
        click_setup,
    ):
        with click_setup() as runner:
            result = runner.invoke(
                click_command,
                ["users", "delete-identity", "someone@symops.io"],
            )
            assert "Unknown user for email: someone@symops.io" in result.output

    def test_delete_user_identity_prompt_both(
    ...
    def test_delete_user_identity_prompt_external_id(
        self, mock_apply, click_setup, users, services
    ):
        with click_setup() as runner:
            # Prompts external ID
    ...
    def test_delete_user_identity_prompt_service_type(
        self, mock_apply, click_setup, users, services
    ):
        with click_setup() as runner:
    ...
    def test_delete_user_identity_does_not_prompt_external_id(
        self, mock_apply, click_setup, users, services
    ):
        with click_setup() as runner:
