...
class TMLT:
    ...
    def do_xgb_optuna_optimization(self, preds_metrics:list, output_dir_path:str, use_gpu=False, opt_trials=100,
                                   opt_timeout=360):
        """
            This methods returns and do optuna bases study optimization for hyperparmaeter search
            preds_metrics need to be sklearn metrics object type some of them are:
                from sklearn.metrics import mean_absolute_error, roc_auc_score,accuracy_score
    ...
    def fetch_xgb_initial_params(self):
        if self.problem_type == "classification":
            xgb_model = xgboost.XGBClassifier
            # TODO: use given sklearn metrics and find xgb eval_metrics, direction, use_predict_proba
