...
class BatchDataSource(BaseDataSource):
    ...
    def __init__(
        ...
        *,
        ...
        :param batch_ds_config: BatchDataSourceConfig object containing the configuration of the batch data source to be included
            in this DataSource.
        ...
        *,
        ...
        .. code-block:: python
         ...
         import pyspark
            ...
            # See the API documentation for both BatchDataSourceConfig and StreamDataSourceConfig
