...
from tentaclio import base_client, decorators, protocols, urls

from tentaclio_gs.clients import exceptions
...
class GSClient(base_client.BaseClient["GSClient"]):
    ...
    def _get_blob(self, bucket_name: str, key_name: str) -> Bucket:
