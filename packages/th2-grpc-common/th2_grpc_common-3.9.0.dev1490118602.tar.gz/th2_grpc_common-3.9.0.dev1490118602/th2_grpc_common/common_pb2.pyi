...
class NotificationKind(metaclass=_NotificationKind):
    V = typing.NewType('V', builtins.int)

global___NotificationKind = NotificationKind

BOOK_ADDED = NotificationKind.V(0)
BOOK_REMOVED = NotificationKind.V(1)
PAGE_ADDED = NotificationKind.V(3)
PAGE_REMOVED = NotificationKind.V(4)

class _NotificationKind(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NotificationKind.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    BOOK_ADDED = NotificationKind.V(0)
    BOOK_REMOVED = NotificationKind.V(1)
    PAGE_ADDED = NotificationKind.V(3)
...
class Notification(google.protobuf.message.Message):
    ...
    kind: global___NotificationKind.V = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"description",b"description",u"kind",b"kind",u"name",b"name"]) -> None: ...
