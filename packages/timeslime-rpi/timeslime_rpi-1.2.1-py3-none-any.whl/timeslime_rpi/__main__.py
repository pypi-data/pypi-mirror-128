...
from timeslime.handler import DatabaseHandler, SettingsHandler, TimeslimeHandler, NtpServerHandler
...
def start_timeslime(tm: tm1637.TM1637, database_handler: DatabaseHandler, ntp_server_handler: NtpServerHandler):
    ...
    try:
        ...
        timeslime_handler = TimeslimeHandler(settings_handler, database_handler, ntp_server_handler)
