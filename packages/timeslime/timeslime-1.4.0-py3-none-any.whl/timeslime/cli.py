...
def init(ctx, weekly_hours, timeslime_server, timeslime_username, timeslime_password):
    ...
    if not (
        ...
        settings_handler.set("timeslime_server", timeslime_server)
        settings_handler.set("username", timeslime_username)
        settings_handler.set("password", timeslime_password)
    else:
