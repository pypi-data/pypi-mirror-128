...
def compute_vertical_profile(elevs, oelevs, values, num_min_prof, min_elev_diff):
    return _titanlib.compute_vertical_profile(elevs, oelevs, values, num_min_prof, min_elev_diff)
