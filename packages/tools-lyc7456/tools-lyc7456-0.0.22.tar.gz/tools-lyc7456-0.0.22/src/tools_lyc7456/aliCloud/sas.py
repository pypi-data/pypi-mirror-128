...
class SAS:
    def __init__(self, key) -> None:
        ...
        # SAS
        self.image_id = key['SAS']['image_id']
        self.plan_id = key['SAS']['plan_id']
        self.instance_name = key['SAS']['instance_name']
        self.password = key['SAS']['password']
    ...
    def listImages(self, image_type='system'):
        ...
        Returns:
            [json]: [json response]
        """
        client = SAS.create_client(self.access_key_id, self.access_key_secret)
