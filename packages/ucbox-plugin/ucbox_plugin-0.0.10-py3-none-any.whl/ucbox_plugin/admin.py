...
@admin.register(UCUCCluster)
class UCUCClusterPlanAdmin(admin.ModelAdmin):
    list_display = ("UCUCCluster", "tenant", "description", "publisher", "subscriber1", "subscriber2", "subscriber3", "subscriber4", "tftp1", "tftp2")

@admin.register(DevicePool)
class DevicePoolPlanAdmin(admin.ModelAdmin):
    list_display = ("devicepool", "tenant", "region", "description", "datetimegroup", "localroutegroup")