...
class Cluster(ChangeLoggedModel):
    ...
    csv_headers = ['cluster', 'tenant', 'description', 'publisher', 'subscriber1', 'subscriber2', 'subscriber3', 'subscriber4', 'tftp1', 'tftp2']

    def __str__(self):
        return str(self.cluster)

    def get_absolute_url(self):
        return reverse("plugins:ucbox_plugin:cluster_view", kwargs={"pk": self.pk})

    class Meta:
        unique_together = ("cluster", "tenant",)#ermoe enant here
