...
from .nested_serializers import NestedNumberSerializer, NestedTrunkSerializer, NestedClusterSerializer, NestedDevicePoolSerializer
...
class ClusterSerializer(TagSerializer, serializers.ModelSerializer):
    ...
    class Meta:
        model = Cluster
        fields = [
            "id", "label", "cluster", "tenant", "publisher", "subscriber1", "subscriber2", "subscriber3", "subscriber4", "tftp1", "tftp2", "description", "tags"
        ]
