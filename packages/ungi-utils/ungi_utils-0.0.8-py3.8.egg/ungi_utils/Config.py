...
class UngiConfig:
    ...
    def __init__(self, path):
        ...
        # Used to determin telegram bot operation mode
        self.telegram_bot = "single"
        self.telegram_bot_mode = config("TELEGRAM", "mode", self.config_path)
        try:
            if self.telegram_bot_mode.lower() == "multi":
                self.telegram_mode = 'multi'
            else:
                self.telegram_mode = 'single'
        except TypeError:
            pass
