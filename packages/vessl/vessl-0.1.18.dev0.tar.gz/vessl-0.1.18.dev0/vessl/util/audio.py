...
from vessl.util.constant import VESSL_AUDIO_PATH
...
class Audio:
    ...
    def _init_meta(self, sample_rate, caption):
        ...
        os.makedirs(VESSL_AUDIO_PATH, exist_ok=True)
        self._path = os.path.join(VESSL_AUDIO_PATH, Audio.generate_uuid() + ".png")
