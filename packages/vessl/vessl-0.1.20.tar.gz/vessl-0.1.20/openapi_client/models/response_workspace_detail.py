...
class ResponseWorkspaceDetail(object):
    ...
    def __init__(self, backup_volume_id=None, created_by=None, created_dt=None, endpoints=None, env_vars=None, exit_code=None, histories=None, id=None, init_script=None, kernel_cluster=None, kernel_cluster_node=None, kernel_cluster_select_policies=None, kernel_image=None, kernel_resource_spec=None, kubernetes_resource_info=None, last_backup_dt=None, name=None, organization=None, ports=None, status=None, status_last_updated=None, status_reason=None, updated_dt=None, volume_mounts=None, local_vars_configuration=None):  # noqa: E501
