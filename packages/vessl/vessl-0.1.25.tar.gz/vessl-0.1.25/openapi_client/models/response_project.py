...
class ResponseProject(object):
    ...
    def __init__(self, created_dt=None, description=None, id=None, is_public=None, name=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
