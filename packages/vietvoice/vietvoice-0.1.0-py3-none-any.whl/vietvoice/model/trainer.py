...
class Trainer():
    def __init__(self, train_config, symbols_config, data_config, encoder_config, decoder_config, postnet_config, text_to_index_fn):
        ...
        trainset = TextMelLoader(train_config['train_files'], text_to_index_fn=text_to_index_fn,
        ...
        evalset = TextMelLoader(train_config['test_files'], text_to_index_fn=text_to_index_fn,
                                precomputed_mels = train_config['precomputed_mels'],
                                **data_config)
    ...
    def train(self):
        for i in range(self.current_iter, self.num_iters):
            ...
            if i >= 1000:
                train_losses.append((i, *loss_items))
