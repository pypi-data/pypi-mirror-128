...
class RelModelsVersionSelectMixin:
    ...
    def setup_version(self):
        ...
        for rel_field in self.instance.rel_versioned_fields:
            ...
            elif rel_field_queryset := self.fields[f'{rel_field}{REL_VERSION_FIELD_END}'].queryset:
                self.fields[f'{rel_field}{REL_VERSION_FIELD_END}'].queryset = rel_field_queryset.none()
