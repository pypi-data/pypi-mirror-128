...
class OakgateSlot(object):
    ...
    def __init__(self, slot_id, config_name):
        ...
        self.platform_path = r"Y:\sshu\log" #os.environ.get('working_path')
        self.logs_path = os.path.join(self.platform_path, "Logs")

        self.script = "u_ssd_data_collection"

    def execute_command(self):
        command_line = "cd /d {} && py -3 run.py --oakgate {} --script {}".\
            format(self.platform_path, self.config_name, self.script)
    ...
    def _format_results(results):
        format_result = {
            ...
            "cap": results["ssd_config_dic"]["drive_density"],
