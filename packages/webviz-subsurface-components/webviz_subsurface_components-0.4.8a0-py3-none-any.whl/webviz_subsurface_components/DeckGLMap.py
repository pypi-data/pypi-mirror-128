...
- colorTemplate (list of dicts; optional):
...
- zoom (number; default -3):
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, resources=Component.UNDEFINED, bounds=Component.UNDEFINED, zoom=Component.UNDEFINED, layers=Component.UNDEFINED, coords=Component.UNDEFINED, scale=Component.UNDEFINED, coordinateUnit=Component.UNDEFINED, legend=Component.UNDEFINED, editedData=Component.UNDEFINED, colorTables=Component.UNDEFINED, colorTemplate=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'bounds', 'colorTables', 'colorTemplate', 'coordinateUnit', 'coords', 'editedData', 'layers', 'legend', 'resources', 'scale', 'zoom']
        self._type = 'DeckGLMap'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'bounds', 'colorTables', 'colorTemplate', 'coordinateUnit', 'coords', 'editedData', 'layers', 'legend', 'resources', 'scale', 'zoom']
