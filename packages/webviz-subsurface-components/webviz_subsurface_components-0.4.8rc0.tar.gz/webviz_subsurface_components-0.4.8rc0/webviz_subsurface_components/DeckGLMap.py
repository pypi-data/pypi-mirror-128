...
- template (list of dicts; default { template }):
    Prop containing color template data.

- zoom (number; default -3):
    Zoom level for the view."""
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, resources=Component.UNDEFINED, bounds=Component.UNDEFINED, zoom=Component.UNDEFINED, layers=Component.UNDEFINED, coords=Component.UNDEFINED, scale=Component.UNDEFINED, coordinateUnit=Component.UNDEFINED, legend=Component.UNDEFINED, editedData=Component.UNDEFINED, colorTables=Component.UNDEFINED, template=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'bounds', 'colorTables', 'coordinateUnit', 'coords', 'editedData', 'layers', 'legend', 'resources', 'scale', 'template', 'zoom']
        self._type = 'DeckGLMap'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'bounds', 'colorTables', 'coordinateUnit', 'coords', 'editedData', 'layers', 'legend', 'resources', 'scale', 'template', 'zoom']
