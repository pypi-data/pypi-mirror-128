...
class DatabaseClient:
    ...
    @staticmethod
    def get_session(url: str, timeout: int = 30, echo: bool = False, pool_recycle: int = 3600, **configs):
        """
    ...
    def __init__(self, url: str, timeout: int = 30, echo: bool = False, pool_recycle: int = 3600, **configs):
        """
