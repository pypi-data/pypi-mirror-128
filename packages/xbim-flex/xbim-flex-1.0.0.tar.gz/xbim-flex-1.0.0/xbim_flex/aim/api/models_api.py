...
class ModelsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.models_assign_by_tenantid_and_assetmodelid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/Roles.Assign',
        ...
        self.models_delete_by_assetmodelid_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})',
        ...
        self.models_generate_model_mapping_by_assetmodelid_and_targetmodelid_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/GenerateModelMapping(id={targetModelId})',
        ...
        self.models_get_by_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models',
        ...
        self.models_member_access_by_assetmodelid_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/MemberAccess',
        ...
        self.models_permissions_by_assetmodelid_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/Permissions',
        ...
        self.models_reprocess_by_assetmodelid_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/Reprocess()',
        ...
        self.models_revoke_by_tenantid_and_assetmodelid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/Roles.Revoke',
        ...
        self.models_roles_by_assetmodelid_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({AssetModelId})/Roles',
        ...
        self.models_supercede_by_key_and_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/odata/{tenantId}/Models({key})/Supercede()',
    ...
    def models_assign_by_tenantid_and_assetmodelid(
        ...
        **kwargs
        ...
        >>> thread = api.models_assign_by_tenantid_and_assetmodelid(tenant_id, asset_model_id, inline_object5, region="UK", async_req=True)
        >>> result = thread.get()
    ...
    def models_patch_by_assetmodelid_and_tenantid(
        ...
        **kwargs
        ...
        >>> thread = api.models_patch_by_assetmodelid_and_tenantid(asset_model_id, tenant_id, model_edit, region="UK", async_req=True)
        >>> result = thread.get()

        Args:
            asset_model_id (int):
            tenant_id (str): The unique Tenant ID (UUID or Identifier string)
            model_edit (ModelEdit): The entity to patch
            region (str): The data center region the data resides in. defaults to "UK", must be one of ["UK"]
    ...
    def models_post_by_tenantid(
        ...
        **kwargs
        ...
        The ability to create Models may be limited by access level  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.models_post_by_tenantid(tenant_id, model_create, region="UK", async_req=True)
        >>> result = thread.get()
    ...
    def models_revoke_by_tenantid_and_assetmodelid(
        ...
        **kwargs
        ...
        >>> thread = api.models_revoke_by_tenantid_and_assetmodelid(tenant_id, asset_model_id, inline_object6, region="UK", async_req=True)
        >>> result = thread.get()
