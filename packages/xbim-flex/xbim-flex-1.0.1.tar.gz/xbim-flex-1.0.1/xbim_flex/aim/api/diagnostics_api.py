...
class DiagnosticsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.diagnostics_get_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{region}/aim/core/Diagnostics',
        ...
        self.diagnostics_get_by_name_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'oauth2'
                ],
                'endpoint_path': '/{region}/aim/core/Diagnostics('{Name}')',
                'operation_id': 'diagnostics_get_by_name',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def diagnostics_get_by_name(
        self,
        name,
        region="UK",
        **kwargs
    ):
        """Returns the entity with the key from Diagnostics  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.diagnostics_get_by_name(name, region="UK", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['region'] = \
            region
        return self.diagnostics_get_by_name_endpoint.call_with_http_info(**kwargs)
